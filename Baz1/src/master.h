...
#define var112	BUFFER[641]	// Внутренняя переменная var112
#define idvar112	30000	// Внутренняя переменная var112
#define var1	BUFFER[646]	// Внутренняя переменная var1
#define idvar1	30001	// Внутренняя переменная var1
#define var2	BUFFER[648]	// Внутренняя переменная var2
#define idvar2	30002	// Внутренняя переменная var2
#define var45	BUFFER[650]	// Внутренняя переменная var45
#define idvar45	30003	// Внутренняя переменная var45
#define var87	BUFFER[652]	// Внутренняя переменная var87
#define idvar87	30004	// Внутренняя переменная var87
#define var88	BUFFER[654]	// Внутренняя переменная var88
#define idvar88	30005	// Внутренняя переменная var88
#define vainSFloat	BUFFER[656]	// Внутренняя переменная vainSFloat
#define idvainSFloat	30006	// Внутренняя переменная vainSFloat
#define var64	BUFFER[661]	// Внутренняя переменная var64
#define idvar64	30007	// Внутренняя переменная var64
#define var91	BUFFER[663]	// Внутренняя переменная var91
#define idvar91	30008	// Внутренняя переменная var91
#define var93	BUFFER[665]	// Внутренняя переменная var93
#define idvar93	30009	// Внутренняя переменная var93
#define var111	BUFFER[667]	// Внутренняя переменная var111
#define idvar111	30010	// Внутренняя переменная var111
#define var142	BUFFER[669]	// Внутренняя переменная var142
#define idvar142	30011	// Внутренняя переменная var142
#define var128	BUFFER[671]	// Внутренняя переменная var128
#define idvar128	30012	// Внутренняя переменная var128
#define var132	BUFFER[673]	// Внутренняя переменная var132
#define idvar132	30013	// Внутренняя переменная var132
#define var4	BUFFER[676]	// Внутренняя переменная var4
#define idvar4	30014	// Внутренняя переменная var4
#define var37	BUFFER[678]	// Внутренняя переменная var37
#define idvar37	30015	// Внутренняя переменная var37
#define var75	BUFFER[680]	// Внутренняя переменная var75
#define idvar75	30016	// Внутренняя переменная var75
#define var77	BUFFER[682]	// Внутренняя переменная var77
#define idvar77	30017	// Внутренняя переменная var77
#define var105	BUFFER[684]	// Внутренняя переменная var105
#define idvar105	30018	// Внутренняя переменная var105
#define var20	BUFFER[689]	// Внутренняя переменная var20
#define idvar20	30019	// Внутренняя переменная var20
#define var42	BUFFER[691]	// Внутренняя переменная var42
#define idvar42	30020	// Внутренняя переменная var42
#define var73	BUFFER[693]	// Внутренняя переменная var73
#define idvar73	30021	// Внутренняя переменная var73
#define var102	BUFFER[695]	// Внутренняя переменная var102
#define idvar102	30022	// Внутренняя переменная var102
#define var23	BUFFER[700]	// Внутренняя переменная var23
#define idvar23	30023	// Внутренняя переменная var23
#define var101	BUFFER[702]	// Внутренняя переменная var101
#define idvar101	30024	// Внутренняя переменная var101
#define var104	BUFFER[707]	// Внутренняя переменная var104
#define idvar104	30025	// Внутренняя переменная var104
#define var136	BUFFER[712]	// Внутренняя переменная var136
#define idvar136	30026	// Внутренняя переменная var136
#define var141	BUFFER[714]	// Внутренняя переменная var141
#define idvar141	30027	// Внутренняя переменная var141
#define var11	BUFFER[716]	// Внутренняя переменная var11
#define idvar11	30028	// Внутренняя переменная var11
#define var18	BUFFER[718]	// Внутренняя переменная var18
#define idvar18	30029	// Внутренняя переменная var18
#define var43	BUFFER[720]	// Внутренняя переменная var43
#define idvar43	30030	// Внутренняя переменная var43
#define var83	BUFFER[722]	// Внутренняя переменная var83
#define idvar83	30031	// Внутренняя переменная var83
#define var84	BUFFER[724]	// Внутренняя переменная var84
#define idvar84	30032	// Внутренняя переменная var84
#define var19	BUFFER[726]	// Внутренняя переменная var19
#define idvar19	30033	// Внутренняя переменная var19
#define var66	BUFFER[728]	// Внутренняя переменная var66
#define idvar66	30034	// Внутренняя переменная var66
#define var72	BUFFER[730]	// Внутренняя переменная var72
#define idvar72	30035	// Внутренняя переменная var72
#define var10	BUFFER[732]	// Внутренняя переменная var10
#define idvar10	30036	// Внутренняя переменная var10
#define var29	BUFFER[734]	// Внутренняя переменная var29
#define idvar29	30037	// Внутренняя переменная var29
#define var33	BUFFER[736]	// Внутренняя переменная var33
#define idvar33	30038	// Внутренняя переменная var33
#define var123	BUFFER[738]	// Внутренняя переменная var123
#define idvar123	30039	// Внутренняя переменная var123
#define var133	BUFFER[740]	// Внутренняя переменная var133
#define idvar133	30040	// Внутренняя переменная var133
#define var8	BUFFER[742]	// Внутренняя переменная var8
#define idvar8	30041	// Внутренняя переменная var8
#define var25	BUFFER[744]	// Внутренняя переменная var25
#define idvar25	30042	// Внутренняя переменная var25
#define var58	BUFFER[746]	// Внутренняя переменная var58
#define idvar58	30043	// Внутренняя переменная var58
#define var100	BUFFER[748]	// Внутренняя переменная var100
#define idvar100	30044	// Внутренняя переменная var100
#define var119	BUFFER[750]	// Внутренняя переменная var119
#define idvar119	30045	// Внутренняя переменная var119
#define var7	BUFFER[752]	// Внутренняя переменная var7
#define idvar7	30046	// Внутренняя переменная var7
#define var115	BUFFER[754]	// Внутренняя переменная var115
#define idvar115	30047	// Внутренняя переменная var115
#define var116	BUFFER[756]	// Внутренняя переменная var116
#define idvar116	30048	// Внутренняя переменная var116
#define var78	BUFFER[758]	// Внутренняя переменная var78
#define idvar78	30049	// Внутренняя переменная var78
#define var95	BUFFER[760]	// Внутренняя переменная var95
#define idvar95	30050	// Внутренняя переменная var95
#define var113	BUFFER[762]	// Внутренняя переменная var113
#define idvar113	30051	// Внутренняя переменная var113
#define var13	BUFFER[771]	// Внутренняя переменная var13
#define idvar13	30052	// Внутренняя переменная var13
#define var24	BUFFER[773]	// Внутренняя переменная var24
#define idvar24	30053	// Внутренняя переменная var24
#define var40	BUFFER[775]	// Внутренняя переменная var40
#define idvar40	30054	// Внутренняя переменная var40
#define var68	BUFFER[777]	// Внутренняя переменная var68
#define idvar68	30055	// Внутренняя переменная var68
#define var76	BUFFER[779]	// Внутренняя переменная var76
#define idvar76	30056	// Внутренняя переменная var76
#define var86	BUFFER[781]	// Внутренняя переменная var86
#define idvar86	30057	// Внутренняя переменная var86
#define var21	BUFFER[783]	// Внутренняя переменная var21
#define idvar21	30058	// Внутренняя переменная var21
#define var62	BUFFER[786]	// Внутренняя переменная var62
#define idvar62	30059	// Внутренняя переменная var62
#define var69	BUFFER[788]	// Внутренняя переменная var69
#define idvar69	30060	// Внутренняя переменная var69
#define var137	BUFFER[790]	// Внутренняя переменная var137
#define idvar137	30061	// Внутренняя переменная var137
#define var26	BUFFER[792]	// Внутренняя переменная var26
#define idvar26	30062	// Внутренняя переменная var26
#define var41	BUFFER[794]	// Внутренняя переменная var41
#define idvar41	30063	// Внутренняя переменная var41
#define var51	BUFFER[796]	// Внутренняя переменная var51
#define idvar51	30064	// Внутренняя переменная var51
#define var53	BUFFER[798]	// Внутренняя переменная var53
#define idvar53	30065	// Внутренняя переменная var53
#define var122	BUFFER[800]	// Внутренняя переменная var122
#define idvar122	30066	// Внутренняя переменная var122
#define vainSBool	BUFFER[802]	// Внутренняя переменная vainSBool
#define idvainSBool	30067	// Внутренняя переменная vainSBool
#define var127	BUFFER[804]	// Внутренняя переменная var127
#define idvar127	30068	// Внутренняя переменная var127
#define var129	BUFFER[809]	// Внутренняя переменная var129
#define idvar129	30069	// Внутренняя переменная var129
#define var14	BUFFER[811]	// Внутренняя переменная var14
#define idvar14	30070	// Внутренняя переменная var14
#define var30	BUFFER[813]	// Внутренняя переменная var30
#define idvar30	30071	// Внутренняя переменная var30
#define var34	BUFFER[815]	// Внутренняя переменная var34
#define idvar34	30072	// Внутренняя переменная var34
#define var90	BUFFER[817]	// Внутренняя переменная var90
#define idvar90	30073	// Внутренняя переменная var90
#define var109	BUFFER[819]	// Внутренняя переменная var109
#define idvar109	30074	// Внутренняя переменная var109
#define var98	BUFFER[821]	// Внутренняя переменная var98
#define idvar98	30075	// Внутренняя переменная var98
#define var110	BUFFER[823]	// Внутренняя переменная var110
#define idvar110	30076	// Внутренняя переменная var110
#define var9	BUFFER[825]	// Внутренняя переменная var9
#define idvar9	30077	// Внутренняя переменная var9
#define var27	BUFFER[827]	// Внутренняя переменная var27
#define idvar27	30078	// Внутренняя переменная var27
#define var36	BUFFER[829]	// Внутренняя переменная var36
#define idvar36	30079	// Внутренняя переменная var36
#define var67	BUFFER[831]	// Внутренняя переменная var67
#define idvar67	30080	// Внутренняя переменная var67
#define var81	BUFFER[833]	// Внутренняя переменная var81
#define idvar81	30081	// Внутренняя переменная var81
#define var28	BUFFER[835]	// Внутренняя переменная var28
#define idvar28	30082	// Внутренняя переменная var28
#define var121	BUFFER[837]	// Внутренняя переменная var121
#define idvar121	30083	// Внутренняя переменная var121
#define var56	BUFFER[839]	// Внутренняя переменная var56
#define idvar56	30084	// Внутренняя переменная var56
#define var22	BUFFER[841]	// Внутренняя переменная var22
#define idvar22	30085	// Внутренняя переменная var22
#define var31	BUFFER[843]	// Внутренняя переменная var31
#define idvar31	30086	// Внутренняя переменная var31
#define var59	BUFFER[845]	// Внутренняя переменная var59
#define idvar59	30087	// Внутренняя переменная var59
#define var140	BUFFER[847]	// Внутренняя переменная var140
#define idvar140	30088	// Внутренняя переменная var140
#define vainSLong	BUFFER[849]	// Внутренняя переменная vainSLong
#define idvainSLong	30089	// Внутренняя переменная vainSLong
#define var3	BUFFER[858]	// Внутренняя переменная var3
#define idvar3	30090	// Внутренняя переменная var3
#define var17	BUFFER[860]	// Внутренняя переменная var17
#define idvar17	30091	// Внутренняя переменная var17
#define var49	BUFFER[862]	// Внутренняя переменная var49
#define idvar49	30092	// Внутренняя переменная var49
#define var52	BUFFER[864]	// Внутренняя переменная var52
#define idvar52	30093	// Внутренняя переменная var52
#define var124	BUFFER[866]	// Внутренняя переменная var124
#define idvar124	30094	// Внутренняя переменная var124
#define var65	BUFFER[871]	// Внутренняя переменная var65
#define idvar65	30095	// Внутренняя переменная var65
#define var131	BUFFER[873]	// Внутренняя переменная var131
#define idvar131	30096	// Внутренняя переменная var131
#define var48	BUFFER[875]	// Внутренняя переменная var48
#define idvar48	30097	// Внутренняя переменная var48
#define var80	BUFFER[877]	// Внутренняя переменная var80
#define idvar80	30098	// Внутренняя переменная var80
#define var85	BUFFER[879]	// Внутренняя переменная var85
#define idvar85	30099	// Внутренняя переменная var85
#define var107	BUFFER[881]	// Внутренняя переменная var107
#define idvar107	30100	// Внутренняя переменная var107
#define var138	BUFFER[883]	// Внутренняя переменная var138
#define idvar138	30101	// Внутренняя переменная var138
#define var50	BUFFER[885]	// Внутренняя переменная var50
#define idvar50	30102	// Внутренняя переменная var50
#define var89	BUFFER[887]	// Внутренняя переменная var89
#define idvar89	30103	// Внутренняя переменная var89
#define var125	BUFFER[889]	// Внутренняя переменная var125
#define idvar125	30104	// Внутренняя переменная var125
#define var99	BUFFER[891]	// Внутренняя переменная var99
#define idvar99	30105	// Внутренняя переменная var99
#define var135	BUFFER[893]	// Внутренняя переменная var135
#define idvar135	30106	// Внутренняя переменная var135
#define var32	BUFFER[895]	// Внутренняя переменная var32
#define idvar32	30107	// Внутренняя переменная var32
#define var38	BUFFER[897]	// Внутренняя переменная var38
#define idvar38	30108	// Внутренняя переменная var38
#define var55	BUFFER[899]	// Внутренняя переменная var55
#define idvar55	30109	// Внутренняя переменная var55
#define var79	BUFFER[901]	// Внутренняя переменная var79
#define idvar79	30110	// Внутренняя переменная var79
#define var82	BUFFER[903]	// Внутренняя переменная var82
#define idvar82	30111	// Внутренняя переменная var82
#define var39	BUFFER[905]	// Внутренняя переменная var39
#define idvar39	30112	// Внутренняя переменная var39
#define vainSInt	BUFFER[907]	// Внутренняя переменная vainSInt
#define idvainSInt	30113	// Внутренняя переменная vainSInt
#define var134	BUFFER[910]	// Внутренняя переменная var134
#define idvar134	30114	// Внутренняя переменная var134
#define var6	BUFFER[912]	// Внутренняя переменная var6
#define idvar6	30115	// Внутренняя переменная var6
#define var15	BUFFER[914]	// Внутренняя переменная var15
#define idvar15	30116	// Внутренняя переменная var15
#define var47	BUFFER[916]	// Внутренняя переменная var47
#define idvar47	30117	// Внутренняя переменная var47
#define var54	BUFFER[918]	// Внутренняя переменная var54
#define idvar54	30118	// Внутренняя переменная var54
#define var118	BUFFER[920]	// Внутренняя переменная var118
#define idvar118	30119	// Внутренняя переменная var118
#define var16	BUFFER[922]	// Внутренняя переменная var16
#define idvar16	30120	// Внутренняя переменная var16
#define var63	BUFFER[924]	// Внутренняя переменная var63
#define idvar63	30121	// Внутренняя переменная var63
#define var92	BUFFER[926]	// Внутренняя переменная var92
#define idvar92	30122	// Внутренняя переменная var92
#define var97	BUFFER[928]	// Внутренняя переменная var97
#define idvar97	30123	// Внутренняя переменная var97
#define var114	BUFFER[930]	// Внутренняя переменная var114
#define idvar114	30124	// Внутренняя переменная var114
#define var96	BUFFER[939]	// Внутренняя переменная var96
#define idvar96	30125	// Внутренняя переменная var96
#define var106	BUFFER[941]	// Внутренняя переменная var106
#define idvar106	30126	// Внутренняя переменная var106
#define var120	BUFFER[943]	// Внутренняя переменная var120
#define idvar120	30127	// Внутренняя переменная var120
#define var12	BUFFER[945]	// Внутренняя переменная var12
#define idvar12	30128	// Внутренняя переменная var12
#define var46	BUFFER[947]	// Внутренняя переменная var46
#define idvar46	30129	// Внутренняя переменная var46
#define var60	BUFFER[949]	// Внутренняя переменная var60
#define idvar60	30130	// Внутренняя переменная var60
#define var61	BUFFER[951]	// Внутренняя переменная var61
#define idvar61	30131	// Внутренняя переменная var61
#define var74	BUFFER[953]	// Внутренняя переменная var74
#define idvar74	30132	// Внутренняя переменная var74
#define var126	BUFFER[955]	// Внутренняя переменная var126
#define idvar126	30133	// Внутренняя переменная var126
#define var108	BUFFER[957]	// Внутренняя переменная var108
#define idvar108	30134	// Внутренняя переменная var108
#define var130	BUFFER[959]	// Внутренняя переменная var130
#define idvar130	30135	// Внутренняя переменная var130
#define var139	BUFFER[962]	// Внутренняя переменная var139
#define idvar139	30136	// Внутренняя переменная var139
#define var5	BUFFER[964]	// Внутренняя переменная var5
#define idvar5	30137	// Внутренняя переменная var5
#define var35	BUFFER[966]	// Внутренняя переменная var35
#define idvar35	30138	// Внутренняя переменная var35
#define var57	BUFFER[968]	// Внутренняя переменная var57
#define idvar57	30139	// Внутренняя переменная var57
#define var71	BUFFER[970]	// Внутренняя переменная var71
#define idvar71	30140	// Внутренняя переменная var71
#define var94	BUFFER[972]	// Внутренняя переменная var94
#define idvar94	30141	// Внутренняя переменная var94
#define var44	BUFFER[974]	// Внутренняя переменная var44
#define idvar44	30142	// Внутренняя переменная var44
#define var70	BUFFER[976]	// Внутренняя переменная var70
#define idvar70	30143	// Внутренняя переменная var70
#define var103	BUFFER[978]	// Внутренняя переменная var103
#define idvar103	30144	// Внутренняя переменная var103
#define var117	BUFFER[980]	// Внутренняя переменная var117
#define idvar117	30145	// Внутренняя переменная var117
#define vainSChar	BUFFER[982]	// Внутренняя переменная vainSChar
#define idvainSChar	30146	// Внутренняя переменная vainSChar
#pragma pack(push,1)
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	 ...
	 30000	,8	,1	,&var112},	//Внутренняя переменная var112
	 30001	,1	,1	,&var1},	//Внутренняя переменная var1
	 30002	,1	,1	,&var2},	//Внутренняя переменная var2
	 30003	,1	,1	,&var45},	//Внутренняя переменная var45
	 30004	,1	,1	,&var87},	//Внутренняя переменная var87
	 30005	,1	,1	,&var88},	//Внутренняя переменная var88
	 30006	,8	,1	,&vainSFloat},	//Внутренняя переменная vainSFloat
	 30007	,1	,1	,&var64},	//Внутренняя переменная var64
	 30008	,1	,1	,&var91},	//Внутренняя переменная var91
	 30009	,1	,1	,&var93},	//Внутренняя переменная var93
	 30010	,1	,1	,&var111},	//Внутренняя переменная var111
	 30011	,1	,1	,&var142},	//Внутренняя переменная var142
	 30012	,1	,1	,&var128},	//Внутренняя переменная var128
	 30013	,	,1	,&var132},	//Внутренняя переменная var132
	 30014	,1	,1	,&var4},	//Внутренняя переменная var4
	 30015	,1	,1	,&var37},	//Внутренняя переменная var37
	 30016	,1	,1	,&var75},	//Внутренняя переменная var75
	 30017	,1	,1	,&var77},	//Внутренняя переменная var77
	 30018	,8	,1	,&var105},	//Внутренняя переменная var105
	 30019	,1	,1	,&var20},	//Внутренняя переменная var20
	 30020	,1	,1	,&var42},	//Внутренняя переменная var42
	 30021	,1	,1	,&var73},	//Внутренняя переменная var73
	 30022	,8	,1	,&var102},	//Внутренняя переменная var102
	 30023	,1	,1	,&var23},	//Внутренняя переменная var23
	 30024	,8	,1	,&var101},	//Внутренняя переменная var101
	 30025	,8	,1	,&var104},	//Внутренняя переменная var104
	 30026	,1	,1	,&var136},	//Внутренняя переменная var136
	 30027	,1	,1	,&var141},	//Внутренняя переменная var141
	 30028	,1	,1	,&var11},	//Внутренняя переменная var11
	 30029	,1	,1	,&var18},	//Внутренняя переменная var18
	 30030	,1	,1	,&var43},	//Внутренняя переменная var43
	 30031	,1	,1	,&var83},	//Внутренняя переменная var83
	 30032	,1	,1	,&var84},	//Внутренняя переменная var84
	 30033	,1	,1	,&var19},	//Внутренняя переменная var19
	 30034	,1	,1	,&var66},	//Внутренняя переменная var66
	 30035	,1	,1	,&var72},	//Внутренняя переменная var72
	 30036	,1	,1	,&var10},	//Внутренняя переменная var10
	 30037	,1	,1	,&var29},	//Внутренняя переменная var29
	 30038	,1	,1	,&var33},	//Внутренняя переменная var33
	 30039	,1	,1	,&var123},	//Внутренняя переменная var123
	 30040	,1	,1	,&var133},	//Внутренняя переменная var133
	 30041	,1	,1	,&var8},	//Внутренняя переменная var8
	 30042	,1	,1	,&var25},	//Внутренняя переменная var25
	 30043	,1	,1	,&var58},	//Внутренняя переменная var58
	 30044	,1	,1	,&var100},	//Внутренняя переменная var100
	 30045	,1	,1	,&var119},	//Внутренняя переменная var119
	 30046	,1	,1	,&var7},	//Внутренняя переменная var7
	 30047	,1	,1	,&var115},	//Внутренняя переменная var115
	 30048	,1	,1	,&var116},	//Внутренняя переменная var116
	 30049	,1	,1	,&var78},	//Внутренняя переменная var78
	 30050	,1	,1	,&var95},	//Внутренняя переменная var95
	 30051	,11	,1	,&var113},	//Внутренняя переменная var113
	 30052	,1	,1	,&var13},	//Внутренняя переменная var13
	 30053	,1	,1	,&var24},	//Внутренняя переменная var24
	 30054	,1	,1	,&var40},	//Внутренняя переменная var40
	 30055	,1	,1	,&var68},	//Внутренняя переменная var68
	 30056	,1	,1	,&var76},	//Внутренняя переменная var76
	 30057	,1	,1	,&var86},	//Внутренняя переменная var86
	 30058	,3	,1	,&var21},	//Внутренняя переменная var21
	 30059	,1	,1	,&var62},	//Внутренняя переменная var62
	 30060	,1	,1	,&var69},	//Внутренняя переменная var69
	 30061	,1	,1	,&var137},	//Внутренняя переменная var137
	 30062	,1	,1	,&var26},	//Внутренняя переменная var26
	 30063	,1	,1	,&var41},	//Внутренняя переменная var41
	 30064	,1	,1	,&var51},	//Внутренняя переменная var51
	 30065	,1	,1	,&var53},	//Внутренняя переменная var53
	 30066	,1	,1	,&var122},	//Внутренняя переменная var122
	 30067	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	 30068	,8	,1	,&var127},	//Внутренняя переменная var127
	 30069	,1	,1	,&var129},	//Внутренняя переменная var129
	 30070	,1	,1	,&var14},	//Внутренняя переменная var14
	 30071	,1	,1	,&var30},	//Внутренняя переменная var30
	 30072	,1	,1	,&var34},	//Внутренняя переменная var34
	 30073	,1	,1	,&var90},	//Внутренняя переменная var90
	 30074	,1	,1	,&var109},	//Внутренняя переменная var109
	 30075	,1	,1	,&var98},	//Внутренняя переменная var98
	 30076	,1	,1	,&var110},	//Внутренняя переменная var110
	 30077	,1	,1	,&var9},	//Внутренняя переменная var9
	 30078	,1	,1	,&var27},	//Внутренняя переменная var27
	 30079	,1	,1	,&var36},	//Внутренняя переменная var36
	 30080	,1	,1	,&var67},	//Внутренняя переменная var67
	 30081	,1	,1	,&var81},	//Внутренняя переменная var81
	 30082	,1	,1	,&var28},	//Внутренняя переменная var28
	 30083	,1	,1	,&var121},	//Внутренняя переменная var121
	 30084	,1	,1	,&var56},	//Внутренняя переменная var56
	 30085	,1	,1	,&var22},	//Внутренняя переменная var22
	 30086	,1	,1	,&var31},	//Внутренняя переменная var31
	 30087	,1	,1	,&var59},	//Внутренняя переменная var59
	 30088	,1	,1	,&var140},	//Внутренняя переменная var140
	 30089	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	 30090	,1	,1	,&var3},	//Внутренняя переменная var3
	 30091	,1	,1	,&var17},	//Внутренняя переменная var17
	 30092	,1	,1	,&var49},	//Внутренняя переменная var49
	 30093	,1	,1	,&var52},	//Внутренняя переменная var52
	 30094	,8	,1	,&var124},	//Внутренняя переменная var124
	 30095	,1	,1	,&var65},	//Внутренняя переменная var65
	 30096	,1	,1	,&var131},	//Внутренняя переменная var131
	 30097	,1	,1	,&var48},	//Внутренняя переменная var48
	 30098	,1	,1	,&var80},	//Внутренняя переменная var80
	 30099	,1	,1	,&var85},	//Внутренняя переменная var85
	 30100	,1	,1	,&var107},	//Внутренняя переменная var107
	 30101	,1	,1	,&var138},	//Внутренняя переменная var138
	 30102	,1	,1	,&var50},	//Внутренняя переменная var50
	 30103	,1	,1	,&var89},	//Внутренняя переменная var89
	 30104	,1	,1	,&var125},	//Внутренняя переменная var125
	 30105	,1	,1	,&var99},	//Внутренняя переменная var99
	 30106	,1	,1	,&var135},	//Внутренняя переменная var135
	 30107	,1	,1	,&var32},	//Внутренняя переменная var32
	 30108	,1	,1	,&var38},	//Внутренняя переменная var38
	 30109	,1	,1	,&var55},	//Внутренняя переменная var55
	 30110	,1	,1	,&var79},	//Внутренняя переменная var79
	 30111	,1	,1	,&var82},	//Внутренняя переменная var82
	 30112	,1	,1	,&var39},	//Внутренняя переменная var39
	 30113	,3	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	 30114	,1	,1	,&var134},	//Внутренняя переменная var134
	 30115	,1	,1	,&var6},	//Внутренняя переменная var6
	 30116	,1	,1	,&var15},	//Внутренняя переменная var15
	 30117	,1	,1	,&var47},	//Внутренняя переменная var47
	 30118	,1	,1	,&var54},	//Внутренняя переменная var54
	 30119	,1	,1	,&var118},	//Внутренняя переменная var118
	 30120	,1	,1	,&var16},	//Внутренняя переменная var16
	 30121	,1	,1	,&var63},	//Внутренняя переменная var63
	 30122	,1	,1	,&var92},	//Внутренняя переменная var92
	 30123	,1	,1	,&var97},	//Внутренняя переменная var97
	 30124	,11	,1	,&var114},	//Внутренняя переменная var114
	 30125	,1	,1	,&var96},	//Внутренняя переменная var96
	 30126	,1	,1	,&var106},	//Внутренняя переменная var106
	 30127	,1	,1	,&var120},	//Внутренняя переменная var120
	 30128	,1	,1	,&var12},	//Внутренняя переменная var12
	 30129	,1	,1	,&var46},	//Внутренняя переменная var46
	 30130	,1	,1	,&var60},	//Внутренняя переменная var60
	 30131	,1	,1	,&var61},	//Внутренняя переменная var61
	 30132	,1	,1	,&var74},	//Внутренняя переменная var74
	 30133	,1	,1	,&var126},	//Внутренняя переменная var126
	 30134	,1	,1	,&var108},	//Внутренняя переменная var108
	 30135	,	,1	,&var130},	//Внутренняя переменная var130
	 30136	,1	,1	,&var139},	//Внутренняя переменная var139
	 30137	,1	,1	,&var5},	//Внутренняя переменная var5
	 30138	,1	,1	,&var35},	//Внутренняя переменная var35
	 30139	,1	,1	,&var57},	//Внутренняя переменная var57
	 30140	,1	,1	,&var71},	//Внутренняя переменная var71
	 30141	,1	,1	,&var94},	//Внутренняя переменная var94
	 30142	,1	,1	,&var44},	//Внутренняя переменная var44
	 30143	,1	,1	,&var70},	//Внутренняя переменная var70
	 30144	,1	,1	,&var103},	//Внутренняя переменная var103
	 30145	,1	,1	,&var117},	//Внутренняя переменная var117
	 30146	,	,1	,&vainSChar},	//Внутренняя переменная vainSChar
	{-1,0,NULL},
}
...
static ModbusRegister coil_Baz1[]={
	{&R0VN61LZ1,2,13},	//( - , Baz1) ПС по мощности канал 1
	{&R0VN64LZ1,2,10},	//( - , Baz1) ПС по мощности канал 4
	{&A0EE07LZ1,2,2},	//( - , Baz1) Исправность сети АКНП3
	{&R0VN63LZ1,2,11},	//( - , Baz1) ПС по мощности канал 3
	{&R0VN62LZ1,2,12},	//( - , Baz1) ПС по мощности канал 2
	{&R0VW13LDU,2,9},	//( - , Baz1, SBz1DU) Индикация выбора АЗ1 или АЗ1+АЗ2
	{&R0VN70LZ1,2,5},	//( - , Baz1) АЗ по АС мощности РУ
	{&A0EE06LZ1,2,3},	//( - , Baz1) Исправность сети АКНП2
	{&A0EE05LZ1,2,4},	//( - , Baz1) Исправность сети АКНП1
	{&R0VW23LDU,2,8},	//( - , Baz1, SBz1DU) Индикация выбора АЗ2 или АЗ1+АЗ2
	{&A0EE08LZ1,2,1},	//( - , Baz1) Исправность сети АКНП4
	{&R0MD34LP1,2,6},	//( - , Baz1) Кнопка (Квитировать)
	{&R0EE02LDU,2,0},	//( - , Baz1) Питание  АКНП  отключить
	{&R7II73LZ1,2,7},	//( - K07VDSR, Baz1) Сработала АС II УР РАД
	{NULL,0,0},
}
#pragma pop
#pragma pack(push,1)
static ModbusRegister di_Baz1[]={
	{&B3VZ11LZ1,2,46},	//( - , Baz1) АЗ от НУП ИС2
	{&B0VN81LZ1,2,0},	//( - , Baz1) АЗ по АС периода разгона АЗ2
	{&A0VZ71LZ1,2,7},	//( - , Baz1) Обобщенный сигнал АС по АЗ1
	{&B2VP81LZ1,2,35},	//( - , Baz1) Давление СБРОС РБ2 в норме
	{&R0VN76LZ1,2,19},	//( - K02VDSR, Baz1) АС по периоду разгона канал  2
	{&A0VN71LZ1,2,3},	//( - , Baz1, SBz1DU) АЗ по АС мощности  АЗ1
	{&A0EE04LZ1,2,10},	//( - , Baz1, SBz1DU) Исправность АКНП4
	{&B0VZ71LZ1,2,4},	//( - , Baz1) Обобщенный сигнал АС по АЗ2
	{&B0VT61LZ1,2,26},	//( - , Baz1) ПС по температуре в АЗ2
	{&A2VP81LZ1,2,34},	//( - , Baz1) Давление СБРОС РБ1 в норме
	{&A2VP51LZ1,2,38},	//( - , Baz1) Давление СБРОС РБ1 ниже ПС
	{&A0EE03LZ1,2,8},	//( - , Baz1, SBz1DU) Исправность АКНП3
	{&A0EE02LZ1,2,9},	//( - , Baz1, SBz1DU) Исправность АКНП2
	{&R0VN80LZ1,2,12},	//( - , Baz1) АЗ по АС периода разгона РУ
	{&A2VP41LZ1,2,39},	//( - , Baz1) Давление СБРОС РБ1 ниже АС
	{&R0VN65LZ1,2,53},	//( - , Baz1) ПС по периоду разгона канал 1
	{&B2VP41LZ1,2,37},	//( - , Baz1) Давление СБРОС РБ2 ниже АС
	{&R0VN66LZ1,2,52},	//( - , Baz1) ПС по периоду разгона канал 2
	{&B0EE00LZ1,2,5},	//( - , Baz1) Исправность АКНП АЗ2
	{&R0VN73LZ1,2,18},	//( - K01VDSR, Baz1) АС по мощности канал 3
	{&R0VN75LZ1,2,21},	//( - K02VDSR, Baz1) АС по периоду разгона канал 1
	{&A0VP41LZ1,2,32},	//( - , Baz1) Давление АЗ1 ниже АС
	{&R0VN74LZ1,2,16},	//( - K01VDSR, Baz1) АС по мощности канал 4
	{&R0VN72LZ1,2,20},	//( - K01VDSR, Baz1) АС по мощности канал 2
	{&R0VN69LZ1,2,45},	//( - , Baz1) ПС по усредненному периоду
	{&A0EE01LZ1,2,11},	//( - , Baz1, SBz1DU) Исправность АКНП1
	{&R7II71LZ1,2,24},	//( - K05VDSR, Baz1) Сработала АС IУР РАД (датчик 1)
	{&R0ET01LZ1,2,33},	//( - , Baz1) Признак наличия неисправности по температуре  АЗ1
	{&R7II72LZ1,2,23},	//( - K06VDSR, Baz1) Сработала АС IУР РАД  (датчик 2)
	{&B0VP41LZ1,2,31},	//( - , Baz1) Давление АЗ2 ниже АС
	{&R0VN78LZ1,2,15},	//( - K02VDSR, Baz1) АС по периоду разгона канал  4
	{&A0VT71LZ1,2,42},	//( - , Baz1, SBz1DU) АС по температуре в АЗ1
	{&B3VZ31LZ1,2,48},	//( - , Baz1) АЗ от ВУ ИС2
	{&R0VP73LZ1,2,27},	//( - , Baz1, SBz1DU) ПС давления для РУ
	{&B1VP41LZ1,2,40},	//( - , Baz1, SBz1DU) Давление СБРОС ББ2 ниже АС
	{&R0VN67LZ1,2,51},	//( - , Baz1) ПС по периоду разгона канал 3
	{&R0VN68LZ1,2,50},	//( - , Baz1) ПС по периоду разгона канал 4
	{&A0VP71LZ1,2,29},	//( - , Baz1, SBz1DU) АЗ по АС любого давления для АЗ1
	{&R0VZ71LZ1,2,13},	//( - K05FDSR, Baz1) Обобщенный сигнал АЗ 1 канала
	{&TestDiagnBaz1,2,14},	//( - , Baz1) Неисправность от диагностики
	{&B0VP71LZ1,2,28},	//( - , Baz1, SBz1DU) АЗ по АС любого давления для АЗ2
	{&B2VP51LZ1,2,36},	//( - , Baz1) Давление СБРОС РБ2 ниже ПС
	{&A1VP41LZ1,2,41},	//( - , Baz1, SBz1DU) Давление СБРОС ББ1 ниже АС
	{&R0VN79LZ1,2,44},	//( - , Baz1) АС по усредненному периоду
	{&A0VN81LZ1,2,1},	//( - , Baz1) АЗ по АС периода разгона АЗ1
	{&R0ET02LZ1,2,30},	//( - , Baz1) Признак наличия неисправности по температуре АЗ2
	{&A0EE00LZ1,2,6},	//( - , Baz1) Исправность АКНП АЗ1
	{&A3VZ11LZ1,2,47},	//( - , Baz1) АЗ от НУП ИС1
	{&A3VZ31LZ1,2,49},	//( - , Baz1) АЗ от ВУ ИС1
	{&B0VN71LZ1,2,2},	//( - , Baz1, SBz1DU) АЗ по АС мощности  АЗ2
	{&R0VN71LZ1,2,22},	//( - K01VDSR, Baz1) АС по мощности канал 1
	{&R0VN77LZ1,2,17},	//( - K02VDSR, Baz1) АС по периоду разгона канал  3
	{&A0VT61LZ1,2,43},	//( - , Baz1) ПС по температуре в АЗ1
	{&B0VT71LZ1,2,25},	//( - , Baz1, SBz1DU) АС по температуре в АЗ2
	{NULL,0,0},
}
#pragma pop
#pragma pack(push,1)
...
static ModbusRegister di_DiagnBaz1[]={
	{&R0DE3DLZ1,2,5},	//( - , DiagnBaz1) диагностика шкафа Баз1 БП5/24Д место 6
	{&R0DE3CLZ1,2,4},	//( - , DiagnBaz1) диагностика шкафа Баз1 БП5/24Д место 5
	{&R0DEB1LZ1,2,0},	//( - S10SBK, DiagnBaz1) диагностика шкафа Баз1 БП5 место 5
	{&R0DEB2LZ1,2,1},	//( - S11SBK, DiagnBaz1) диагностика шкафа Баз1 БП24Д место 5
	{&R0DEB4LZ1,2,2},	//( - S13SBK, DiagnBaz1) диагностика шкафа Баз1 БП24Д место 6
	{&R0DEB3LZ1,2,3},	//( - S12SBK, DiagnBaz1) диагностика шкафа Баз1 БП5 место 6
	{NULL,0,0},
}
#pragma pop
#pragma pack(push,1)
...
static ModbusDevice modbuses[]={
	{0,5002,&coil_Baz1[0],&di_Baz1[0],&di_Baz1[0],&hr_Baz1[0],NULL,NULL,NULL,0},	//Общий слэйв
	{0,5010,&coil_SBz1DU[0],&di_SBz1DU[0],&di_SBz1DU[0],&hr_SBz1DU[0],NULL,NULL,NULL,0},	//Слэйв для DU
	{0,5005,&coil_DiagnBaz1[0],&di_DiagnBaz1[0],&di_DiagnBaz1[0],&hr_DiagnBaz1[0],NULL,NULL,NULL,0},	//Диагностика Baz1
	{1,5003,&coil_MBz1S[0],&di_MBz1S[0],&di_MBz1S[0],&hr_MBz1S[0],NULL,MBz1S_ip1,MBz1S_ip2,100},	//Мастер Баз1 в SCM
	{1,5015,&coil_MBz1A1[0],&di_MBz1A1[0],&di_MBz1A1[0],&hr_MBz1A1[0],NULL,MBz1A1_ip1,MBz1A1_ip2,20},	//Мастер Баз1 в AKNP1
	{1,5016,&coil_MBz1A2[0],&di_MBz1A2[0],&di_MBz1A2[0],&hr_MBz1A2[0],NULL,MBz1A2_ip1,MBz1A2_ip2,20},	//Мастер Баз1 в AKNP2
	{1,5017,&coil_MBz1A3[0],&di_MBz1A3[0],&di_MBz1A3[0],&hr_MBz1A3[0],NULL,MBz1A3_ip1,MBz1A3_ip2,20},	//Мастер Баз1 в AKNP3
	{1,5018,&coil_MBz1A4[0],&di_MBz1A4[0],&di_MBz1A4[0],&hr_MBz1A4[0],NULL,MBz1A4_ip1,MBz1A4_ip2,20},	//Мастер Баз1 в AKNP4
...
void MainCycle(void){
	if ((getAsShort(R0S01LZ1) == 2) || (getAsShort(R0S01LZ1) == 3)) {
		if(delay++<200) return;
