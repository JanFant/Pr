...
#define A1VP41LZ1	 BUFFER[292]	//( - , SBz1DU) Давление СБРОС ББ1 ниже АС
#define idA1VP41LZ1	 120	//( - , SBz1DU) Давление СБРОС ББ1 ниже АС
#define B1VP41LZ1	 BUFFER[294]	//( - , SBz1DU) Давление СБРОС ББ2 ниже АС
#define idB1VP41LZ1	 121	//( - , SBz1DU) Давление СБРОС ББ2 ниже АС
...
static VarCtrl allVariables[]={      // Описание всех переменных
	...
	{ 120	,1	,1	, &A1VP41LZ1},	//( - , SBz1DU) Давление СБРОС ББ1 ниже АС
	{ 121	,1	,1	, &B1VP41LZ1},	//( - , SBz1DU) Давление СБРОС ББ2 ниже АС
...
static ModbusRegister di_Baz1[]={  // 
	...
	{&B0VP71LZ1,1,29},	//( - , Baz1, SBz1DU) АЗ по АС любого давления для АЗ2
	{&A0VP71LZ1,1,30},	//( - , Baz1, SBz1DU) АЗ по АС любого давления для АЗ1
	{&R0ET02LZ1,1,31},	//( - , Baz1) Признак наличия неисправности по температуре АЗ2
	{&B0VP41LZ1,1,32},	//( - , Baz1) Давление АЗ2 ниже АС
	{&A0VP41LZ1,1,33},	//( - , Baz1) Давление АЗ1 ниже АС
	{&R0ET01LZ1,1,34},	//( - , Baz1) Признак наличия неисправности по температуре  АЗ1
	{&A2VP81LZ1,1,35},	//( - , Baz1) Давление СБРОС РБ1 в норме
	{&B2VP81LZ1,1,36},	//( - , Baz1) Давление СБРОС РБ2 в норме
	{&B2VP51LZ1,1,37},	//( - , Baz1) Давление СБРОС РБ2 ниже ПС
	{&B2VP41LZ1,1,38},	//( - , Baz1) Давление СБРОС РБ2 ниже АС
	{&A2VP51LZ1,1,39},	//( - , Baz1) Давление СБРОС РБ1 ниже ПС
	{&A2VP41LZ1,1,40},	//( - , Baz1) Давление СБРОС РБ1 ниже АС
	{&A0VT71LZ1,1,41},	//( - , Baz1, SBz1DU) АС по температуре в АЗ1
	{&A0VT61LZ1,1,42},	//( - , Baz1) ПС по температуре в АЗ1
	{&R0VN80LZ1,1,43},	//( - , Baz1) АЗ по АС периода разгона РУ
...
static ModbusRegister ir_Baz1[]={  // 
	...
	{&R0VN04RZ1,8,7},	//( - , Baz1) Уровень мощности по каналу 4
	{&R0VN03RZ1,8,9},	//( - , Baz1) Уровень мощности по каналу 3
	{&R0VN02RZ1,8,11},	//( - , Baz1) Уровень мощности по каналу 2
	{&R0VN01RZ1,8,13},	//( - , Baz1) Уровень мощности по каналу 1
	{&A0EP02IZ1,3,15},	//( - , Baz1) Индикатор -Давление  АЗ1 ниже АС
	{&B0EP02IZ1,3,16},	//( - , Baz1) Индикатор -Давление  АЗ2 ниже АС
	{&B2CP01RZ1,8,17},	//( - , Baz1) Текущее давление СБРОС РБ2
	{&A2CP01RZ1,8,19},	//( - , Baz1) Текущее давление СБРОС РБ1
	{&A0CT01IZ1,8,21},	//( - , Baz1, SBz1DU) Температура АЗ1-1
	{&R0VR02RZ1,8,23},	//( - , Baz1) Усредненная реактивность
	{&R0VN09RZ1,8,25},	//( - , Baz1, SBz1DU) Усредненный период разгона
	{&R0VN08RZ1,8,27},	//( - , Baz1) Период разгона по каналу 4
	{&R0VN07RZ1,8,29},	//( - , Baz1) Период разгона по каналу 3
	{&R0VN06RZ1,8,31},	//( - , Baz1) Период разгона по каналу 2
	{&R0VN05RZ1,8,33},	//( - , Baz1) Период разгона по каналу 1
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
