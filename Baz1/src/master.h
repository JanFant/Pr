...
static ModbusRegister coil_Baz1[]={  // 
	...
	{&R7II73LZ1,1,9},	//( - K07VDSR, Baz1) Сработала АС II УР РАД
	{&R0VW23LDU,1,10},	//( - , Baz1, SBz1DU) Индикация выбора АЗ2 или АЗ1+АЗ2
	{&R0VW13LDU,1,11},	//( - , Baz1, SBz1DU) Индикация выбора АЗ1 или АЗ1+АЗ2
	{&R0VN64LZ1,1,12},	//( - , Baz1) ПС по мощности канал 4
	{&R0VN63LZ1,1,13},	//( - , Baz1) ПС по мощности канал 3
	{&R0VN62LZ1,1,14},	//( - , Baz1) ПС по мощности канал 2
	{&R0VN61LZ1,1,15},	//( - , Baz1) ПС по мощности канал 1
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
static ModbusRegister di_Baz1[]={  // 
	...
	{&R0VZ71LZ1,1,43},	//( - K05FDSR, Baz1) Обобщенный сигнал АЗ 1 канала
