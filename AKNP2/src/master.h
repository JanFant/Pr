...
#define var28	BUFFER[407]	// Внутренняя переменная var28
#define idvar28	108	// Внутренняя переменная var28
#define var3	BUFFER[409]	// Внутренняя переменная var3
#define idvar3	109	// Внутренняя переменная var3
#define var4	BUFFER[414]	// Внутренняя переменная var4
#define idvar4	110	// Внутренняя переменная var4
#define var20	BUFFER[419]	// Внутренняя переменная var20
#define idvar20	111	// Внутренняя переменная var20
#define var23	BUFFER[424]	// Внутренняя переменная var23
#define idvar23	112	// Внутренняя переменная var23
#define var26	BUFFER[429]	// Внутренняя переменная var26
#define idvar26	113	// Внутренняя переменная var26
#define vainSFloat	BUFFER[431]	// Внутренняя переменная vainSFloat
#define idvainSFloat	114	// Внутренняя переменная vainSFloat
#define var10	BUFFER[436]	// Внутренняя переменная var10
#define idvar10	115	// Внутренняя переменная var10
#define var18	BUFFER[438]	// Внутренняя переменная var18
#define idvar18	116	// Внутренняя переменная var18
#define var21	BUFFER[443]	// Внутренняя переменная var21
#define idvar21	117	// Внутренняя переменная var21
#define var22	BUFFER[446]	// Внутренняя переменная var22
#define idvar22	118	// Внутренняя переменная var22
#define var32	BUFFER[448]	// Внутренняя переменная var32
#define idvar32	119	// Внутренняя переменная var32
#define var12	BUFFER[453]	// Внутренняя переменная var12
#define idvar12	120	// Внутренняя переменная var12
#define var16	BUFFER[455]	// Внутренняя переменная var16
#define idvar16	121	// Внутренняя переменная var16
#define var30	BUFFER[460]	// Внутренняя переменная var30
#define idvar30	122	// Внутренняя переменная var30
#define var24	BUFFER[462]	// Внутренняя переменная var24
#define idvar24	123	// Внутренняя переменная var24
#define var1	BUFFER[464]	// Внутренняя переменная var1
#define idvar1	124	// Внутренняя переменная var1
#define var6	BUFFER[469]	// Внутренняя переменная var6
#define idvar6	125	// Внутренняя переменная var6
#define var13	BUFFER[474]	// Внутренняя переменная var13
#define idvar13	126	// Внутренняя переменная var13
#define var14	BUFFER[476]	// Внутренняя переменная var14
#define idvar14	127	// Внутренняя переменная var14
#define var15	BUFFER[479]	// Внутренняя переменная var15
#define idvar15	128	// Внутренняя переменная var15
#define var2	BUFFER[484]	// Внутренняя переменная var2
#define idvar2	129	// Внутренняя переменная var2
#define var31	BUFFER[489]	// Внутренняя переменная var31
#define idvar31	130	// Внутренняя переменная var31
#define vainSBool	BUFFER[491]	// Внутренняя переменная vainSBool
#define idvainSBool	131	// Внутренняя переменная vainSBool
#define var29	BUFFER[493]	// Внутренняя переменная var29
#define idvar29	132	// Внутренняя переменная var29
#define var33	BUFFER[495]	// Внутренняя переменная var33
#define idvar33	133	// Внутренняя переменная var33
#define vainSLong	BUFFER[497]	// Внутренняя переменная vainSLong
#define idvainSLong	134	// Внутренняя переменная vainSLong
#define var8	BUFFER[506]	// Внутренняя переменная var8
#define idvar8	135	// Внутренняя переменная var8
#define var9	BUFFER[508]	// Внутренняя переменная var9
#define idvar9	136	// Внутренняя переменная var9
#define var11	BUFFER[510]	// Внутренняя переменная var11
#define idvar11	137	// Внутренняя переменная var11
#define var25	BUFFER[512]	// Внутренняя переменная var25
#define idvar25	138	// Внутренняя переменная var25
#define var27	BUFFER[514]	// Внутренняя переменная var27
#define idvar27	139	// Внутренняя переменная var27
#define var17	BUFFER[516]	// Внутренняя переменная var17
#define idvar17	140	// Внутренняя переменная var17
#define vainSInt	BUFFER[518]	// Внутренняя переменная vainSInt
#define idvainSInt	141	// Внутренняя переменная vainSInt
#define var5	BUFFER[521]	// Внутренняя переменная var5
#define idvar5	142	// Внутренняя переменная var5
#define var7	BUFFER[526]	// Внутренняя переменная var7
#define idvar7	143	// Внутренняя переменная var7
#define var19	BUFFER[531]	// Внутренняя переменная var19
...
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{108	,1	,1	,&var28},	//Внутренняя переменная var28
	{109	,8	,1	,&var3},	//Внутренняя переменная var3
	{110	,8	,1	,&var4},	//Внутренняя переменная var4
	{111	,8	,1	,&var20},	//Внутренняя переменная var20
	{112	,8	,1	,&var23},	//Внутренняя переменная var23
	{113	,1	,1	,&var26},	//Внутренняя переменная var26
	{114	,8	,1	,&vainSFloat},	//Внутренняя переменная vainSFloat
	{115	,1	,1	,&var10},	//Внутренняя переменная var10
	{116	,8	,1	,&var18},	//Внутренняя переменная var18
	{117	,3	,1	,&var21},	//Внутренняя переменная var21
	{118	,1	,1	,&var22},	//Внутренняя переменная var22
	{119	,8	,1	,&var32},	//Внутренняя переменная var32
	{120	,1	,1	,&var12},	//Внутренняя переменная var12
	{121	,8	,1	,&var16},	//Внутренняя переменная var16
	{122	,1	,1	,&var30},	//Внутренняя переменная var30
	{123	,1	,1	,&var24},	//Внутренняя переменная var24
	{124	,8	,1	,&var1},	//Внутренняя переменная var1
	{125	,8	,1	,&var6},	//Внутренняя переменная var6
	{126	,1	,1	,&var13},	//Внутренняя переменная var13
	{127	,3	,1	,&var14},	//Внутренняя переменная var14
	{128	,8	,1	,&var15},	//Внутренняя переменная var15
	{129	,8	,1	,&var2},	//Внутренняя переменная var2
	{130	,1	,1	,&var31},	//Внутренняя переменная var31
	{131	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	{132	,1	,1	,&var29},	//Внутренняя переменная var29
	{133	,1	,1	,&var33},	//Внутренняя переменная var33
	{134	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	{135	,1	,1	,&var8},	//Внутренняя переменная var8
	{136	,1	,1	,&var9},	//Внутренняя переменная var9
	{137	,1	,1	,&var11},	//Внутренняя переменная var11
	{138	,1	,1	,&var25},	//Внутренняя переменная var25
	{139	,1	,1	,&var27},	//Внутренняя переменная var27
	{140	,1	,1	,&var17},	//Внутренняя переменная var17
	{141	,3	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	{142	,8	,1	,&var5},	//Внутренняя переменная var5
	{143	,8	,1	,&var7},	//Внутренняя переменная var7
	{144	,8	,1	,&var19},	//Внутренняя переменная var19
	{-1,0,NULL},
};
