...
#define idvar29	108	// Внутренняя переменная var29
...
#define var21	BUFFER[421]	// Внутренняя переменная var21
#define idvar21	112	// Внутренняя переменная var21
#define var14	BUFFER[424]	// Внутренняя переменная var14
#define idvar14	113	// Внутренняя переменная var14
#define var18	BUFFER[427]	// Внутренняя переменная var18
#define idvar18	114	// Внутренняя переменная var18
#define var31	BUFFER[432]	// Внутренняя переменная var31
#define idvar31	115	// Внутренняя переменная var31
#define var32	BUFFER[434]	// Внутренняя переменная var32
#define idvar32	116	// Внутренняя переменная var32
#define var3	BUFFER[439]	// Внутренняя переменная var3
#define idvar3	117	// Внутренняя переменная var3
#define var5	BUFFER[444]	// Внутренняя переменная var5
#define idvar5	118	// Внутренняя переменная var5
#define var11	BUFFER[449]	// Внутренняя переменная var11
#define idvar11	119	// Внутренняя переменная var11
#define var24	BUFFER[451]	// Внутренняя переменная var24
...
#define var10	BUFFER[455]	// Внутренняя переменная var10
#define idvar10	122	// Внутренняя переменная var10
#define var12	BUFFER[457]	// Внутренняя переменная var12
#define idvar12	123	// Внутренняя переменная var12
#define var13	BUFFER[459]	// Внутренняя переменная var13
#define idvar13	124	// Внутренняя переменная var13
#define var15	BUFFER[461]	// Внутренняя переменная var15
#define idvar15	125	// Внутренняя переменная var15
#define var16	BUFFER[466]	// Внутренняя переменная var16
#define idvar16	126	// Внутренняя переменная var16
#define var23	BUFFER[471]	// Внутренняя переменная var23
#define idvar23	127	// Внутренняя переменная var23
#define vainSFloat	BUFFER[476]	// Внутренняя переменная vainSFloat
#define idvainSFloat	128	// Внутренняя переменная vainSFloat
#define var6	BUFFER[481]	// Внутренняя переменная var6
#define idvar6	129	// Внутренняя переменная var6
...
#define var4	BUFFER[493]	// Внутренняя переменная var4
#define idvar4	132	// Внутренняя переменная var4
#define var7	BUFFER[498]	// Внутренняя переменная var7
#define idvar7	133	// Внутренняя переменная var7
#define vainSInt	BUFFER[503]	// Внутренняя переменная vainSInt
#define idvainSInt	134	// Внутренняя переменная vainSInt
#define var2	BUFFER[506]	// Внутренняя переменная var2
#define idvar2	135	// Внутренняя переменная var2
#define vainSLong	BUFFER[511]	// Внутренняя переменная vainSLong
...
#define var25	BUFFER[522]	// Внутренняя переменная var25
#define idvar25	138	// Внутренняя переменная var25
#define var26	BUFFER[524]	// Внутренняя переменная var26
#define idvar26	139	// Внутренняя переменная var26
#define var28	BUFFER[526]	// Внутренняя переменная var28
#define idvar28	140	// Внутренняя переменная var28
#define var30	BUFFER[528]	// Внутренняя переменная var30
...
#define var17	BUFFER[532]	// Внутренняя переменная var17
#define idvar17	143	// Внутренняя переменная var17
#define var22	BUFFER[534]	// Внутренняя переменная var22
...
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{108	,1	,1	,&var29},	//Внутренняя переменная var29
	...
	{124	,1	,1	,&var13},	//Внутренняя переменная var13
	{125	,8	,1	,&var15},	//Внутренняя переменная var15
	{126	,8	,1	,&var16},	//Внутренняя переменная var16
	{127	,8	,1	,&var23},	//Внутренняя переменная var23
	{128	,8	,1	,&vainSFloat},	//Внутренняя переменная vainSFloat
	{129	,8	,1	,&var6},	//Внутренняя переменная var6
	...
	{134	,3	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	...
	{139	,1	,1	,&var26},	//Внутренняя переменная var26
	...
	{143	,1	,1	,&var17},	//Внутренняя переменная var17
	{144	,1	,1	,&var22},	//Внутренняя переменная var22
	{-1,0,NULL},
};
