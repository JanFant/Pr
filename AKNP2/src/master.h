...
static ModbusRegister ir_AKNP2[]={
	...
	{&R0IN02FS2,8,6},	//( - , AKNP2) Выход КНК15-1 Гц
	{&R0IN03FS2,8,8},	//( - , AKNP2) Выход КНК53М Гц
	{&R0IN01FS2,8,10},	//( - , AKNP2) Выход СНМ-11 Гц
	{&TTLaknp2,3,12},	//( - , AKNP2) TTL
	{&R0VN15RS2,3,13},	//( - , AKNP2) Номер ведущей камеры канал 2
	{&R0VN33RS2,8,14},	//( - , AKNP2) Нейтронный поток по камере КНК53М канал 2
	{&R0VN23RS2,8,16},	//( - , AKNP2) Нейтронный поток по камере КНК15-1 канал 2
	{&R0VN13RS2,8,18},	//( - , AKNP2) Нейтронный поток по камере СНМ11 канал 2
	{&R0VN04RS2,8,20},	//( - , AKNP2) Реактивность канал 2
	{&R0VN03RS2,8,22},	//( - , AKNP2) Измеренный нейтронный поток канал 2
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
