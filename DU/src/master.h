...
static ModbusRegister coil_DU[]={  // 
	...
	{&A3VZ15LZ2,1,12},	//( - K19VDSR, DU) Имитация срабатывания АЗ от НУП ИС
	{&A3VZ13LZ2,1,13},	//( - K18VDSR, DU) Имитация срабатывания АЗ от ВУ ИС
	{&R0AD14LZ2,1,14},	//( - K20VDSR, DU) Имитация срабатывания АЗ от  II УР
	{&A1VN71LZ2,1,15},	//( - K21VDSR, DU) Блокировка автоматического подъёма ББ
	{&R0IS02LDU,1,16},	//( - K30VDSR, DU) Разрешение ввода от имитатора
	{&R0MD34LP1,1,17},	//( - , DU) Кнопка КВИТИРОВАТЬ
	...
	{&A2MC01LC2,1,24},	//( - , DU) Настроить энкодер РБ1
	{&A2MC01LC1,1,25},	//( - , DU) Настроить энкодер РБ1
	{&B2MC01LC2,1,26},	//( - , DU) Настроить энкодер РБ2
	{&B2MC01LC1,1,27},	//( - , DU) Настроить энкодер РБ2
	{&A1MC01LC2,1,28},	//( - , DU) Настроить энкодер ББ1
	{&A1MC01LC1,1,29},	//( - , DU) Настроить энкодер ББ1
	{&B1MC01LC2,1,30},	//( - , DU) Настроить энкодер ББ2
	{&B1MC01LC1,1,31},	//( - , DU) Настроить энкодер ББ2
	{&syn_B3VP52LDU,1,32},	//( - , DU) Давление ВЫСТРЕЛ ИС2 ниже ПС
	{&syn_A3VP52LDU,1,33},	//( - , DU) Давление ВЫСТРЕЛ ИС1 ниже ПС
	{&syn_R0EE03LDU,1,34},	//( - , DU) ВПИС ИС
	{&R6IS68LZZ,1,35},	//( - , DU) Исправность ВИП 4,0 (№7) ССДИ-2
	{&R6IS67LZZ,1,36},	//( - , DU) Исправность ВИП 4,0 (№6) ССДИ-1-2
	{&R6IS66LZZ,1,37},	//( - , DU) Исправность ВИП 4,0 (№5) ССДИ-1-1
	{&B3MC01LC1,1,38},	//( - , DU) Настроить энкодер ИС2
	{&B3MC01LC2,1,39},	//( - , DU) Настроить энкодер ИС2
	{&A3MC01LC1,1,40},	//( - , DU) Настроить энкодер ИС1
	{&A3MC01LC2,1,41},	//( - , DU) Настроить энкодер ИС1
	{&B8MC01LC1,1,42},	//( - , DU) Настроить энкодер АЗ2
	{&B8MC01LC2,1,43},	//( - , DU) Настроить энкодер АЗ2
	{&A8MC01LC1,1,44},	//( - , DU) Настроить энкодер ДС2
	{&A8MC01LC2,1,45},	//( - , DU) Настроить энкодер ДС2
	{&C2MD31LP1,1,46},	//( - , DU) Кнопка СБРОС РБ
	{&B1VP41LZ2,1,47},	//( - , DU) Давление СБРОС ББ2 ниже АС
	{&B1VP41LZ1,1,48},	//( - , DU) Давление СБРОС ББ2 ниже АС
	{&A1VP41LZ2,1,49},	//( - , DU) Давление СБРОС ББ1 ниже АС
	{&A1VP41LZ1,1,50},	//( - , DU) Давление СБРОС ББ1 ниже АС
...
static ModbusRegister di_DU[]={  // 
	...
	{&R3IS21LDU,1,17},	//( - K18VDSR, DU) Приход на НУ гомогенных дверей
	{&R3IS11LDU,1,18},	//( - K17VDSR, DU) Приход на ВУ гомогенных дверей
	{&B4IS10LDU,1,19},	//( - K04VDSR, DU) Клапан ПОДЪЕМ НИ2 открыт (обесточен)
	...
	{&R0IS01LDU,1,29},	//( - K29VDSR, DU) Признак работы с имитатором
	{&R0VP73LDU,1,30},	//( - , DU) ПС давления для РУ
	{&B2VS11LDU,1,31},	//( - , DU) Движение РБ2 в сторону ВУ
	{&B2VS21LDU,1,32},	//( - , DU) Движение РБ2 в сторону НУ
	...
	{&B3IS11LDU,1,39},	//( - K03VDSR, DU) Приход на ВУ ИС2
	{&R0VX01LDU,1,40},	//( - , DU) ДО ИМПУЛЬСА
	{&B1AD31LDU,1,41},	//( - K06FDSR, DU) Клапан СБРОС ББ2 открыть (обесточить)
	{&A1AD31LDU,1,42},	//( - K02FDSR, DU) Клапан СБРОС ББ1 открыть (обесточить)
	{&B2AD31LDU,1,43},	//( - K08FDSR, DU) Клапан Сброс РБ2 открыть (обесточить)
	{&A2AD31LDU,1,44},	//( - K04FDSR, DU) Клапан СБРОС РБ1 открыть (обесточить)
	{&B3AB20LDU,1,45},	//( - , DU) Блокировка выстрела ИС2 - клапан ВПИС2 закрыт
	{&B3AB18LDU,1,46},	//( - , DU) Блокировка подъёма ИС2- РБ-СТР ниже 80 мм
	{&B3AB17LDU,1,47},	//( - , DU) Блокировка перемещения ИС2: выполняется программа 20 мин
	{&B3AB04LDU,1,48},	//( - , DU) Блокировка движения ИС2 нет перемещения  ИС1
	{&B3AB02LDU,1,49},	//( - , DU) Блокировка движения ИС2: превышение заданной скорости
	{&B3AB01LDU,1,50},	//( - , DU) Блокировка движения ИС2: скорость перемещения менее заданной
	{&B3VS22LDU,1,51},	//( - , DU) Движение ИС2 в сторону НУ
	{&B3AZ03LDU,1,52},	//( - , DU) Сброс РБ: Несанкционированное перемещение ИС2
	{&B3AB07LDU,1,53},	//( - , DU) Блокировка подъёма ИС2 Гомогенные двери не закрыты
	{&B3AB08LDU,1,54},	//( - , DU) Блокировка подъёма ИС2 - реактор не на рабочем месте
	{&B3AB05LDU,1,55},	//( - , DU) Блокировка подъёма ИС2 -нет сигнала готовности СУЗ
	{&B3AB06LDU,1,56},	//( - , DU) Блокировка подъёма ИС2 - НИ не в положении ВУ,режим работы не проверочный
	{&B3AB09LDU,1,57},	//( - , DU) Блокировка подъёма ИС2- АНИ не установлен
	{&B3AB10LDU,1,58},	//( - , DU) Блокировка подъёма ИС2- есть сигнал общего сброса
	{&B3AB11LDU,1,59},	//( - , DU) Блокировка подъёма ИС2- АЗ2 или ДС2 не на заданной координате
	{&B3AB12LDU,1,60},	//( - , DU) Блокировка подъёма ИС2- при работе с АЗ2 органы СУЗ АЗ1 не на НУ
	{&B3AB14LDU,1,61},	//( - , DU) Блокировка подъёма ИС2- в режимах Калибровка, Статический мощность больше заданной
	{&B3AB16LDU,1,62},	//( - , DU) Блокировка перемещения ИС2: выполняется программа 200 с
	{&B9AZ03LDU,1,63},	//( - , DU) Несанкционированное перемещение НИ ДС2
	{&A9AB02LDU,1,64},	//( - , DU) Блокировка НИ ДС1 - Нет перемещения
	{&A9AB01LDU,1,65},	//( - , DU) Блокировка движения НИ ДС1 - Превышение времени движения
	{&A9AZ03LDU,1,66},	//( - , DU) Несанкционированное перемещение НИ ДС1
	{&B9IS11LDU,1,67},	//( - K25VDSR, DU) Приход на ВУ НИ ДС2
	{&A9IS11LDU,1,68},	//( - K23VDSR, DU) Приход на ВУ НИ ДС1
	{&B4VS22LDU,1,69},	//( - , DU) Движение НИ2 в сторону НУ
	{&B4VS12LDU,1,70},	//( - , DU) Движение НИ2 в сторону ВУ
	{&A4VS22LDU,1,71},	//( - , DU) Движение НИ1 в сторону НУ
	...
	{&A1IS11LDU,1,78},	//( - K08VDSR, DU) Приход на ВУ ББ1
	{&B1IS11LDU,1,79},	//( - K08VDSR, DU) Приход на ВУ ББ2
	{&TestDiagnDU,1,80},	//( - , DU) Неисправность от
	{&B3AB13LDU,1,81},	//( - , DU) Блокировка подъёма ИС2- давление в пневмосистеме ИС ниже значения заданного предупредительной уставкой
	{&A3AB13LDU,1,82},	//( - , DU) Блокировка подъёма ИС1- давление в пневмосистеме ИС1 ниже ПС
	{&R3VS12LDU,1,83},	//( - , DU) Движение гомогенных дверей к открыты
	{&R3VS22LDU,1,84},	//( - , DU) Движение гомогенных дверей к закрыты
	{&R5VS12LDU,1,85},	//( - , DU) Движение ворот отстойной зоны к открыты
	{&R5VS22LDU,1,86},	//( - , DU) Движение ворот отстойной зоны к закрыты
	{&R5IS21LDU,1,87},	//( - K26VDSR, DU) Приход на НУ ворот отстойной зоны
	{&B3AB15LDU,1,88},	//( - , DU) Блокировка заполнения ресивера ИС2: работает регулятор мощности
	{&B3EE03LDU,1,89},	//( - , DU) ВПИС ИС2
	{&A3EE03LDU,1,90},	//( - , DU) ВПИС ИС1
	{&B3AB19LDU,1,91},	//( - , DU) Блокировка пневматического подъема ИС2: режим статический
	{&A3AB19LDU,1,92},	//( - , DU) Блокировка пневматического подъема ИС1: режим статический
	...
	{&A3VP42LDU,1,101},	//( - , DU) Давление ВЫСТРЕЛ ИС1 ниже АС
	{&A3VP52LDU,1,102},	//( - , DU) Давление ВЫСТРЕЛ ИС1 ниже ПС
	{&B3VP42LDU,1,103},	//( - , DU) Давление ВЫСТРЕЛ ИС2 ниже АС
	{&B3VP52LDU,1,104},	//( - , DU) Давление ВЫСТРЕЛ ИС2 ниже ПС
	{&B3VP82LDU,1,105},	//( - , DU) Давление ВЫСТРЕЛ ИС2 в норме
	{&A3VP82LDU,1,106},	//( - , DU) Давление ВЫСТРЕЛ ИС1 в норме
	{&A0VE01LDU,1,107},	//( - , DU) Напряжение в системы АЗ1 подано
	{&R4ABL,1,108},	//( - , DU) Блокировка тележки -
	{&A9ZAV,1,109},	//( - , DU) Завершение НИ ДС1(2)
	{&A8ZAV,1,110},	//( - , DU) 
	{&A2ZAV,1,111},	//( - , DU) Завершение РБ1,2
	{&B8ZAV,1,112},	//( - , DU) 
	{&A5ZAV,1,113},	//( - , DU) 
	{&R2ZAV,1,114},	//( - , DU) 
	{&A6ZAV,1,115},	//( - , DU) 
	...
	{&R0VL23LDU,1,132},	//( - , DU) Конец программы 20мин
	{&R0VL22LDU,1,133},	//( - , DU) Конец программы 200сек
	{&B8IS21LDU,1,134},	//( - K20VDSR, DU) Приход на НУ1 АЗ2
	{&B8IS12LDU,1,135},	//( - K21VDSR, DU) Приход на ВУ2 АЗ2
	{&R0AB19LDU,1,136},	//( - , DU) Блокировка регулирования мощности:Нарушение исходных условий.
	{&R0AB20LDU,1,137},	//( - , DU) Блокировка изменения положения ОР: работает  регулятор мощности
	{&A4UP,1,138},	//( - , DU) 
	{&A4DW,1,139},	//( - , DU) 
	{&R0AB14LDU,1,140},	//( - , DU) Режим проверки не разрешён: ИС2 ниже 55 мм
	{&R0AB15LDU,1,141},	//( - , DU) Режим проверки не разрешён: ИС1 ниже 55 мм
	{&A3IS12LDU,1,142},	//( - , DU) Приход на ВУ штока ИС1
	{&B3IS12LDU,1,143},	//( - , DU) Приход на ВУ штока ИС2
	{&A1ZAV,1,144},	//( - , DU) 
	{&A3ZAV,1,145},	//( - , DU) 
	...
	{&R0AB17LDU,1,148},	//( - , DU) Блокировка регулирования мощности: Время работы при мощности более 100Вт больше допустимого
	{&R0AB18LDU,1,149},	//( - , DU) Блокировка регулирования мощности: Рассогласование  заданных координат ИС1,2
	{&A3AB15LDU,1,150},	//( - , DU) Блокировка заполнения ресивера ИС1: работает регулятор мощности
	{&B2IS12LDU,1,151},	//( - K10VDSR, DU) Магнит РБ2 зацеплен
	{&B1IS12LDU,1,152},	//( - K07VDSR, DU) Магнит ББ2 зацеплен
	{&A2IS12LDU,1,153},	//( - K10VDSR, DU) Магнит РБ1 зацеплен
	{&A1IS12LDU,1,154},	//( - K07VDSR, DU) Магнит ББ1 зацеплен
	{&B5AB04LDU,1,155},	//( - , DU) Блокировка движения НЛ2 -Ошибка в направлении  движения
	{&A5AB04LDU,1,156},	//( - , DU) Блокировка движения НЛ1 -Ошибка в направлении  движения
	{&B4AB02LDU,1,157},	//( - , DU) Блокировка движения НИ2 - Нет перемещения
	{&B4AB01LDU,1,158},	//( - , DU) Блокировка движения НИ2 - Превышение времени движения
	{&B4AZ03LDU,1,159},	//( - , DU) Несанкционированное перемещение НИ2
	{&A4AB02LDU,1,160},	//( - , DU) Блокировка движения НИ1 - Нет перемещения
	{&A4AB01LDU,1,161},	//( - , DU) Блокировка движения НИ1 - Превышение времени движения
	{&A4AZ03LDU,1,162},	//( - , DU) Несанкционированное перемещение НИ1
	{&B4IS21LDU,1,163},	//( - K32VDSR, DU) Приход на НУ НИ2
	{&A4IS21LDU,1,164},	//( - K15VDSR, DU) Приход на НУ НИ1
	{&B5AB02LDU,1,165},	//( - , DU) Блокировка движения НЛ2 - Нет перемещения
	{&B5AB01LDU,1,166},	//( - , DU) Блокировка движения НЛ2 - Превышение времени движения
	{&B5AZ03LDU,1,167},	//( - , DU) Несанкционированное перемещение НЛ2
	{&A5AB02LDU,1,168},	//( - , DU) Блокировка движения НЛ1 - Нет перемещения
	{&A5AB01LDU,1,169},	//( - , DU) Блокировка движения НЛ1 - Превышение времени движения
	{&A5AZ03LDU,1,170},	//( - , DU) Несанкционированное перемещение НЛ1
	{&B5IS21LDU,1,171},	//( - K16VDSR, DU) Приход на НУ НЛ2
	{&B5IS11LDU,1,172},	//( - K15VDSR, DU) Приход на ВУ НЛ2
	{&A5IS21LDU,1,173},	//( - K12VDSR, DU) Приход на НУ НЛ1
	{&A5IS11LDU,1,174},	//( - K11VDSR, DU) Приход на ВУ НЛ1
	{&B5VS12LDU,1,175},	//( - K14VDSR, DU) Движение НЛ2 в сторону ВУ
	{&B5VS22LDU,1,176},	//( - K15VDSR, DU) Движение НЛ2 в сторону НУ
	{&A5VS12LDU,1,177},	//( - K11VDSR, DU) Движение НЛ1 в сторону ВУ
	{&A5VS22LDU,1,178},	//( - K12VDSR, DU) Движение НЛ1 в сторону НУ
	{&R4AD20LDU,1,179},	//( - K14FDSR, DU) Перемещение тележки назад
	{&R4AB18LDU,1,180},	//( - , DU) Блокировка движения тележки назад - тележка на нижних механических упорах реактора
	{&R4AB17LDU,1,181},	//( - , DU) Блокировка движения тележки вперёд - тележка на верхних механических упорах реактора
	{&R4AB16LDU,1,182},	//( - , DU) Блокировка движения тележки - Гомогенные двери не в положении Закрыты
	{&A8AB07LDU,1,183},	//( - , DU) Блокировка движения ДС2: превышение заданной скорости
	{&A8AB06LDU,1,184},	//( - , DU) Блокировка движения ДС2 нет перемещения ДС2
	{&A8VS12LDU,1,185},	//( - , DU) Движение ДС2 в сторону ВУ
	{&B8AB02LDU,1,186},	//( - , DU) Блокировка движения АЗ2- АНИ не установлен
	{&B8AB14LDU,1,187},	//( - , DU) Блокировка движения АЗ2 - Самоход любого механизма
	{&B8AB13LDU,1,188},	//( - , DU) Блокировка движения АЗ2 - ОРР не в исходном состоянии
	{&B8AB12LDU,1,189},	//( - , DU) Блокировка движения АЗ2 - НИ не в положении ВУ
	{&B8AB11LDU,1,190},	//( - , DU) Блокировка движения АЗ2 -нет сигнала готовности СУЗ
	{&B8AB10LDU,1,191},	//( - , DU) Блокировка движения АЗ2 - тележка не на верхних механических упорах реактора
	{&B8AB09LDU,1,192},	//( - , DU) Блокировка  движения  АЗ2 - АС по мощности от любого канала
	{&B8AB08LDU,1,193},	//( - , DU) Блокировка движения АЗ2 Гомогенные двери не закрыты
	{&B8AB04LDU,1,194},	//( - , DU) Блокировка движения АЗ2 -Ошибка в направлении  движения
	{&B8AB01LDU,1,195},	//( - , DU) Блокировка движения АЗ2 - Превышение времени движения
	{&B8IS11LDU,1,196},	//( - K19VDSR, DU) Приход на ВУ1 АЗ2
	{&R4IS11LDU,1,197},	//( - K05VDSR, DU) Приход на ВУ1 тележки
	{&A6AB06LDU,1,198},	//( - , DU) Блокировка открытия БЗ1 - ОРР не в исходном состоянии
	{&A6AB07LDU,1,199},	//( - , DU) Блокировка открытия БЗ1 - АЗ2 находится не на упорах 1,5м
	{&A6AB08LDU,1,200},	//( - , DU) Блокировка открытия БЗ1 - ДС2 находится не на упорах 1,5м
	{&A6AB09LDU,1,201},	//( - , DU) Блокировка открытия БЗ1 -ворота отстойной зоны не открыты
	{&B6AB06LDU,1,202},	//( - , DU) Блокировка открытия БЗ2 - ОРР не в исходном состоянии
	{&B6AB07LDU,1,203},	//( - , DU) Блокировка открытия БЗ2 - АЗ2 находится не на упорах 1,5м
	{&B6AB08LDU,1,204},	//( - , DU) Блокировка открытия БЗ2 - ДС2находится не на упорах 1,5м
	{&B6AB09LDU,1,205},	//( - , DU) Блокировка открытия БЗ2 -ворота отстойной зоны не открыты
	{&A6AB05LDU,1,206},	//( - , DU) Блокировка открытия БЗ1 - АНИ не установлен
	{&B8VS12LDU,1,207},	//( - , DU) Движение АЗ2 в сторону ВУ
	{&B8AB06LDU,1,208},	//( - , DU) Блокировка движения АЗ2 нет перемещения АЗ2
	{&B8AB07LDU,1,209},	//( - , DU) Блокировка движения АЗ2: превышение заданной скорости
	{&B8AB05LDU,1,210},	//( - , DU) Блокировка движения АЗ2: скорость перемещения менее заданной
	{&B8VS22LDU,1,211},	//( - , DU) Движение АЗ2 в сторону НУ
	{&B8AZ03LDU,1,212},	//( - , DU) Несанкционированное перемещение АЗ2
	{&B6AB01LDU,1,213},	//( - , DU) Блокировка движения движения БЗ2 - Превышение времени движения
	{&B6AZ03LDU,1,214},	//( - , DU) Несанкционированное перемещение БЗ2
	{&A6AB02LDU,1,215},	//( - , DU) Блокировка движения БЗ1 - Нет перемещения
	{&A6AB01LDU,1,216},	//( - , DU) Блокировка движения БЗ1 - Превышение времени движения
	{&A6AZ03LDU,1,217},	//( - , DU) Несанкционированное перемещение БЗ1
	{&B6VS12LDU,1,218},	//( - K20VDSR, DU) Движение створок БЗ2  к  ОТКРЫТА
	{&B6VS22LDU,1,219},	//( - K21VDSR, DU) Движение створок БЗ2  к «ЗАКРЫТА»
	{&A6VS12LDU,1,220},	//( - K17VDSR, DU) Движение створок БЗ1  к  ОТКРЫТА
	{&A6VS22LDU,1,221},	//( - K18VDSR, DU) Движение створок БЗ1  к ЗАКРЫТА
	{&B6IS21LDU,1,222},	//( - K14VDSR, DU) Приход на НУ БЗ2
	{&B6IS11LDU,1,223},	//( - K13VDSR, DU) Приход на ВУ БЗ2
	{&A6IS21LDU,1,224},	//( - K10VDSR, DU) Приход на НУ БЗ1
	{&A6IS11LDU,1,225},	//( - K09VDSR, DU) Приход на ВУ БЗ1
	{&A1IS21LDU,1,226},	//( - K09VDSR, DU) Приход на НУ ББ1
	{&A2IS21LDU,1,227},	//( - K12VDSR, DU) Приход на НУ РБ1-СС
	{&A3IS21LDU,1,228},	//( - K13VDSR, DU) Приход на НУ ИС1
	{&B1IS21LDU,1,229},	//( - K09VDSR, DU) Приход на НУ ББ2
	{&B2IS21LDU,1,230},	//( - K12VDSR, DU) Приход на НУ РБ2-СС
	{&B3IS21LDU,1,231},	//( - K13VDSR, DU) Приход на НУ ИС2
	{&R0ES01LDU,1,232},	//( - , DU) ОРР не в исходном состоянии
	{&R5IS11LDU,1,233},	//( - K25VDSR, DU) Приход на ВУ ворот отстойной зоны
	...
	{&B6AB02LDU,1,249},	//( - , DU) Блокировка движения БЗ2 - Нет перемещения
	{&A6AB04LDU,1,250},	//( - , DU) Блокировка движения БЗ1 -Ошибка в направлении  движения
	{&B6AB04LDU,1,251},	//( - , DU) Блокировка движения БЗ2 -Ошибка в направлении  движения
	{&R4AB01LDU,1,252},	//( - , DU) Блокировка движения тележки - АНИ не установлен
	{&R8IS11LDU,1,253},	//( - K14VDSR, DU) Аварийный НИ установлен
	{&R4AB02LDU,1,254},	//( - , DU) Блокировка движения тележки - Потеря связи с БАЗ, ОПУ
	{&R4IS21LDU,1,255},	//( - K07VDSR, DU) Приход на НУ1 тележки
	{&R4IS22LDU,1,256},	//( - K08VDSR, DU) Приход на НУ2 тележки
	{&R4IS12LDU,1,257},	//( - K06VDSR, DU) Приход на ВУ2 тележки
	{&R4VS22LDU,1,258},	//( - K03VDSR, DU) Движение реактора к У ЗАЩИТЫ
	{&R4VS12LDU,1,259},	//( - K02VDSR, DU) Движение реактора  к У ОБРАЗЦОВ
	{&R4AZ03LDU,1,260},	//( - , DU) Несанкционированное перемещение тележки
	{&R4AB03LDU,1,261},	//( - , DU) Блокировка движения тележки - Самоход любого механизма
	{&R1IS21LDU,1,262},	//( - K28VDSR, DU) Приход на НУ МДЗ1
	{&B1AB08LDU,1,263},	//( - , DU) Блокировка подъёма ББ2 - реактор не на рабочем месте
	{&B1AB07LDU,1,264},	//( - , DU) Блокировка подъёма ББ2 Гомогенные двери не закрыты
	...
	{&R1VS12LDU,1,277},	//( - K05VDSR, DU) Движение МДЗ1 в сторону ВУ
	{&R2IS11LDU,1,278},	//( - K29VDSR, DU) Приход на ВУ МДЗ2
	{&A1VS12LDU,1,279},	//( - , DU) Движение ББ1 в сторону ВУ
	{&A1AB04LDU,1,280},	//( - , DU) Блокировка движения ББ1 нет перемещения  ББ1
	{&A1AB02LDU,1,281},	//( - , DU) Блокировка движения ББ1: превышение заданной скорости
	{&A1AB01LDU,1,282},	//( - , DU) Блокировка движения ББ1: скорость перемещения менее заданной
	{&A1VS22LDU,1,283},	//( - , DU) Движение ББ1 в сторону НУ
	{&A1AZ03LDU,1,284},	//( - , DU) Сброс ББ: Несанкционированное перемещение ББ1
	{&A1AB07LDU,1,285},	//( - , DU) Блокировка подъёма ББ1 Гомогенные двери не закрыты
	{&A1AB08LDU,1,286},	//( - , DU) Блокировка подъёма ББ1 - реактор не на рабочем месте
	...
	{&A1AB10LDU,1,290},	//( - , DU) Блокировка подъёма ББ1- есть сигнал общего сброса
	{&A1AB11LDU,1,291},	//( - , DU) Блокировка подъёма ББ1- АЗ2 или ДС2 не на заданной координате
	{&B3VS12LDU,1,292},	//( - , DU) Движение ИС2 в сторону ВУ
	{&A3AB20LDU,1,293},	//( - , DU) Блокировка выстрела ИС1 - клапан ВПИС1 закрыт
	{&A3AB18LDU,1,294},	//( - , DU) Блокировка подъёма ИС1- РБ-СТР ниже 80 мм
	{&A3AB17LDU,1,295},	//( - , DU) Блокировка перемещения ИС1: выполняется программа 20 мин
	{&A3AB16LDU,1,296},	//( - , DU) Блокировка перемещения ИС1: выполняется программа 200 с
	{&A3AB14LDU,1,297},	//( - , DU) Блокировка подъёма ИС1- в режимах Калибровка, Статический мощность больше заданной
	{&A3AB12LDU,1,298},	//( - , DU) Блокировка подъёма ИС1- при работе с АЗ1 органы СУЗ АЗ2 не на НУ
	{&A3AB11LDU,1,299},	//( - , DU) Блокировка подъёма ИС1- АЗ2 или ДС2 не на заданной координате
	{&A3AB10LDU,1,300},	//( - , DU) Блокировка подъёма ИС1- есть сигнал общего сброса
	{&A3AB09LDU,1,301},	//( - , DU) Блокировка подъёма ИС1- АНИ не установлен
	{&A3AB06LDU,1,302},	//( - , DU) Блокировка подъёма ИС1 - НИ не в положении ВУ,режим работы не проверочный
	{&A3AB05LDU,1,303},	//( - , DU) Блокировка подъёма ИС1 -нет сигнала готовности СУЗ
	{&A3AB08LDU,1,304},	//( - , DU) Блокировка подъёма ИС1 - реактор не на рабочем месте
	{&A3AB07LDU,1,305},	//( - , DU) Блокировка подъёма ИС1 Гомогенные двери не закрыты
	{&A3AZ03LDU,1,306},	//( - , DU) Сброс РБ: Несанкционированное перемещение ИС1
	{&B1AB05LDU,1,307},	//( - , DU) Блокировка подъёма ББ2 -нет сигнала готовности СУЗ
	{&B1AB06LDU,1,308},	//( - , DU) Блокировка подъёма ББ2 - НИ не в положении ВУ,режим работы не проверочный
	{&B1AB09LDU,1,309},	//( - , DU) Блокировка подъёма ББ2- АНИ не установлен
	{&B1AB10LDU,1,310},	//( - , DU) Блокировка подъёма ББ2- есть сигнал общего сброса
	{&B1AB11LDU,1,311},	//( - , DU) Блокировка подъёма ББ2- АЗ2 или ДС2 не на заданной координате
	{&B1AB12LDU,1,312},	//( - , DU) Блокировка подъёма ББ2- при работе с АЗ1 органы СУЗ АЗ2 не на НУ
	{&B1AB13LDU,1,313},	//( - , DU) Блокировка подъёма ББ2- давление в пневмосистеме ББ2 ниже АС
	{&B1AB14LDU,1,314},	//( - , DU) Блокировка подъёма ББ2- в режимах Калибровка, Статический мощность больше заданной
	{&B1AB16LDU,1,315},	//( - , DU) Блокировка перемещения ББ2: выполняется программа 200 с
	{&B1AB17LDU,1,316},	//( - , DU) Блокировка перемещения ББ2: выполняется программа 20 мин
	{&B1AB18LDU,1,317},	//( - , DU) Блокировка подъёма ББ2- РБ-СТР ниже 80 мм
	{&A3VS12LDU,1,318},	//( - , DU) Движение ИС1 в сторону ВУ
	{&A3AB04LDU,1,319},	//( - , DU) Блокировка движения ИС1 нет перемещения  ИС1
	{&A3AB02LDU,1,320},	//( - , DU) Блокировка движения ИС1: превышение заданной скорости
	{&A3AB01LDU,1,321},	//( - , DU) Блокировка движения ИС1: скорость перемещения менее заданной
	{&A3VS22LDU,1,322},	//( - , DU) Движение ИС1 в сторону НУ
	{&A2AB14LDU,1,323},	//( - , DU) Блокировка подъёма РБ1- в режимах Калибровка, Статический мощность больше заданной
	{&A2AB13LDU,1,324},	//( - , DU) Блокировка подъёма РБ1- давление в пневмосистеме сброса РБ ниже ПС
	{&A2AB12LDU,1,325},	//( - , DU) Блокировка подъёма РБ1- при работе с АЗ1 органы СУЗ АЗ2 не на НУ
	{&A2AB11LDU,1,326},	//( - , DU) Блокировка подъёма РБ1- АЗ2 или ДС2 не на заданной координате
	{&A2AB10LDU,1,327},	//( - , DU) Блокировка подъёма РБ1- есть сигнал общего сброса
	{&A2AB09LDU,1,328},	//( - , DU) Блокировка подъёма РБ1- АНИ не установлен
	{&A2AB06LDU,1,329},	//( - , DU) Блокировка подъёма РБ1 - НИ не в положении ВУ,режим работы не проверочный
	{&A2AB05LDU,1,330},	//( - , DU) Блокировка подъёма РБ1 -нет сигнала готовности СУЗ
	{&A2AB08LDU,1,331},	//( - , DU) Блокировка подъёма РБ1 - реактор не на рабочем месте
	{&A2AB07LDU,1,332},	//( - , DU) Блокировка подъёма РБ1 Гомогенные двери не закрыты
	{&A2AZ03LDU,1,333},	//( - , DU) Сброс РБ: Несанкционированное перемещение РБ1
	{&A2VS21LDU,1,334},	//( - , DU) Движение РБ1 в сторону НУ
	{&A2AB01LDU,1,335},	//( - , DU) Блокировка движения РБ1: скорость перемещения менее заданной
	{&A2AB02LDU,1,336},	//( - , DU) Блокировка движения РБ1: превышение заданной скорости
	{&A2AB04LDU,1,337},	//( - , DU) Блокировка движения РБ1 нет перемещения  РБ1
	{&A8AB05LDU,1,338},	//( - , DU) Блокировка движения ДС2: скорость перемещения менее заданной
	{&A8VS22LDU,1,339},	//( - , DU) Движение ДС2 в сторону НУ
	{&A8AZ03LDU,1,340},	//( - , DU) Несанкционированное перемещение ДС2
	{&B8IS22LDU,1,341},	//( - K22VDSR, DU) Приход на НУ2 АЗ2
	{&A8IS12LDU,1,342},	//( - K30VDSR, DU) Приход на механический ВУ ДС2
	{&A8AB04LDU,1,343},	//( - , DU) Блокировка ДС2 -Ошибка в направлении  движения
	{&A8IS22LDU,1,344},	//( - K31VDSR, DU) Приход на механический НУ ДС2
	{&A8AB08LDU,1,345},	//( - , DU) Блокировка движения ДС2 Гомогенные двери не закрыты
	{&A8AB09LDU,1,346},	//( - , DU) Блокировка  движения ДС2 - АС по мощности от любого канала
	{&A8AB10LDU,1,347},	//( - , DU) Блокировка движения ДС2 - тележка не на верхних механических упорах реактора
	{&A8AB11LDU,1,348},	//( - , DU) Блокировка движения ДС2 -нет сигнала готовности СУЗ
	...
	{&A8AB02LDU,1,352},	//( - , DU) Блокировка движения ДС2- АНИ не установлен
	{&A8AB01LDU,1,353},	//( - , DU) Блокировка ДС2 -Превышение времени перемещения
	{&A2VS11LDU,1,354},	//( - , DU) Движение РБ1 в сторону ВУ
	{&R2VS12LDU,1,355},	//( - K08VDSR, DU) Движение МДЗ2 в сторону ВУ
	{&R2VS22LDU,1,356},	//( - K09VDSR, DU) Движение МДЗ2 в сторону НУ
	{&R1VS22LDU,1,357},	//( - K06VDSR, DU) Движение МДЗ1 в сторону НУ
	{&R1IS11LDU,1,358},	//( - K27VDSR, DU) Приход на ВУ МДЗ1
	{&R2AB04LDU,1,359},	//( - , DU) Блокировка движения МДЗ2 -Ошибка в направлении  движения
	{&R1AB04LDU,1,360},	//( - , DU) Блокировка движения МДЗ1 -Ошибка в направлении  движения
	{&R2AB02LDU,1,361},	//( - , DU) Блокировка движения МДЗ2 - Нет перемещения МДЗ2
	{&R2AB01LDU,1,362},	//( - , DU) Блокировка движения МДЗ2 - Превышение времени движения
	{&R2AZ03LDU,1,363},	//( - , DU) Несанкционированное перемещение МДЗ2
	{&R1AB02LDU,1,364},	//( - , DU) Блокировка движения МДЗ1 - Нет перемещения МДЗ1
	{&R1AB01LDU,1,365},	//( - , DU) Блокировка движения МДЗ1 - Превышение времени движения
	{&R1AZ03LDU,1,366},	//( - , DU) Несанкционированное перемещение МДЗ1
	{&B2AB17LDU,1,367},	//( - , DU) Блокировка перемещения РБ2: выполняется программа 20 мин
	{&B2AB16LDU,1,368},	//( - , DU) Блокировка перемещения РБ2: выполняется программа 200 с
	{&B2AB14LDU,1,369},	//( - , DU) Блокировка подъёма РБ2- в режимах Калибровка, Статический мощность больше заданной
	{&B2AB13LDU,1,370},	//( - , DU) Блокировка подъёма РБ2- давление в пневмосистеме сброса РБ ниже ПС
	{&A2AB16LDU,1,371},	//( - , DU) Блокировка перемещения РБ1: выполняется программа 200 с
	{&A2AB17LDU,1,372},	//( - , DU) Блокировка перемещения РБ1: выполняется программа 20 мин
	{&B2AB04LDU,1,373},	//( - , DU) Блокировка движения РБ2 нет перемещения  РБ2
	{&B2AB02LDU,1,374},	//( - , DU) Блокировка движения РБ2: превышение заданной скорости
	{&B2AB01LDU,1,375},	//( - , DU) Блокировка движения РБ2: скорость перемещения менее заданной
	{&B2AZ03LDU,1,376},	//( - , DU) Сброс РБ: Несанкционированное перемещение РБ2
	{&B2AB07LDU,1,377},	//( - , DU) Блокировка подъёма РБ2 Гомогенные двери не закрыты
	{&B2AB08LDU,1,378},	//( - , DU) Блокировка подъёма РБ2 - реактор не на рабочем месте
	{&B2AB05LDU,1,379},	//( - , DU) Блокировка подъёма РБ2 -нет сигнала готовности СУЗ
	{&B2AB06LDU,1,380},	//( - , DU) Блокировка подъёма РБ2 - НИ не в положении ВУ,режим работы не проверочный
	{&B2AB09LDU,1,381},	//( - , DU) Блокировка подъёма РБ2- АНИ не установлен
	{&B2AB10LDU,1,382},	//( - , DU) Блокировка подъёма РБ2- есть сигнал общего сброса
	{&B2AB11LDU,1,383},	//( - , DU) Блокировка подъёма РБ2- АЗ2 или ДС2 не на заданной координате
	{&B2AB12LDU,1,384},	//( - , DU) Блокировка подъёма РБ2- при работе с АЗ2 органы СУЗ АЗ1 не на НУ
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
static ModbusRegister ir_DU[]={  // 
	...
	{&R0VL02RDU,8,4},	//( - , DU) Индикация (Время задержки ИНИ)
	{&R0VL06RDU,8,6},	//( - , DU) Индикация (Время задержки от ВУ РБ)
	{&R0VL11IDU,3,8},	//( - , DU) До импульса секунд
	{&R0VL01IDU,3,9},	//( - , DU) До импульса минут
	{&B3CV01RDU,8,10},	//( - , DU) Измеренная скорость перемещения ИС2
	...
	{&B4VS01IDU,3,20},	//( - , DU) Готовность к управлению НИ2
	...
	{&A2VS01IDU,3,33},	//( - , DU) Готовность к управлению РБ1
	{&A4VS01IDU,3,34},	//( - , DU) Готовность к управлению НИ1
	...
	{&A3MC01RDU,8,72},	//( - , DU) Заданная координата положения ИС от регулятора мм
	{&A3MC02RDU,8,74},	//( - , DU) Температурная корректировка координаты ИМ
	{&R0CN91LDU,8,76},	//( - , DU) Рассчётная реактивность от регулятора
	{&A3MC03RDU,8,78},	//( - , DU) Координата положения ИМ 0-й реактивности
...
static ModbusRegister hr_DU[]={  // 
	...
	{&A1MC01RP1,8,6},	//( - , DU) Заданная координата положения ББ1 мм
	{&B1MC01RP1,8,8},	//( - , DU) Заданная координата положения ББ2  мм
	{&A3MC01RP1,8,10},	//( - , DU) Заданная координата положения ИС1 мм
