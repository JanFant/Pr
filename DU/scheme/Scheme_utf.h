...
void InitInternalParametr(void)
{
  int i;
  for( i=0;i<10;i++ )
    array_m325_rz_1[i] = &(&internal1_m325_rz)[i];
  for( i=0;i<10;i++ )
    array_m268_rz_1[i] = &(&internal1_m268_rz)[i];
  for( i=0;i<6;i++ )
    array_m1390_rz_1[i] = &(&internal1_m1390_rz)[i];
  for( i=0;i<60;i++ )
    array_m1317_x0_1[i] = &(&internal1_m1317_x0)[i];
  for( i=0;i<60;i++ )
    array_m1317_tim0_1[i] = &(&internal1_m1317_tim0)[i];
  for( i=0;i<60;i++ )
    array_m920_x0_1[i] = &(&internal1_m920_x0)[i];
  for( i=0;i<60;i++ )
    array_m920_tim0_1[i] = &(&internal1_m920_tim0)[i];
  for( i=0;i<150;i++ )
    array_m516_x0_1[i] = &(&internal1_m516_x0)[i];
  for( i=0;i<150;i++ )
    array_m516_tim0_1[i] = &(&internal1_m516_tim0)[i];
  for( i=0;i<150;i++ )
    array_m197_x0_1[i] = &(&internal1_m197_x0)[i];
  for( i=0;i<150;i++ )
    array_m197_tim0_1[i] = &(&internal1_m197_tim0)[i];
  for( i=0;i<80;i++ )
    array_m827_x0_1[i] = &(&internal1_m827_x0)[i];
  for( i=0;i<80;i++ )
    array_m827_tim0_1[i] = &(&internal1_m827_tim0)[i];
  for( i=0;i<80;i++ )
    array_m1226_x0_1[i] = &(&internal1_m1226_x0)[i];
  for( i=0;i<80;i++ )
    array_m1226_tim0_1[i] = &(&internal1_m1226_tim0)[i];
  for( i=0;i<20;i++ )
    array_m1591_x0_1[i] = &(&internal1_m1591_x0)[i];
  for( i=0;i<20;i++ )
    array_m1591_tim0_1[i] = &(&internal1_m1591_tim0)[i];
  for( i=0;i<20;i++ )
    array_m1131_x0_1[i] = &(&internal1_m1131_x0)[i];
  for( i=0;i<20;i++ )
    array_m1131_tim0_1[i] = &(&internal1_m1131_tim0)[i];
}
