...
extern  func_ext1();
// АП
//  Результат трансляции схемы D:\md\pti\pr\AKNP3\scheme\aknp3.tpr

#define PBLENGTH 8192
#ifndef SIMUL_MODE
char EEPROMType = 2;/*0 - absent, 1 - external, 2 - internal, 3 - misc*/
#else
char *SchemaName = "D:\md\pti\pr\AKNP3\scheme\aknp3.tpr";
#endif
...
#define internal1_m17_Nk (*((psint)(InternalBuf+0x2))) /*Nk - ведущая камера*/
...
#define signal_R0VN02RS3     (*((psfloat)(PBSTART+0x0)))  /*                       Уровень мощности канал 3 */
#define signal_R0VN01RS3     (*((psfloat)(PBSTART+0x5)))  /*                       Период разгона канал 3 */
#define signal_R0VN61LS3     (*((psbool)(PBSTART+0xa)))  /*                       ПС по мощности канал 3 */
#define signal_R0VN73LZ1     (*((psbool)(PBSTART+0xc)))  /*                       АС по мощности канал 3 на БАЗ1 */
#define signal_R0VN65LS3     (*((psbool)(PBSTART+0xe)))  /*                       ПС по периоду разгона канал 3 */
#define signal_R0VN77LZ1     (*((psbool)(PBSTART+0x10)))  /*                       АС по периоду разгона канал 3 на БАЗ1 */
#define signal_A0EE01LS3     (*((psbool)(PBSTART+0x12)))  /*                       Исправность АКНП канал 3 на БАЗ1 */
#define signal_R0IN01FS3     (*((psfloat)(PBSTART+0x14)))  /*                       Выход СНМ-11 Гц */
#define signal_R0IN02FS3     (*((psfloat)(PBSTART+0x19)))  /*                       Выход КНК15-1 Гц */
#define signal_R0VN03RS3     (*((psfloat)(PBSTART+0x1e)))  /*                       Измеренный нейтронный поток канал 3 */
#define signal_R0VN04RS3     (*((psfloat)(PBSTART+0x23)))  /*                       Реактивность канал 3 */
#define signal_A1VN71LS3     (*((psbool)(PBSTART+0x28)))  /*                       Блокировка автоматического  подъёма ББ канал 3 на БАЗ2 */
#define signal_R0IN03FS3     (*((psfloat)(PBSTART+0x2a)))  /*                       Выход КНК53М Гц */
#define signal_A0EE02LS3     (*((psbool)(PBSTART+0x2f)))  /*                       Исправность АКНП3 (от сшивки каналов) канал 3 */
#define signal_R0IE11LS3     (*((psbool)(PBSTART+0x31)))  /*                       Исправность ВИП 1,6 (№14) СНМ11 3 канала */
#define signal_R0IE12LS3     (*((psbool)(PBSTART+0x33)))  /*                       Исправность ВИП 0,5 (№15) КНК15-1 3 канала */
#define signal_R0IE13LS3     (*((psbool)(PBSTART+0x35)))  /*                       Исправность ВИП 0,5 (№16) КНК53М 3 канала */
#define signal_R0VN13RS3     (*((psfloat)(PBSTART+0x37)))  /*                       Нейтронный поток по камере СНМ11 канал 3 */
#define signal_R0VN23RS3     (*((psfloat)(PBSTART+0x3c)))  /*                       Нейтронный поток по камере КНК15-1 канал 3 */
#define signal_R0VN33RS3     (*((psfloat)(PBSTART+0x41)))  /*                       Нейтронный поток по камере КНК53М канал 3 */
#define signal_R0VN15RS3     (*((psint)(PBSTART+0x46)))  /*                       Номер ведущей камеры канал 3 */
#define signal_A0EE03LS3     (*((psbool)(PBSTART+0x49)))  /*                       Подключена сеть питания АКНП канал 3 */
#define signal_R0IE01LS3     (*((psbool)(PBSTART+0x4b)))  /*                       Отключение питание детекторов канал 3 */
#define signal_R0IE02LS3     (*((psbool)(PBSTART+0x4d)))  /*                       Отключить питание ПР, ПУ канал 3 */
#define signal_A0VN71LS3     (*((psbool)(PBSTART+0x4f)))  /*                       Блокировка автоматического  подъёма ББ канал 3 на БАЗ1 */
#define signal_R0VN73LZ2     (*((psbool)(PBSTART+0x51)))  /*                       АС по мощности канал 3 на БАЗ2 */
#define signal_R0VN77LZ2     (*((psbool)(PBSTART+0x53)))  /*                       АС по периоду разгона канал 3 на БАЗ2 */
#define signal_A1EE01LS3     (*((psbool)(PBSTART+0x55)))  /*                       Исправность АКНП канал 3 на БАЗ2 */
#define signal_B8VC01RDU     (*((psfloat)(PBSTART+0x57)))  /*                       Координата АЗ2, мм */
#define signal_R0EE03LZ1     (*((psbool)(PBSTART+0x5c)))  /*                       Питание  АКНП3  отключить */
#define signal_R0EE03LZ2     (*((psbool)(PBSTART+0x5e)))  /*                       Питание  АКНП3  отключить */
...
#define fEM_R7UX07RSS  (*((psfloat)(SpaEEPROMBuf+0x28)))
#define fEM_R7UX08RSS  (*((psfloat)(SpaEEPROMBuf+0x2D)))
#define fEM_R7UX09RSS  (*((psfloat)(SpaEEPROMBuf+0x32)))
#define fEM_R7UY00RSS  (*((psfloat)(SpaEEPROMBuf+0x37)))
#define fEM_R7UY07RSS  (*((psfloat)(SpaEEPROMBuf+0x3C)))
#define fEM_R7UY08RSS  (*((psfloat)(SpaEEPROMBuf+0x41)))
#define fEM_R7UY09RSS  (*((psfloat)(SpaEEPROMBuf+0x46)))
#define fEM_A0UX00RSS  (*((psfloat)(SpaEEPROMBuf+0x4B)))
#define fEM_A0UX07RSS  (*((psfloat)(SpaEEPROMBuf+0x50)))
#define fEM_A0UX08RSS  (*((psfloat)(SpaEEPROMBuf+0x55)))
#define fEM_A0UX09RSS  (*((psfloat)(SpaEEPROMBuf+0x5A)))
#define fEM_B0UX07RSS  (*((psfloat)(SpaEEPROMBuf+0x5F)))
#define fEM_B0UX08RSS  (*((psfloat)(SpaEEPROMBuf+0x64)))
#define fEM_B0UX09RSS  (*((psfloat)(SpaEEPROMBuf+0x69)))
...
/* код алгоблоков */
/* Объявление структур */
_S_ocham far S_ocham_17_1 = {NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,&bRM_1_,&fRM_2_0,NULL,NULL,NULL,&var1,&var2,&var3,&var4,&var5,&var6,&var7,NULL};
_S_or2 far S_or2_67_1 = {NULL,NULL,&var8};
...
if(bFirstEnterFlag.b==0){ InitInternalParametr(); }
 ...
 CheckSignals(Par);
  ...
  bol((&S_bol_52_1));
  andn((&S_andn_55_1));
  signal_A1EE01LS3.b = var13.b;
  signal_A1EE01LS3.error = var13.error;
  signal_R0VN77LZ2.b = var12.b;
  signal_R0VN77LZ2.error = var12.error;
  signal_R0VN73LZ2.b = var14.b;
  signal_R0VN73LZ2.error = var14.error;
  signal_A0VN71LS3.b = var19.b;
  signal_A0VN71LS3.error = var19.error;
  signal_R0IE02LS3.b = var8.b;
  signal_R0IE02LS3.error = var8.error;
  signal_R0IE01LS3.b = var8.b;
  signal_R0IE01LS3.error = var8.error;
  signal_R0VN15RS3.i = var7.i;
  signal_R0VN15RS3.error = var7.error;
  fplet(&signal_R0VN33RS3.f,&var6.f);
  signal_R0VN33RS3.error = var6.error;
  fplet(&signal_R0VN23RS3.f,&var5.f);
  signal_R0VN23RS3.error = var5.error;
  fplet(&signal_R0VN13RS3.f,&var4.f);
  signal_R0VN13RS3.error = var4.error;
  signal_A0EE02LS3.b = var3.b;
  signal_A0EE02LS3.error = var3.error;
  signal_A1VN71LS3.b = var19.b;
  signal_A1VN71LS3.error = var19.error;
  fplet(&signal_R0VN04RS3.f,&var18.f);
  signal_R0VN04RS3.error = var18.error;
  fplet(&signal_R0VN03RS3.f,&var1.f);
  signal_R0VN03RS3.error = var1.error;
  signal_A0EE01LS3.b = var13.b;
  signal_A0EE01LS3.error = var13.error;
  signal_R0VN77LZ1.b = var12.b;
  signal_R0VN77LZ1.error = var12.error;
  signal_R0VN65LS3.b = var10.b;
  signal_R0VN65LS3.error = var10.error;
  signal_R0VN73LZ1.b = var14.b;
  signal_R0VN73LZ1.error = var14.error;
  signal_R0VN61LS3.b = var15.b;
  signal_R0VN61LS3.error = var15.error;
  fplet(&signal_R0VN01RS3.f,&var9.f);
  signal_R0VN01RS3.error = var9.error;
  fplet(&signal_R0VN02RS3.f,&var2.f);
  signal_R0VN02RS3.error = var2.error;
...
void __stdcall CheckSignals(DVE_Parametrs *Par)
{
  ...
  CheckSFloat(20);
#else
ParExchange("R0IN01FS3",1,&SignalBuffer[20],"Выход СНМ-11 Гц",0);
#endif
#ifndef SIMUL_MODE
  CheckSFloat(25);
#else
ParExchange("R0IN02FS3",1,&SignalBuffer[25],"Выход КНК15-1 Гц",0);
#endif
#ifndef SIMUL_MODE
  CheckSFloat(42);
#else
ParExchange("R0IN03FS3",1,&SignalBuffer[42],"Выход КНК53М Гц",0);
#endif
#ifndef SIMUL_MODE
  CheckSBool(49);
#else
ParExchange("R0IE11LS3",3,&SignalBuffer[49],"Исправность ВИП 1,6 (№14) СНМ11 3 канала",0);
#endif
#ifndef SIMUL_MODE
  CheckSBool(51);
#else
ParExchange("R0IE12LS3",3,&SignalBuffer[51],"Исправность ВИП 0,5 (№15) КНК15-1 3 канала",0);
#endif
#ifndef SIMUL_MODE
  CheckSBool(53);
#else
ParExchange("R0IE13LS3",3,&SignalBuffer[53],"Исправность ВИП 0,5 (№16) КНК53М 3 канала",0);
#endif
#ifndef SIMUL_MODE
  CheckSBool(73);
#else
ParExchange("A0EE03LS3",3,&SignalBuffer[73],"Подключена сеть питания АКНП канал 3",0);
#endif
#ifndef SIMUL_MODE
  CheckSFloat(87);
#else
ParExchange("B8VC01RDU",1,&SignalBuffer[87],"Координата АЗ2, мм",0);
  ...
  CheckSBool(92);
#else
ParExchange("R0EE03LZ1",3,&SignalBuffer[92],"Питание  АКНП3  отключить",0);
#endif
#ifndef SIMUL_MODE
  CheckSBool(94);
#else
ParExchange("R0EE03LZ2",3,&SignalBuffer[94],"Питание  АКНП3  отключить",0);
#endif
#ifndef SIMUL_MODE
...
void UnloadSignals()
{
ParExchange("R0VN02RS3",1,&SignalBuffer[0],"Уровень мощности канал 3",1);
ParExchange("R0VN01RS3",1,&SignalBuffer[5],"Период разгона канал 3",1);
ParExchange("R0VN61LS3",3,&SignalBuffer[10],"ПС по мощности канал 3",1);
ParExchange("R0VN73LZ1",3,&SignalBuffer[12],"АС по мощности канал 3 на БАЗ1",1);
ParExchange("R0VN65LS3",3,&SignalBuffer[14],"ПС по периоду разгона канал 3",1);
ParExchange("R0VN77LZ1",3,&SignalBuffer[16],"АС по периоду разгона канал 3 на БАЗ1",1);
ParExchange("A0EE01LS3",3,&SignalBuffer[18],"Исправность АКНП канал 3 на БАЗ1",1);
ParExchange("R0VN03RS3",1,&SignalBuffer[30],"Измеренный нейтронный поток канал 3",1);
ParExchange("R0VN04RS3",1,&SignalBuffer[35],"Реактивность канал 3",1);
ParExchange("A1VN71LS3",3,&SignalBuffer[40],"Блокировка автоматического  подъёма ББ канал 3 на БАЗ2",1);
ParExchange("A0EE02LS3",3,&SignalBuffer[47],"Исправность АКНП3 (от сшивки каналов) канал 3",1);
ParExchange("R0VN13RS3",1,&SignalBuffer[55],"Нейтронный поток по камере СНМ11 канал 3",1);
ParExchange("R0VN23RS3",1,&SignalBuffer[60],"Нейтронный поток по камере КНК15-1 канал 3",1);
ParExchange("R0VN33RS3",1,&SignalBuffer[65],"Нейтронный поток по камере КНК53М канал 3",1);
ParExchange("R0VN15RS3",2,&SignalBuffer[70],"Номер ведущей камеры канал 3",1);
ParExchange("R0IE01LS3",3,&SignalBuffer[75],"Отключение питание детекторов канал 3",1);
ParExchange("R0IE02LS3",3,&SignalBuffer[77],"Отключить питание ПР, ПУ канал 3",1);
ParExchange("A0VN71LS3",3,&SignalBuffer[79],"Блокировка автоматического  подъёма ББ канал 3 на БАЗ1",1);
ParExchange("R0VN73LZ2",3,&SignalBuffer[81],"АС по мощности канал 3 на БАЗ2",1);
ParExchange("R0VN77LZ2",3,&SignalBuffer[83],"АС по периоду разгона канал 3 на БАЗ2",1);
ParExchange("A1EE01LS3",3,&SignalBuffer[85],"Исправность АКНП канал 3 на БАЗ2",1);
}
#endif
...
if(EEPROMFlag) {
  ...
  fplet(&fEM_R7UX07RSS.f,((float*)(IntEEPROMBuffer+0x20)));
  fEM_R7UX07RSS.error = 0;
  fplet(&fEM_R7UX08RSS.f,((float*)(IntEEPROMBuffer+0x24)));
  fEM_R7UX08RSS.error = 0;
  fplet(&fEM_R7UX09RSS.f,((float*)(IntEEPROMBuffer+0x28)));
  fEM_R7UX09RSS.error = 0;
  fplet(&fEM_R7UY00RSS.f,((float*)(IntEEPROMBuffer+0x2C)));
  fEM_R7UY00RSS.error = 0;
  fplet(&fEM_R7UY07RSS.f,((float*)(IntEEPROMBuffer+0x30)));
  fEM_R7UY07RSS.error = 0;
  fplet(&fEM_R7UY08RSS.f,((float*)(IntEEPROMBuffer+0x34)));
  fEM_R7UY08RSS.error = 0;
  fplet(&fEM_R7UY09RSS.f,((float*)(IntEEPROMBuffer+0x38)));
  fEM_R7UY09RSS.error = 0;
  fplet(&fEM_A0UX00RSS.f,((float*)(IntEEPROMBuffer+0x3C)));
  fEM_A0UX00RSS.error = 0;
  fplet(&fEM_A0UX07RSS.f,((float*)(IntEEPROMBuffer+0x40)));
  fEM_A0UX07RSS.error = 0;
  fplet(&fEM_A0UX08RSS.f,((float*)(IntEEPROMBuffer+0x44)));
  fEM_A0UX08RSS.error = 0;
  fplet(&fEM_A0UX09RSS.f,((float*)(IntEEPROMBuffer+0x48)));
  fEM_A0UX09RSS.error = 0;
  fplet(&fEM_B0UX07RSS.f,((float*)(IntEEPROMBuffer+0x4C)));
  fEM_B0UX07RSS.error = 0;
  fplet(&fEM_B0UX08RSS.f,((float*)(IntEEPROMBuffer+0x50)));
  fEM_B0UX08RSS.error = 0;
  fplet(&fEM_B0UX09RSS.f,((float*)(IntEEPROMBuffer+0x54)));
...
{
  S_ocham_17_1.Ch1k = &signal_R0IN01FS3;
  S_ocham_17_1.Ch2k = &signal_R0IN02FS3;
  S_ocham_17_1.Ch3k = &signal_R0IN03FS3;
  S_ocham_17_1.YAz2 = &signal_B8VC01RDU;
  S_or2_67_1.x1 = &signal_R0EE03LZ1;
  S_or2_67_1.x2 = &signal_R0EE03LZ2;
  array_m64_x_1[1] = &signal_R0IE11LS3;
  array_m64_x_1[2] = &signal_R0IE12LS3;
  array_m64_x_1[3] = &signal_R0IE13LS3;
  array_m64_x_1[4] = &signal_A0EE03LS3;
}

void InitInternalParametr(void)
{
  int i;
  S_ocham_17_1.Nk = &internal1_m17_Nk;
  S_period_45_1.Period0 = &internal1_m45_Period0;
  S_period_45_1.MyFirstEnterFlag = &internal1_m45_MyFirstEnterFlag;
  S_ocham_17_1.XAz = &fEM_R7UX00RSS;
  S_ocham_17_1.YAz1 = &fEM_R7UY00RSS;
  S_ocham_17_1.Reff = &fEM_A0UX00RSS;
  S_ocham_17_1.Ak1 = &fEM_A0UX07RSS;
  S_ocham_17_1.Bk1 = &fEM_B0UX07RSS;
  S_ocham_17_1.Ak2 = &fEM_A0UX08RSS;
  S_ocham_17_1.Bk2 = &fEM_B0UX08RSS;
  S_ocham_17_1.Ak3 = &fEM_A0UX09RSS;
  S_ocham_17_1.Bk3 = &fEM_B0UX09RSS;
  S_ocham_17_1.XCm1 = &fEM_R7UX07RSS;
  S_ocham_17_1.YCm1 = &fEM_R7UY07RSS;
  S_ocham_17_1.XCm2 = &fEM_R7UX08RSS;
  S_ocham_17_1.YCm2 = &fEM_R7UY08RSS;
  S_ocham_17_1.XCm3 = &fEM_R7UX09RSS;
  S_ocham_17_1.YCm3 = &fEM_R7UY09RSS;
  S_ocham_17_1.Kpr2k = &fEM_R0UH02RSS;
  S_ocham_17_1.Kpr3k = &fEM_R0UH03RSS;
  S_ocham_17_1.Kprm = &fEM_R0UH05RSS;
