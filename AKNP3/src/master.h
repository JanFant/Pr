...
#define R0DEB1LS3	 BUFFER[52]	//(R0DEB1LS3) диагностика шкафа РПУ БП5 место 7
#define idR0DEB1LS3	 23	//(R0DEB1LS3) диагностика шкафа РПУ БП5 место 7
#define R0DEB2LS3	 BUFFER[54]	//(R0DEB2LS3) диагностика шкафа РПУ БП24Д место 7
#define idR0DEB2LS3	 24	//(R0DEB2LS3) диагностика шкафа РПУ БП24Д место 7
#define R0DEB3LS3	 BUFFER[56]	//(R0DEB3LS3) диагностика шкафа РПУ БП5 место 8
#define idR0DEB3LS3	 25	//(R0DEB3LS3) диагностика шкафа РПУ БП5 место 8
#define R0DEB4LS3	 BUFFER[58]	//(R0DEB4LS3) диагностика шкафа РПУ БП24Д место 8
#define idR0DEB4LS3	 26	//(R0DEB4LS3) диагностика шкафа РПУ БП24Д место 8
...
static VarCtrl allVariables[]={      // Описание всех переменных
	...
	{ 23	,1	,1	, &R0DEB1LS3},	//(R0DEB1LS3) диагностика шкафа РПУ БП5 место 7
	{ 24	,1	,1	, &R0DEB2LS3},	//(R0DEB2LS3) диагностика шкафа РПУ БП24Д место 7
	{ 25	,1	,1	, &R0DEB3LS3},	//(R0DEB3LS3) диагностика шкафа РПУ БП5 место 8
	{ 26	,1	,1	, &R0DEB4LS3},	//(R0DEB4LS3) диагностика шкафа РПУ БП24Д место 8
...
static ModbusRegister di_DiagnAKNP3[]={  // 
	{&R0DEB4LS3,1,0},	//(R0DEB4LS3) диагностика шкафа РПУ БП24Д место 8
	{&R0DEB3LS3,1,1},	//(R0DEB3LS3) диагностика шкафа РПУ БП5 место 8
	{&R0DEB2LS3,1,2},	//(R0DEB2LS3) диагностика шкафа РПУ БП24Д место 7
	{&R0DEB1LS3,1,3},	//(R0DEB1LS3) диагностика шкафа РПУ БП5 место 7
