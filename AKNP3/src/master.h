...
#define var33	BUFFER[409]	// Внутренняя переменная var33
#define idvar33	109	// Внутренняя переменная var33
#define var1	BUFFER[411]	// Внутренняя переменная var1
#define idvar1	110	// Внутренняя переменная var1
#define var4	BUFFER[416]	// Внутренняя переменная var4
#define idvar4	111	// Внутренняя переменная var4
#define var7	BUFFER[421]	// Внутренняя переменная var7
#define idvar7	112	// Внутренняя переменная var7
#define var14	BUFFER[426]	// Внутренняя переменная var14
#define idvar14	113	// Внутренняя переменная var14
#define var19	BUFFER[429]	// Внутренняя переменная var19
#define idvar19	114	// Внутренняя переменная var19
#define var26	BUFFER[434]	// Внутренняя переменная var26
...
#define vainSLong	BUFFER[438]	// Внутренняя переменная vainSLong
#define idvainSLong	117	// Внутренняя переменная vainSLong
#define var3	BUFFER[447]	// Внутренняя переменная var3
#define idvar3	118	// Внутренняя переменная var3
#define var6	BUFFER[452]	// Внутренняя переменная var6
#define idvar6	119	// Внутренняя переменная var6
#define vainSFloat	BUFFER[457]	// Внутренняя переменная vainSFloat
#define idvainSFloat	120	// Внутренняя переменная vainSFloat
#define var29	BUFFER[462]	// Внутренняя переменная var29
#define idvar29	121	// Внутренняя переменная var29
#define vainSInt	BUFFER[464]	// Внутренняя переменная vainSInt
#define idvainSInt	122	// Внутренняя переменная vainSInt
#define var12	BUFFER[467]	// Внутренняя переменная var12
#define idvar12	123	// Внутренняя переменная var12
#define var28	BUFFER[469]	// Внутренняя переменная var28
#define idvar28	124	// Внутренняя переменная var28
#define vainSBool	BUFFER[471]	// Внутренняя переменная vainSBool
#define idvainSBool	125	// Внутренняя переменная vainSBool
#define var15	BUFFER[473]	// Внутренняя переменная var15
#define idvar15	126	// Внутренняя переменная var15
#define var30	BUFFER[478]	// Внутренняя переменная var30
#define idvar30	127	// Внутренняя переменная var30
#define var9	BUFFER[480]	// Внутренняя переменная var9
#define idvar9	128	// Внутренняя переменная var9
#define var10	BUFFER[482]	// Внутренняя переменная var10
...
#define var5	BUFFER[489]	// Внутренняя переменная var5
#define idvar5	131	// Внутренняя переменная var5
#define var13	BUFFER[494]	// Внутренняя переменная var13
#define idvar13	132	// Внутренняя переменная var13
#define var20	BUFFER[496]	// Внутренняя переменная var20
#define idvar20	133	// Внутренняя переменная var20
#define var21	BUFFER[501]	// Внутренняя переменная var21
#define idvar21	134	// Внутренняя переменная var21
#define var23	BUFFER[504]	// Внутренняя переменная var23
#define idvar23	135	// Внутренняя переменная var23
#define var27	BUFFER[509]	// Внутренняя переменная var27
#define idvar27	136	// Внутренняя переменная var27
#define var8	BUFFER[511]	// Внутренняя переменная var8
#define idvar8	137	// Внутренняя переменная var8
#define var11	BUFFER[513]	// Внутренняя переменная var11
#define idvar11	138	// Внутренняя переменная var11
#define var24	BUFFER[515]	// Внутренняя переменная var24
...
#define var18	BUFFER[519]	// Внутренняя переменная var18
#define idvar18	141	// Внутренняя переменная var18
#define var22	BUFFER[524]	// Внутренняя переменная var22
#define idvar22	142	// Внутренняя переменная var22
#define var32	BUFFER[526]	// Внутренняя переменная var32
#define idvar32	143	// Внутренняя переменная var32
#define var16	BUFFER[531]	// Внутренняя переменная var16
#define idvar16	144	// Внутренняя переменная var16
...
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{109	,1	,1	,&var33},	//Внутренняя переменная var33
	{110	,8	,1	,&var1},	//Внутренняя переменная var1
	{111	,8	,1	,&var4},	//Внутренняя переменная var4
	{112	,8	,1	,&var7},	//Внутренняя переменная var7
	{113	,3	,1	,&var14},	//Внутренняя переменная var14
	...
	{117	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	{118	,8	,1	,&var3},	//Внутренняя переменная var3
	{119	,8	,1	,&var6},	//Внутренняя переменная var6
	{120	,8	,1	,&vainSFloat},	//Внутренняя переменная vainSFloat
	{121	,1	,1	,&var29},	//Внутренняя переменная var29
	{122	,3	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	{123	,1	,1	,&var12},	//Внутренняя переменная var12
	{124	,1	,1	,&var28},	//Внутренняя переменная var28
	{125	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	{126	,8	,1	,&var15},	//Внутренняя переменная var15
	{127	,1	,1	,&var30},	//Внутренняя переменная var30
	{128	,1	,1	,&var9},	//Внутренняя переменная var9
	{129	,1	,1	,&var10},	//Внутренняя переменная var10
	{130	,8	,1	,&var2},	//Внутренняя переменная var2
	{131	,8	,1	,&var5},	//Внутренняя переменная var5
	{132	,1	,1	,&var13},	//Внутренняя переменная var13
	{133	,8	,1	,&var20},	//Внутренняя переменная var20
	{134	,3	,1	,&var21},	//Внутренняя переменная var21
	{135	,8	,1	,&var23},	//Внутренняя переменная var23
	{136	,1	,1	,&var27},	//Внутренняя переменная var27
	{137	,1	,1	,&var8},	//Внутренняя переменная var8
	{138	,1	,1	,&var11},	//Внутренняя переменная var11
	...
	{143	,8	,1	,&var32},	//Внутренняя переменная var32
	{144	,8	,1	,&var16},	//Внутренняя переменная var16
