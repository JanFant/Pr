...
#define var11	BUFFER[416]	// Внутренняя переменная var11
#define idvar11	111	// Внутренняя переменная var11
#define var26	BUFFER[418]	// Внутренняя переменная var26
#define idvar26	112	// Внутренняя переменная var26
#define var9	BUFFER[420]	// Внутренняя переменная var9
#define idvar9	113	// Внутренняя переменная var9
#define var20	BUFFER[422]	// Внутренняя переменная var20
#define idvar20	114	// Внутренняя переменная var20
#define var23	BUFFER[427]	// Внутренняя переменная var23
#define idvar23	115	// Внутренняя переменная var23
#define var4	BUFFER[432]	// Внутренняя переменная var4
#define idvar4	116	// Внутренняя переменная var4
#define var10	BUFFER[437]	// Внутренняя переменная var10
...
#define var31	BUFFER[454]	// Внутренняя переменная var31
#define idvar31	121	// Внутренняя переменная var31
#define var33	BUFFER[456]	// Внутренняя переменная var33
#define idvar33	122	// Внутренняя переменная var33
#define vainSFloat	BUFFER[458]	// Внутренняя переменная vainSFloat
#define idvainSFloat	123	// Внутренняя переменная vainSFloat
#define var1	BUFFER[463]	// Внутренняя переменная var1
#define idvar1	124	// Внутренняя переменная var1
#define var2	BUFFER[468]	// Внутренняя переменная var2
#define idvar2	125	// Внутренняя переменная var2
#define var5	BUFFER[473]	// Внутренняя переменная var5
#define idvar5	126	// Внутренняя переменная var5
#define var7	BUFFER[478]	// Внутренняя переменная var7
#define idvar7	127	// Внутренняя переменная var7
#define var13	BUFFER[483]	// Внутренняя переменная var13
#define idvar13	128	// Внутренняя переменная var13
#define vainSInt	BUFFER[485]	// Внутренняя переменная vainSInt
#define idvainSInt	129	// Внутренняя переменная vainSInt
#define var29	BUFFER[490]	// Внутренняя переменная var29
#define idvar29	130	// Внутренняя переменная var29
#define var30	BUFFER[492]	// Внутренняя переменная var30
...
#define var22	BUFFER[496]	// Внутренняя переменная var22
#define idvar22	133	// Внутренняя переменная var22
...
#define var6	BUFFER[505]	// Внутренняя переменная var6
#define idvar6	136	// Внутренняя переменная var6
#define var12	BUFFER[510]	// Внутренняя переменная var12
#define idvar12	137	// Внутренняя переменная var12
...
#define var21	BUFFER[519]	// Внутренняя переменная var21
#define idvar21	140	// Внутренняя переменная var21
#define vainSLong	BUFFER[524]	// Внутренняя переменная vainSLong
#define idvainSLong	141	// Внутренняя переменная vainSLong
#define vainSBool	BUFFER[533]	// Внутренняя переменная vainSBool
#define idvainSBool	142	// Внутренняя переменная vainSBool
#define var19	BUFFER[535]	// Внутренняя переменная var19
#define idvar19	143	// Внутренняя переменная var19
#define var24	BUFFER[540]	// Внутренняя переменная var24
#define idvar24	144	// Внутренняя переменная var24
#define var28	BUFFER[542]	// Внутренняя переменная var28
#define idvar28	145	// Внутренняя переменная var28
#pragma pack(push,1)
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{114	,8	,1	,&var20},	//Внутренняя переменная var20
	...
	{121	,1	,1	,&var31},	//Внутренняя переменная var31
	...
	{125	,8	,1	,&var2},	//Внутренняя переменная var2
	...
	{133	,1	,1	,&var22},	//Внутренняя переменная var22
	{134	,1	,1	,&var27},	//Внутренняя переменная var27
	{135	,8	,1	,&var32},	//Внутренняя переменная var32
	{136	,8	,1	,&var6},	//Внутренняя переменная var6
	{137	,1	,1	,&var12},	//Внутренняя переменная var12
	{138	,1	,1	,&var17},	//Внутренняя переменная var17
	{139	,8	,1	,&var18},	//Внутренняя переменная var18
	{140	,5	,1	,&var21},	//Внутренняя переменная var21
	{141	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	{142	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	{143	,8	,1	,&var19},	//Внутренняя переменная var19
	{144	,1	,1	,&var24},	//Внутренняя переменная var24
	{145	,1	,1	,&var28},	//Внутренняя переменная var28
	{-1,0,NULL},
};
