...
#define var11	BUFFER[419]	// Внутренняя переменная var11
#define idvar11	111	// Внутренняя переменная var11
...
#define var26	BUFFER[431]	// Внутренняя переменная var26
#define idvar26	114	// Внутренняя переменная var26
#define var30	BUFFER[433]	// Внутренняя переменная var30
#define idvar30	115	// Внутренняя переменная var30
#define var6	BUFFER[435]	// Внутренняя переменная var6
#define idvar6	116	// Внутренняя переменная var6
#define var13	BUFFER[440]	// Внутренняя переменная var13
#define idvar13	117	// Внутренняя переменная var13
#define var14	BUFFER[442]	// Внутренняя переменная var14
#define idvar14	118	// Внутренняя переменная var14
#define var18	BUFFER[447]	// Внутренняя переменная var18
#define idvar18	119	// Внутренняя переменная var18
#define var21	BUFFER[452]	// Внутренняя переменная var21
#define idvar21	120	// Внутренняя переменная var21
#define var22	BUFFER[457]	// Внутренняя переменная var22
#define idvar22	121	// Внутренняя переменная var22
#define var23	BUFFER[459]	// Внутренняя переменная var23
#define idvar23	122	// Внутренняя переменная var23
#define var27	BUFFER[464]	// Внутренняя переменная var27
#define idvar27	123	// Внутренняя переменная var27
#define var32	BUFFER[466]	// Внутренняя переменная var32
#define idvar32	124	// Внутренняя переменная var32
#define vainSFloat	BUFFER[471]	// Внутренняя переменная vainSFloat
#define idvainSFloat	125	// Внутренняя переменная vainSFloat
#define var7	BUFFER[476]	// Внутренняя переменная var7
#define idvar7	126	// Внутренняя переменная var7
#define var8	BUFFER[481]	// Внутренняя переменная var8
#define idvar8	127	// Внутренняя переменная var8
#define var10	BUFFER[483]	// Внутренняя переменная var10
#define idvar10	128	// Внутренняя переменная var10
#define var17	BUFFER[485]	// Внутренняя переменная var17
#define idvar17	129	// Внутренняя переменная var17
#define var20	BUFFER[487]	// Внутренняя переменная var20
#define idvar20	130	// Внутренняя переменная var20
#define var29	BUFFER[492]	// Внутренняя переменная var29
#define idvar29	131	// Внутренняя переменная var29
#define var31	BUFFER[494]	// Внутренняя переменная var31
#define idvar31	132	// Внутренняя переменная var31
#define var5	BUFFER[496]	// Внутренняя переменная var5
#define idvar5	133	// Внутренняя переменная var5
#define var12	BUFFER[501]	// Внутренняя переменная var12
#define idvar12	134	// Внутренняя переменная var12
#define var25	BUFFER[503]	// Внутренняя переменная var25
#define idvar25	135	// Внутренняя переменная var25
#define var33	BUFFER[505]	// Внутренняя переменная var33
#define idvar33	136	// Внутренняя переменная var33
#define var4	BUFFER[507]	// Внутренняя переменная var4
#define idvar4	137	// Внутренняя переменная var4
#define var15	BUFFER[512]	// Внутренняя переменная var15
#define idvar15	138	// Внутренняя переменная var15
#define var3	BUFFER[517]	// Внутренняя переменная var3
#define idvar3	139	// Внутренняя переменная var3
#define var9	BUFFER[522]	// Внутренняя переменная var9
#define idvar9	140	// Внутренняя переменная var9
#define vainSLong	BUFFER[524]	// Внутренняя переменная vainSLong
#define idvainSLong	141	// Внутренняя переменная vainSLong
#define var24	BUFFER[533]	// Внутренняя переменная var24
#define idvar24	142	// Внутренняя переменная var24
#define var28	BUFFER[535]	// Внутренняя переменная var28
...
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{111	,1	,1	,&var11},	//Внутренняя переменная var11
	{112	,8	,1	,&var16},	//Внутренняя переменная var16
	{113	,8	,1	,&var19},	//Внутренняя переменная var19
	{114	,1	,1	,&var26},	//Внутренняя переменная var26
	{115	,1	,1	,&var30},	//Внутренняя переменная var30
	{116	,8	,1	,&var6},	//Внутренняя переменная var6
	{117	,1	,1	,&var13},	//Внутренняя переменная var13
	{118	,5	,1	,&var14},	//Внутренняя переменная var14
	{119	,8	,1	,&var18},	//Внутренняя переменная var18
	{120	,5	,1	,&var21},	//Внутренняя переменная var21
	{121	,1	,1	,&var22},	//Внутренняя переменная var22
	...
	{125	,8	,1	,&vainSFloat},	//Внутренняя переменная vainSFloat
	...
	{130	,8	,1	,&var20},	//Внутренняя переменная var20
	{131	,1	,1	,&var29},	//Внутренняя переменная var29
	{132	,1	,1	,&var31},	//Внутренняя переменная var31
	{133	,8	,1	,&var5},	//Внутренняя переменная var5
	...
	{138	,8	,1	,&var15},	//Внутренняя переменная var15
	{139	,8	,1	,&var3},	//Внутренняя переменная var3
	{140	,1	,1	,&var9},	//Внутренняя переменная var9
	{141	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	{142	,1	,1	,&var24},	//Внутренняя переменная var24
