...
#define R0IN01FS3	 BUFFER[44]	//(vchs:01 - K01VCHS, AKNP3) Выход СНМ-11 Гц
#define idR0IN01FS3	 21	//(vchs:01 - K01VCHS, AKNP3) Выход СНМ-11 Гц
#define R0IN02FI3	 BUFFER[49]	//( - , MA3S) Выход КНК15-1 Гц от ПТИ
#define idR0IN02FI3	 22	//( - , MA3S) Выход КНК15-1 Гц от ПТИ
#define R0IN03FS3	 BUFFER[54]	//(vchs:02 - K01VCHS, AKNP3) Выход КНК53М Гц
#define idR0IN03FS3	 23	//(vchs:02 - K01VCHS, AKNP3) Выход КНК53М Гц
...
#define R0IN02FS3	 BUFFER[66]	//(vchs:01 - K02VCHS, AKNP3) Выход КНК15-1 Гц
#define idR0IN02FS3	 26	//(vchs:01 - K02VCHS, AKNP3) Выход КНК15-1 Гц
...
#define idinternal1_m57_flst	 89	//(internal1_m57_flst)  флаг старта измерения
#define internal1_m57_chsr	 BUFFER[319]	//(internal1_m57_chsr)  счетчик усреднения
#define idinternal1_m57_chsr	 90	//(internal1_m57_chsr)  счетчик усреднения
#define internal1_m57_chizm	 BUFFER[322]	//(internal1_m57_chizm)  счетчик уменьшения мощности
#define idinternal1_m57_chizm	 91	//(internal1_m57_chizm)  счетчик уменьшения мощности
...
#define internal1_m57_Wmin	 BUFFER[340]	//(internal1_m57_Wmin)  минимальное измерение в серии
#define idinternal1_m57_Wmin	 95	//(internal1_m57_Wmin)  минимальное измерение в серии
#define internal1_m57_Wmax	 BUFFER[345]	//(internal1_m57_Wmax)  максимальное измерение в серии
#define idinternal1_m57_Wmax	 96	//(internal1_m57_Wmax)  максимальное измерение в серии
#define internal1_m57_Wlast	 BUFFER[350]	//(internal1_m57_Wlast)  последнее растущее измерение
#define idinternal1_m57_Wlast	 97	//(internal1_m57_Wlast)  последнее растущее измерение
#define internal1_m57_y0	 BUFFER[355]	//(internal1_m57_y0) y0 - внутренний параметр
#define idinternal1_m57_y0	 98	//(internal1_m57_y0) y0 - внутренний параметр
#define internal1_m57_MyFirstEnterFlag	 BUFFER[360]	//(internal1_m57_MyFirstEnterFlag)  FirstEnterFlag
#define idinternal1_m57_MyFirstEnterFlag	 99	//(internal1_m57_MyFirstEnterFlag)  FirstEnterFlag
#pragma pack(push,1)
static VarCtrl allVariables[]={      // Описание всех переменных
	...
	{ 21	,8	,1	, &R0IN01FS3},	//(vchs:01 - K01VCHS, AKNP3) Выход СНМ-11 Гц
	{ 22	,8	,1	, &R0IN02FI3},	//( - , MA3S) Выход КНК15-1 Гц от ПТИ
	{ 23	,8	,1	, &R0IN03FS3},	//(vchs:02 - K01VCHS, AKNP3) Выход КНК53М Гц
	{ 24	,1	,1	, &R0IS01FI0},	//( - , MA3S) Признак работы с имитатором
	{ 25	,8	,1	, &R0IN01FI3},	//( - , MA3S) Выход СНМ-11 Гц от ПТИ
	{ 26	,8	,1	, &R0IN02FS3},	//(vchs:01 - K02VCHS, AKNP3) Выход КНК15-1 Гц
	...
	{ 89	,3	,1	, &internal1_m57_flst},	//(internal1_m57_flst)  флаг старта измерения
	{ 90	,3	,1	, &internal1_m57_chsr},	//(internal1_m57_chsr)  счетчик усреднения
	{ 91	,3	,1	, &internal1_m57_chizm},	//(internal1_m57_chizm)  счетчик уменьшения мощности
	...
	{ 95	,8	,1	, &internal1_m57_Wmin},	//(internal1_m57_Wmin)  минимальное измерение в серии
	{ 96	,8	,1	, &internal1_m57_Wmax},	//(internal1_m57_Wmax)  максимальное измерение в серии
	{ 97	,8	,1	, &internal1_m57_Wlast},	//(internal1_m57_Wlast)  последнее растущее измерение
	{ 98	,8	,1	, &internal1_m57_y0},	//(internal1_m57_y0) y0 - внутренний параметр
	{ 99	,1	,1	, &internal1_m57_MyFirstEnterFlag},	//(internal1_m57_MyFirstEnterFlag)  FirstEnterFlag
	{-1,0,NULL},
};
...
static ModbusRegister ir_AKNP3[]={  // 
	...
	{&R0IN01FS3,8,12},	//( - K01VCHS, AKNP3) Выход СНМ-11 Гц
	{&R0IN03FS3,8,14},	//( - K01VCHS, AKNP3) Выход КНК53М Гц
	{&R0IN02FS3,8,16},	//( - K02VCHS, AKNP3) Выход КНК15-1 Гц
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
