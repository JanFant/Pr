...
#define idvar28	110	// Внутренняя переменная var28
#define var10	BUFFER[413]	// Внутренняя переменная var10
#define idvar10	111	// Внутренняя переменная var10
#define var23	BUFFER[415]	// Внутренняя переменная var23
#define idvar23	112	// Внутренняя переменная var23
#define var24	BUFFER[420]	// Внутренняя переменная var24
#define idvar24	113	// Внутренняя переменная var24
#define var30	BUFFER[422]	// Внутренняя переменная var30
#define idvar30	114	// Внутренняя переменная var30
#define var32	BUFFER[424]	// Внутренняя переменная var32
#define idvar32	115	// Внутренняя переменная var32
#define var13	BUFFER[429]	// Внутренняя переменная var13
#define idvar13	116	// Внутренняя переменная var13
#define var20	BUFFER[431]	// Внутренняя переменная var20
#define idvar20	117	// Внутренняя переменная var20
#define var14	BUFFER[436]	// Внутренняя переменная var14
#define idvar14	118	// Внутренняя переменная var14
#define var17	BUFFER[441]	// Внутренняя переменная var17
#define idvar17	119	// Внутренняя переменная var17
#define var19	BUFFER[443]	// Внутренняя переменная var19
#define idvar19	120	// Внутренняя переменная var19
#define var21	BUFFER[448]	// Внутренняя переменная var21
#define idvar21	121	// Внутренняя переменная var21
#define var4	BUFFER[453]	// Внутренняя переменная var4
#define idvar4	122	// Внутренняя переменная var4
#define var11	BUFFER[458]	// Внутренняя переменная var11
#define idvar11	123	// Внутренняя переменная var11
#define var6	BUFFER[460]	// Внутренняя переменная var6
#define idvar6	124	// Внутренняя переменная var6
#define var8	BUFFER[465]	// Внутренняя переменная var8
#define idvar8	125	// Внутренняя переменная var8
#define var9	BUFFER[467]	// Внутренняя переменная var9
#define idvar9	126	// Внутренняя переменная var9
#define var16	BUFFER[469]	// Внутренняя переменная var16
#define idvar16	127	// Внутренняя переменная var16
#define vainSInt	BUFFER[474]	// Внутренняя переменная vainSInt
#define idvainSInt	128	// Внутренняя переменная vainSInt
#define var1	BUFFER[479]	// Внутренняя переменная var1
#define idvar1	129	// Внутренняя переменная var1
#define var3	BUFFER[484]	// Внутренняя переменная var3
#define idvar3	130	// Внутренняя переменная var3
#define var33	BUFFER[489]	// Внутренняя переменная var33
#define idvar33	131	// Внутренняя переменная var33
#define vainSFloat	BUFFER[491]	// Внутренняя переменная vainSFloat
...
#define var31	BUFFER[501]	// Внутренняя переменная var31
#define idvar31	134	// Внутренняя переменная var31
#define var2	BUFFER[503]	// Внутренняя переменная var2
#define idvar2	135	// Внутренняя переменная var2
#define vainSBool	BUFFER[508]	// Внутренняя переменная vainSBool
#define idvainSBool	136	// Внутренняя переменная vainSBool
#define var25	BUFFER[510]	// Внутренняя переменная var25
#define idvar25	137	// Внутренняя переменная var25
#define vainSLong	BUFFER[512]	// Внутренняя переменная vainSLong
#define idvainSLong	138	// Внутренняя переменная vainSLong
#define var12	BUFFER[521]	// Внутренняя переменная var12
#define idvar12	139	// Внутренняя переменная var12
#define var18	BUFFER[523]	// Внутренняя переменная var18
#define idvar18	140	// Внутренняя переменная var18
#define var22	BUFFER[528]	// Внутренняя переменная var22
#define idvar22	141	// Внутренняя переменная var22
#define var27	BUFFER[530]	// Внутренняя переменная var27
#define idvar27	142	// Внутренняя переменная var27
#define var29	BUFFER[532]	// Внутренняя переменная var29
...
#define var7	BUFFER[539]	// Внутренняя переменная var7
#define idvar7	145	// Внутренняя переменная var7
#pragma pack(push,1)
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{110	,1	,1	,&var28},	//Внутренняя переменная var28
	{111	,1	,1	,&var10},	//Внутренняя переменная var10
	{112	,8	,1	,&var23},	//Внутренняя переменная var23
	{113	,1	,1	,&var24},	//Внутренняя переменная var24
	{114	,1	,1	,&var30},	//Внутренняя переменная var30
	{115	,8	,1	,&var32},	//Внутренняя переменная var32
	{116	,1	,1	,&var13},	//Внутренняя переменная var13
	{117	,8	,1	,&var20},	//Внутренняя переменная var20
	...
	{121	,5	,1	,&var21},	//Внутренняя переменная var21
	{122	,8	,1	,&var4},	//Внутренняя переменная var4
	{123	,1	,1	,&var11},	//Внутренняя переменная var11
	{124	,8	,1	,&var6},	//Внутренняя переменная var6
	{125	,1	,1	,&var8},	//Внутренняя переменная var8
	{126	,1	,1	,&var9},	//Внутренняя переменная var9
	{127	,8	,1	,&var16},	//Внутренняя переменная var16
	{128	,5	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	{129	,8	,1	,&var1},	//Внутренняя переменная var1
	{130	,8	,1	,&var3},	//Внутренняя переменная var3
	...
	{134	,1	,1	,&var31},	//Внутренняя переменная var31
	{135	,8	,1	,&var2},	//Внутренняя переменная var2
	{136	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	{137	,1	,1	,&var25},	//Внутренняя переменная var25
	{138	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	{139	,1	,1	,&var12},	//Внутренняя переменная var12
	{140	,8	,1	,&var18},	//Внутренняя переменная var18
	{141	,1	,1	,&var22},	//Внутренняя переменная var22
	{142	,1	,1	,&var27},	//Внутренняя переменная var27
	{143	,1	,1	,&var29},	//Внутренняя переменная var29
	{144	,8	,1	,&var5},	//Внутренняя переменная var5
	{145	,8	,1	,&var7},	//Внутренняя переменная var7
	{-1,0,NULL},
};
