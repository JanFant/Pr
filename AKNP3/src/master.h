...
#define var4	BUFFER[409]	// Внутренняя переменная var4
#define idvar4	109	// Внутренняя переменная var4
#define var18	BUFFER[414]	// Внутренняя переменная var18
#define idvar18	110	// Внутренняя переменная var18
#define var20	BUFFER[419]	// Внутренняя переменная var20
#define idvar20	111	// Внутренняя переменная var20
#define var26	BUFFER[424]	// Внутренняя переменная var26
#define idvar26	112	// Внутренняя переменная var26
#define var27	BUFFER[426]	// Внутренняя переменная var27
#define idvar27	113	// Внутренняя переменная var27
...
#define vainSBool	BUFFER[432]	// Внутренняя переменная vainSBool
#define idvainSBool	116	// Внутренняя переменная vainSBool
#define var16	BUFFER[434]	// Внутренняя переменная var16
#define idvar16	117	// Внутренняя переменная var16
#define vainSInt	BUFFER[439]	// Внутренняя переменная vainSInt
#define idvainSInt	118	// Внутренняя переменная vainSInt
#define var11	BUFFER[444]	// Внутренняя переменная var11
#define idvar11	119	// Внутренняя переменная var11
#define var25	BUFFER[446]	// Внутренняя переменная var25
#define idvar25	120	// Внутренняя переменная var25
#define var32	BUFFER[448]	// Внутренняя переменная var32
#define idvar32	121	// Внутренняя переменная var32
#define var3	BUFFER[453]	// Внутренняя переменная var3
#define idvar3	122	// Внутренняя переменная var3
#define var10	BUFFER[458]	// Внутренняя переменная var10
#define idvar10	123	// Внутренняя переменная var10
#define var12	BUFFER[460]	// Внутренняя переменная var12
#define idvar12	124	// Внутренняя переменная var12
#define var13	BUFFER[462]	// Внутренняя переменная var13
#define idvar13	125	// Внутренняя переменная var13
#define var15	BUFFER[464]	// Внутренняя переменная var15
#define idvar15	126	// Внутренняя переменная var15
...
#define var31	BUFFER[481]	// Внутренняя переменная var31
#define idvar31	130	// Внутренняя переменная var31
#define var2	BUFFER[483]	// Внутренняя переменная var2
#define idvar2	131	// Внутренняя переменная var2
#define var22	BUFFER[488]	// Внутренняя переменная var22
#define idvar22	132	// Внутренняя переменная var22
#define var24	BUFFER[490]	// Внутренняя переменная var24
#define idvar24	133	// Внутренняя переменная var24
#define vainSLong	BUFFER[492]	// Внутренняя переменная vainSLong
#define idvainSLong	134	// Внутренняя переменная vainSLong
#define var6	BUFFER[501]	// Внутренняя переменная var6
...
#define idvar9	137	// Внутренняя переменная var9
#define var17	BUFFER[510]	// Внутренняя переменная var17
#define idvar17	138	// Внутренняя переменная var17
#define var1	BUFFER[512]	// Внутренняя переменная var1
#define idvar1	139	// Внутренняя переменная var1
#define var5	BUFFER[517]	// Внутренняя переменная var5
#define idvar5	140	// Внутренняя переменная var5
#define var14	BUFFER[522]	// Внутренняя переменная var14
#define idvar14	141	// Внутренняя переменная var14
#define var21	BUFFER[527]	// Внутренняя переменная var21
...
#define var7	BUFFER[537]	// Внутренняя переменная var7
#define idvar7	144	// Внутренняя переменная var7
#define var29	BUFFER[542]	// Внутренняя переменная var29
#define idvar29	145	// Внутренняя переменная var29
#pragma pack(push,1)
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{109	,8	,1	,&var4},	//Внутренняя переменная var4
	{110	,8	,1	,&var18},	//Внутренняя переменная var18
	{111	,8	,1	,&var20},	//Внутренняя переменная var20
	{112	,1	,1	,&var26},	//Внутренняя переменная var26
	{113	,1	,1	,&var27},	//Внутренняя переменная var27
	{114	,1	,1	,&var30},	//Внутренняя переменная var30
	{115	,1	,1	,&var33},	//Внутренняя переменная var33
	{116	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	{117	,8	,1	,&var16},	//Внутренняя переменная var16
	{118	,5	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	{119	,1	,1	,&var11},	//Внутренняя переменная var11
	{120	,1	,1	,&var25},	//Внутренняя переменная var25
	{121	,8	,1	,&var32},	//Внутренняя переменная var32
	{122	,8	,1	,&var3},	//Внутренняя переменная var3
	{123	,1	,1	,&var10},	//Внутренняя переменная var10
	{124	,1	,1	,&var12},	//Внутренняя переменная var12
	{125	,1	,1	,&var13},	//Внутренняя переменная var13
	{126	,8	,1	,&var15},	//Внутренняя переменная var15
	...
	{131	,8	,1	,&var2},	//Внутренняя переменная var2
	{132	,1	,1	,&var22},	//Внутренняя переменная var22
	{133	,1	,1	,&var24},	//Внутренняя переменная var24
	...
	{137	,1	,1	,&var9},	//Внутренняя переменная var9
	{138	,1	,1	,&var17},	//Внутренняя переменная var17
	{139	,8	,1	,&var1},	//Внутренняя переменная var1
	{140	,8	,1	,&var5},	//Внутренняя переменная var5
	{141	,5	,1	,&var14},	//Внутренняя переменная var14
	...
	{145	,1	,1	,&var29},	//Внутренняя переменная var29
	{-1,0,NULL},
};
