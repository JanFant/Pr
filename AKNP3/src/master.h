...
#define vainSBool	BUFFER[503]	// Внутренняя переменная vainSBool
#define idvainSBool	136	// Внутренняя переменная vainSBool
#define vainSFloat	BUFFER[529]	// Внутренняя переменная vainSFloat
#define idvainSFloat	143	// Внутренняя переменная vainSFloat
#define vainSInt	BUFFER[534]	// Внутренняя переменная vainSInt
#define idvainSInt	144	// Внутренняя переменная vainSInt
#define vainSLong	BUFFER[494]	// Внутренняя переменная vainSLong
#define idvainSLong	135	// Внутренняя переменная vainSLong
#define var1	BUFFER[474]	// Внутренняя переменная var1
#define idvar1	131	// Внутренняя переменная var1
#define var10	BUFFER[454]	// Внутренняя переменная var10
#define idvar10	124	// Внутренняя переменная var10
#define var11	BUFFER[409]	// Внутренняя переменная var11
#define idvar11	109	// Внутренняя переменная var11
#define var12	BUFFER[468]	// Внутренняя переменная var12
...
#define idvar14	139	// Внутренняя переменная var14
#define var15	BUFFER[520]	// Внутренняя переменная var15
#define idvar15	140	// Внутренняя переменная var15
#define var16	BUFFER[479]	// Внутренняя переменная var16
#define idvar16	132	// Внутренняя переменная var16
#define var17	BUFFER[443]	// Внутренняя переменная var17
#define idvar17	120	// Внутренняя переменная var17
#define var18	BUFFER[436]	// Внутренняя переменная var18
#define idvar18	118	// Внутренняя переменная var18
#define var19	BUFFER[411]	// Внутренняя переменная var19
...
#define var20	BUFFER[484]	// Внутренняя переменная var20
#define idvar20	133	// Внутренняя переменная var20
#define var21	BUFFER[416]	// Внутренняя переменная var21
#define idvar21	111	// Внутренняя переменная var21
#define var22	BUFFER[434]	// Внутренняя переменная var22
#define idvar22	117	// Внутренняя переменная var22
#define var23	BUFFER[489]	// Внутренняя переменная var23
#define idvar23	134	// Внутренняя переменная var23
#define var24	BUFFER[470]	// Внутренняя переменная var24
#define idvar24	129	// Внутренняя переменная var24
#define var25	BUFFER[445]	// Внутренняя переменная var25
#define idvar25	121	// Внутренняя переменная var25
#define var26	BUFFER[447]	// Внутренняя переменная var26
#define idvar26	122	// Внутренняя переменная var26
#define var27	BUFFER[423]	// Внутренняя переменная var27
#define idvar27	113	// Внутренняя переменная var27
#define var28	BUFFER[425]	// Внутренняя переменная var28
#define idvar28	114	// Внутренняя переменная var28
#define var29	BUFFER[472]	// Внутренняя переменная var29
#define idvar29	130	// Внутренняя переменная var29
#define var3	BUFFER[429]	// Внутренняя переменная var3
#define idvar3	116	// Внутренняя переменная var3
#define var30	BUFFER[525]	// Внутренняя переменная var30
#define idvar30	141	// Внутренняя переменная var30
#define var31	BUFFER[527]	// Внутренняя переменная var31
#define idvar31	142	// Внутренняя переменная var31
#define var32	BUFFER[449]	// Внутренняя переменная var32
#define idvar32	123	// Внутренняя переменная var32
#define var33	BUFFER[427]	// Внутренняя переменная var33
#define idvar33	115	// Внутренняя переменная var33
#define var4	BUFFER[510]	// Внутренняя переменная var4
#define idvar4	138	// Внутренняя переменная var4
#define var5	BUFFER[505]	// Внутренняя переменная var5
#define idvar5	137	// Внутренняя переменная var5
#define var6	BUFFER[456]	// Внутренняя переменная var6
#define idvar6	125	// Внутренняя переменная var6
#define var7	BUFFER[461]	// Внутренняя переменная var7
#define idvar7	126	// Внутренняя переменная var7
#define var8	BUFFER[466]	// Внутренняя переменная var8
#define idvar8	127	// Внутренняя переменная var8
#define var9	BUFFER[421]	// Внутренняя переменная var9
#define idvar9	112	// Внутренняя переменная var9
#pragma pack(push,1)
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{136	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	{143	,8	,1	,&vainSFloat},	//Внутренняя переменная vainSFloat
	{144	,5	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	{135	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	...
	{139	,5	,1	,&var14},	//Внутренняя переменная var14
	{140	,8	,1	,&var15},	//Внутренняя переменная var15
	{132	,8	,1	,&var16},	//Внутренняя переменная var16
	...
	{111	,5	,1	,&var21},	//Внутренняя переменная var21
	{117	,1	,1	,&var22},	//Внутренняя переменная var22
	{134	,8	,1	,&var23},	//Внутренняя переменная var23
	{129	,1	,1	,&var24},	//Внутренняя переменная var24
	{121	,1	,1	,&var25},	//Внутренняя переменная var25
	{122	,1	,1	,&var26},	//Внутренняя переменная var26
	{113	,1	,1	,&var27},	//Внутренняя переменная var27
	{114	,1	,1	,&var28},	//Внутренняя переменная var28
	{130	,1	,1	,&var29},	//Внутренняя переменная var29
	{116	,8	,1	,&var3},	//Внутренняя переменная var3
	{141	,1	,1	,&var30},	//Внутренняя переменная var30
	{142	,1	,1	,&var31},	//Внутренняя переменная var31
	{123	,8	,1	,&var32},	//Внутренняя переменная var32
	...
	{112	,1	,1	,&var9},	//Внутренняя переменная var9
	{-1,0,NULL},
};
