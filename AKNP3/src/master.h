...
/* Объявление структур */
_S_and5  S_and5_63_1 = {&R0IE13LS3,&R0IE12LS3,&R0IE11LS3,&A0EE03LS3,&var6,&var1};
_S_and2  S_and2_55_1 = {&var13,&var16,&var2};
_S_and2  S_and2_54_1 = {&var16,&var17,&var3};
_S_ocham  S_ocham_17_1 = {&R0IN01FS3,&R0IN02FS3,&R0IN03FS3,&B8VC01RDU,&fEM_R7UX00RSS,&fEM_R7UY00RSS,&fEM_A0UX00RSS,&fEM_A0UX07RSS,&fEM_B0UX07RSS,&fEM_A0UX08RSS,&fEM_B0UX08RSS,&fEM_A0UX09RSS,&fEM_B0UX09RSS,&fEM_R7UX07RSS,&fEM_R7UY07RSS,&fEM_R7UX08RSS,&fEM_R7UY08RSS,&fEM_R7UX09RSS,&fEM_R7UY09RSS,&bRM_1_,&fRM_2_0,&fEM_R0UH02RSS,&fEM_R0UH03RSS,&fEM_R0UH05RSS,&var4,&var5,&var6,&var7,&var8,&var9,&var10,&internal1_m17_Nk};
_S_or2  S_or2_66_1 = {&R0EE03LZ1,&R0EE03LZ2,&var11};
...
if(getAsBool(idbFirstEnterFlag)==0) InitInternalParametr();
  ...
  and2(&S_and2_54_1);
  and2(&S_and2_55_1);
  setData(idA1EE01LS3,&var1);
  setData(idR0VN77LZ2,&var3);
  setData(idR0VN73LZ2,&var14);
  setData(idA0VN71LS3,&var19);
  setData(idR0IE02LS3,&var11);
  setData(idR0IE01LS3,&var11);
  setData(idR0VN15RS3,&var10);
  setData(idR0VN33RS3,&var9);
  setData(idR0VN23RS3,&var8);
  setData(idR0VN13RS3,&var7);
  setData(idA0EE02LS3,&var6);
  setData(idA1VN71LS3,&var19);
  setData(idR0VN04RS3,&var18);
  setData(idR0VN03RS3,&var4);
  setData(idA0EE01LS3,&var1);
  setData(idR0VN77LZ1,&var3);
  setData(idR0VN65LS3,&var2);
  setData(idR0VN73LZ1,&var14);
  setData(idR0VN61LS3,&var15);
  setData(idR0VN01RS3,&var12);
  setData(idR0VN02RS3,&var5);
