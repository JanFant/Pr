...
#define idvar30	109	// Внутренняя переменная var30
#define var3	BUFFER[411]	// Внутренняя переменная var3
#define idvar3	110	// Внутренняя переменная var3
#define var23	BUFFER[416]	// Внутренняя переменная var23
#define idvar23	111	// Внутренняя переменная var23
#define var25	BUFFER[421]	// Внутренняя переменная var25
#define idvar25	112	// Внутренняя переменная var25
#define var27	BUFFER[423]	// Внутренняя переменная var27
#define idvar27	113	// Внутренняя переменная var27
#define var1	BUFFER[425]	// Внутренняя переменная var1
#define idvar1	114	// Внутренняя переменная var1
#define var7	BUFFER[430]	// Внутренняя переменная var7
#define idvar7	115	// Внутренняя переменная var7
#define var13	BUFFER[435]	// Внутренняя переменная var13
#define idvar13	116	// Внутренняя переменная var13
#define var15	BUFFER[437]	// Внутренняя переменная var15
...
#define var28	BUFFER[444]	// Внутренняя переменная var28
#define idvar28	119	// Внутренняя переменная var28
#define var33	BUFFER[446]	// Внутренняя переменная var33
#define idvar33	120	// Внутренняя переменная var33
#define var4	BUFFER[448]	// Внутренняя переменная var4
#define idvar4	121	// Внутренняя переменная var4
#define var9	BUFFER[453]	// Внутренняя переменная var9
...
#define var14	BUFFER[467]	// Внутренняя переменная var14
#define idvar14	127	// Внутренняя переменная var14
#define var20	BUFFER[470]	// Внутренняя переменная var20
#define idvar20	128	// Внутренняя переменная var20
#define var29	BUFFER[475]	// Внутренняя переменная var29
#define idvar29	129	// Внутренняя переменная var29
#define var31	BUFFER[477]	// Внутренняя переменная var31
#define idvar31	130	// Внутренняя переменная var31
#define var21	BUFFER[479]	// Внутренняя переменная var21
#define idvar21	131	// Внутренняя переменная var21
#define vainSFloat	BUFFER[482]	// Внутренняя переменная vainSFloat
#define idvainSFloat	132	// Внутренняя переменная vainSFloat
#define var8	BUFFER[487]	// Внутренняя переменная var8
#define idvar8	133	// Внутренняя переменная var8
#define var10	BUFFER[489]	// Внутренняя переменная var10
#define idvar10	134	// Внутренняя переменная var10
#define var17	BUFFER[491]	// Внутренняя переменная var17
#define idvar17	135	// Внутренняя переменная var17
#define var18	BUFFER[493]	// Внутренняя переменная var18
#define idvar18	136	// Внутренняя переменная var18
#define vainSBool	BUFFER[498]	// Внутренняя переменная vainSBool
#define idvainSBool	137	// Внутренняя переменная vainSBool
#define var5	BUFFER[500]	// Внутренняя переменная var5
#define idvar5	138	// Внутренняя переменная var5
#define var11	BUFFER[505]	// Внутренняя переменная var11
#define idvar11	139	// Внутренняя переменная var11
#define var19	BUFFER[507]	// Внутренняя переменная var19
#define idvar19	140	// Внутренняя переменная var19
#define var24	BUFFER[512]	// Внутренняя переменная var24
#define idvar24	141	// Внутренняя переменная var24
#define var2	BUFFER[514]	// Внутренняя переменная var2
#define idvar2	142	// Внутренняя переменная var2
#define var6	BUFFER[519]	// Внутренняя переменная var6
...
#define vainSLong	BUFFER[529]	// Внутренняя переменная vainSLong
...
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{109	,1	,1	,&var30},	//Внутренняя переменная var30
	{110	,8	,1	,&var3},	//Внутренняя переменная var3
	{111	,8	,1	,&var23},	//Внутренняя переменная var23
	{112	,1	,1	,&var25},	//Внутренняя переменная var25
	{113	,1	,1	,&var27},	//Внутренняя переменная var27
	{114	,8	,1	,&var1},	//Внутренняя переменная var1
	...
	{120	,1	,1	,&var33},	//Внутренняя переменная var33
	...
	{126	,3	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	{127	,3	,1	,&var14},	//Внутренняя переменная var14
	{128	,8	,1	,&var20},	//Внутренняя переменная var20
	{129	,1	,1	,&var29},	//Внутренняя переменная var29
	{130	,1	,1	,&var31},	//Внутренняя переменная var31
	{131	,3	,1	,&var21},	//Внутренняя переменная var21
	...
	{135	,1	,1	,&var17},	//Внутренняя переменная var17
	{136	,8	,1	,&var18},	//Внутренняя переменная var18
	{137	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	{138	,8	,1	,&var5},	//Внутренняя переменная var5
	{139	,1	,1	,&var11},	//Внутренняя переменная var11
	{140	,8	,1	,&var19},	//Внутренняя переменная var19
	{141	,1	,1	,&var24},	//Внутренняя переменная var24
	{142	,8	,1	,&var2},	//Внутренняя переменная var2
