...
#define B3IS22LDU	 BUFFER[119]	//(vds32:06 - K06VDSR, - ) Приход на НУП ИС2
#define idB3IS22LDU	 52	//(vds32:06 - K06VDSR, - ) Приход на НУП ИС2
#define R0AD21LDU	 BUFFER[121]	//( - , SBz2DU) Подключить защиту от II УР
#define idR0AD21LDU	 53	//( - , SBz2DU) Подключить защиту от II УР
#define R6IS66LZZ	 BUFFER[123]	//( - , - ) Исправность ВИП 4,0 (№5) ССДИ-1-1
#define idR6IS66LZZ	 54	//( - , - ) Исправность ВИП 4,0 (№5) ССДИ-1-1
#define R6IS67LZZ	 BUFFER[125]	//( - , - ) Исправность ВИП 4,0 (№6) ССДИ-1-2
#define idR6IS67LZZ	 55	//( - , - ) Исправность ВИП 4,0 (№6) ССДИ-1-2
#define R6IS68LZZ	 BUFFER[127]	//( - , - ) Исправность ВИП 4,0 (№7) ССДИ-2
#define idR6IS68LZZ	 56	//( - , - ) Исправность ВИП 4,0 (№7) ССДИ-2
#define R7II72LZ2	 BUFFER[129]	//(vds32:08 - K06VDSR, Baz2) Сработала АС IУР РАД  (датчик 2)
#define idR7II72LZ2	 57	//(vds32:08 - K06VDSR, Baz2) Сработала АС IУР РАД  (датчик 2)
#define R7II71LZ2	 BUFFER[131]	//(vds32:08 - K05VDSR, Baz2) Сработала АС IУР РАД (датчик 1)
#define idR7II71LZ2	 58	//(vds32:08 - K05VDSR, Baz2) Сработала АС IУР РАД (датчик 1)
#define R7II73LZ2	 BUFFER[133]	//(vds32:08 - K07VDSR, Baz2) Сработала АС II УР РАД
#define idR7II73LZ2	 59	//(vds32:08 - K07VDSR, Baz2) Сработала АС II УР РАД
#define R0AD05LZ2	 BUFFER[135]	//(vds32:05 - K09VDSR, - ) Имитация ухода с НУП ИС
#define idR0AD05LZ2	 60	//(vds32:05 - K09VDSR, - ) Имитация ухода с НУП ИС
#define R0AD03LZ2	 BUFFER[137]	//(vds32:05 - K07VDSR, - ) Имитация прихода на ВУ ИС
#define idR0AD03LZ2	 61	//(vds32:05 - K07VDSR, - ) Имитация прихода на ВУ ИС
#define A3VZ11LZ2	 BUFFER[139]	//( - , Baz2) АЗ от НУП ИС1
#define idA3VZ11LZ2	 62	//( - , Baz2) АЗ от НУП ИС1
#define B3VZ11LZ2	 BUFFER[141]	//( - , - ) АЗ от НУП ИС2
#define idB3VZ11LZ2	 63	//( - , - ) АЗ от НУП ИС2
#define A3VZ31LZ2	 BUFFER[143]	//( - , - ) АЗ от ВУ ИС1
#define idA3VZ31LZ2	 64	//( - , - ) АЗ от ВУ ИС1
#define B3VZ31LZ2	 BUFFER[145]	//( - , - ) АЗ от ВУ ИС2
#define idB3VZ31LZ2	 65	//( - , - ) АЗ от ВУ ИС2
#define A3VZ13LZ2	 BUFFER[147]	//(fds16:0a - K01FDSR, - ) Имитация АЗ от ВУ ИС
#define idA3VZ13LZ2	 66	//(fds16:0a - K01FDSR, - ) Имитация АЗ от ВУ ИС
#define R0AD14LZ2	 BUFFER[149]	//(fds16:0a - K03FDSR, - ) Имитация АЗ от IIУР
#define idR0AD14LZ2	 67	//(fds16:0a - K03FDSR, - ) Имитация АЗ от IIУР
#define A3VZ15LZ2	 BUFFER[151]	//(fds16:0a - K02FDSR, - ) Имитация АЗ от НУП ИС
#define idA3VZ15LZ2	 68	//(fds16:0a - K02FDSR, - ) Имитация АЗ от НУП ИС
...
static VarCtrl allVariables[]={      // Описание всех переменных
	...
	{ 52	,1	,1	, &B3IS22LDU},	//(vds32:06 - K06VDSR, - ) Приход на НУП ИС2
	...
	{ 57	,1	,1	, &R7II72LZ2},	//(vds32:08 - K06VDSR, Baz2) Сработала АС IУР РАД  (датчик 2)
	{ 58	,1	,1	, &R7II71LZ2},	//(vds32:08 - K05VDSR, Baz2) Сработала АС IУР РАД (датчик 1)
	{ 59	,1	,1	, &R7II73LZ2},	//(vds32:08 - K07VDSR, Baz2) Сработала АС II УР РАД
	{ 60	,1	,1	, &R0AD05LZ2},	//(vds32:05 - K09VDSR, - ) Имитация ухода с НУП ИС
	{ 61	,1	,1	, &R0AD03LZ2},	//(vds32:05 - K07VDSR, - ) Имитация прихода на ВУ ИС
	{ 62	,1	,1	, &A3VZ11LZ2},	//( - , Baz2) АЗ от НУП ИС1
	{ 63	,1	,1	, &B3VZ11LZ2},	//( - , - ) АЗ от НУП ИС2
	{ 64	,1	,1	, &A3VZ31LZ2},	//( - , - ) АЗ от ВУ ИС1
	{ 65	,1	,1	, &B3VZ31LZ2},	//( - , - ) АЗ от ВУ ИС2
	{ 66	,1	,1	, &A3VZ13LZ2},	//(fds16:0a - K01FDSR, - ) Имитация АЗ от ВУ ИС
	{ 67	,1	,1	, &R0AD14LZ2},	//(fds16:0a - K03FDSR, - ) Имитация АЗ от IIУР
	{ 68	,1	,1	, &A3VZ15LZ2},	//(fds16:0a - K02FDSR, - ) Имитация АЗ от НУП ИС
...
static ModbusRegister coil_Baz2[]={  // 
	...
	{&R7II73LZ2,1,4},	//( - K07VDSR, Baz2) Сработала АС II УР РАД
