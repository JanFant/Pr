...
#define var3	BUFFER[658]	// Внутренняя переменная var3
#define idvar3	30000	// Внутренняя переменная var3
#define var23	BUFFER[660]	// Внутренняя переменная var23
#define idvar23	30001	// Внутренняя переменная var23
#define var96	BUFFER[662]	// Внутренняя переменная var96
#define idvar96	30002	// Внутренняя переменная var96
#define var138	BUFFER[664]	// Внутренняя переменная var138
#define idvar138	30003	// Внутренняя переменная var138
#define var106	BUFFER[666]	// Внутренняя переменная var106
#define idvar106	30004	// Внутренняя переменная var106
#define var4	BUFFER[668]	// Внутренняя переменная var4
#define idvar4	30005	// Внутренняя переменная var4
#define var14	BUFFER[670]	// Внутренняя переменная var14
#define idvar14	30006	// Внутренняя переменная var14
#define var52	BUFFER[672]	// Внутренняя переменная var52
#define idvar52	30007	// Внутренняя переменная var52
#define var57	BUFFER[674]	// Внутренняя переменная var57
#define idvar57	30008	// Внутренняя переменная var57
#define var102	BUFFER[676]	// Внутренняя переменная var102
#define idvar102	30009	// Внутренняя переменная var102
#define var128	BUFFER[678]	// Внутренняя переменная var128
#define idvar128	30010	// Внутренняя переменная var128
#define var1	BUFFER[680]	// Внутренняя переменная var1
#define idvar1	30011	// Внутренняя переменная var1
#define var32	BUFFER[682]	// Внутренняя переменная var32
#define idvar32	30012	// Внутренняя переменная var32
#define var86	BUFFER[684]	// Внутренняя переменная var86
#define idvar86	30013	// Внутренняя переменная var86
#define var90	BUFFER[686]	// Внутренняя переменная var90
#define idvar90	30014	// Внутренняя переменная var90
#define var112	BUFFER[688]	// Внутренняя переменная var112
#define idvar112	30015	// Внутренняя переменная var112
#define var54	BUFFER[690]	// Внутренняя переменная var54
#define idvar54	30016	// Внутренняя переменная var54
#define var62	BUFFER[692]	// Внутренняя переменная var62
#define idvar62	30017	// Внутренняя переменная var62
#define var98	BUFFER[694]	// Внутренняя переменная var98
#define idvar98	30018	// Внутренняя переменная var98
#define var15	BUFFER[696]	// Внутренняя переменная var15
#define idvar15	30019	// Внутренняя переменная var15
#define var33	BUFFER[698]	// Внутренняя переменная var33
#define idvar33	30020	// Внутренняя переменная var33
#define var131	BUFFER[701]	// Внутренняя переменная var131
#define idvar131	30021	// Внутренняя переменная var131
#define vainSInt	BUFFER[703]	// Внутренняя переменная vainSInt
#define idvainSInt	30022	// Внутренняя переменная vainSInt
#define vainSChar	BUFFER[706]	// Внутренняя переменная vainSChar
#define idvainSChar	30023	// Внутренняя переменная vainSChar
#define var104	BUFFER[709]	// Внутренняя переменная var104
#define idvar104	30024	// Внутренняя переменная var104
#define var17	BUFFER[714]	// Внутренняя переменная var17
#define idvar17	30025	// Внутренняя переменная var17
#define var27	BUFFER[716]	// Внутренняя переменная var27
#define idvar27	30026	// Внутренняя переменная var27
#define var87	BUFFER[718]	// Внутренняя переменная var87
#define idvar87	30027	// Внутренняя переменная var87
#define var88	BUFFER[720]	// Внутренняя переменная var88
#define idvar88	30028	// Внутренняя переменная var88
#define var94	BUFFER[722]	// Внутренняя переменная var94
#define idvar94	30029	// Внутренняя переменная var94
#define var38	BUFFER[724]	// Внутренняя переменная var38
#define idvar38	30030	// Внутренняя переменная var38
#define var58	BUFFER[726]	// Внутренняя переменная var58
#define idvar58	30031	// Внутренняя переменная var58
#define var66	BUFFER[728]	// Внутренняя переменная var66
#define idvar66	30032	// Внутренняя переменная var66
#define var108	BUFFER[730]	// Внутренняя переменная var108
#define idvar108	30033	// Внутренняя переменная var108
#define var11	BUFFER[735]	// Внутренняя переменная var11
#define idvar11	30034	// Внутренняя переменная var11
#define var49	BUFFER[737]	// Внутренняя переменная var49
#define idvar49	30035	// Внутренняя переменная var49
#define var93	BUFFER[739]	// Внутренняя переменная var93
#define idvar93	30036	// Внутренняя переменная var93
#define var7	BUFFER[741]	// Внутренняя переменная var7
#define idvar7	30037	// Внутренняя переменная var7
#define var28	BUFFER[743]	// Внутренняя переменная var28
#define idvar28	30038	// Внутренняя переменная var28
#define var65	BUFFER[745]	// Внутренняя переменная var65
#define idvar65	30039	// Внутренняя переменная var65
#define var72	BUFFER[747]	// Внутренняя переменная var72
#define idvar72	30040	// Внутренняя переменная var72
#define var133	BUFFER[749]	// Внутренняя переменная var133
#define idvar133	30041	// Внутренняя переменная var133
#define var144	BUFFER[752]	// Внутренняя переменная var144
#define idvar144	30042	// Внутренняя переменная var144
#define var41	BUFFER[754]	// Внутренняя переменная var41
#define idvar41	30043	// Внутренняя переменная var41
#define var70	BUFFER[756]	// Внутренняя переменная var70
#define idvar70	30044	// Внутренняя переменная var70
#define var84	BUFFER[758]	// Внутренняя переменная var84
#define idvar84	30045	// Внутренняя переменная var84
#define var121	BUFFER[760]	// Внутренняя переменная var121
#define idvar121	30046	// Внутренняя переменная var121
#define var127	BUFFER[762]	// Внутренняя переменная var127
#define idvar127	30047	// Внутренняя переменная var127
#define var13	BUFFER[767]	// Внутренняя переменная var13
#define idvar13	30048	// Внутренняя переменная var13
#define var22	BUFFER[769]	// Внутренняя переменная var22
#define idvar22	30049	// Внутренняя переменная var22
#define var46	BUFFER[771]	// Внутренняя переменная var46
#define idvar46	30050	// Внутренняя переменная var46
#define var78	BUFFER[773]	// Внутренняя переменная var78
#define idvar78	30051	// Внутренняя переменная var78
#define var92	BUFFER[775]	// Внутренняя переменная var92
#define idvar92	30052	// Внутренняя переменная var92
#define var109	BUFFER[777]	// Внутренняя переменная var109
#define idvar109	30053	// Внутренняя переменная var109
#define var80	BUFFER[779]	// Внутренняя переменная var80
#define idvar80	30054	// Внутренняя переменная var80
#define var103	BUFFER[781]	// Внутренняя переменная var103
#define idvar103	30055	// Внутренняя переменная var103
#define var8	BUFFER[783]	// Внутренняя переменная var8
#define idvar8	30056	// Внутренняя переменная var8
#define var9	BUFFER[785]	// Внутренняя переменная var9
#define idvar9	30057	// Внутренняя переменная var9
#define var35	BUFFER[787]	// Внутренняя переменная var35
#define idvar35	30058	// Внутренняя переменная var35
#define var45	BUFFER[789]	// Внутренняя переменная var45
#define idvar45	30059	// Внутренняя переменная var45
#define var60	BUFFER[791]	// Внутренняя переменная var60
#define idvar60	30060	// Внутренняя переменная var60
#define var126	BUFFER[793]	// Внутренняя переменная var126
#define idvar126	30061	// Внутренняя переменная var126
#define var36	BUFFER[795]	// Внутренняя переменная var36
#define idvar36	30062	// Внутренняя переменная var36
#define var37	BUFFER[797]	// Внутренняя переменная var37
#define idvar37	30063	// Внутренняя переменная var37
#define var77	BUFFER[799]	// Внутренняя переменная var77
#define idvar77	30064	// Внутренняя переменная var77
#define var91	BUFFER[801]	// Внутренняя переменная var91
#define idvar91	30065	// Внутренняя переменная var91
#define var105	BUFFER[803]	// Внутренняя переменная var105
#define idvar105	30066	// Внутренняя переменная var105
#define var18	BUFFER[808]	// Внутренняя переменная var18
#define idvar18	30067	// Внутренняя переменная var18
#define var19	BUFFER[810]	// Внутренняя переменная var19
#define idvar19	30068	// Внутренняя переменная var19
#define var122	BUFFER[812]	// Внутренняя переменная var122
#define idvar122	30069	// Внутренняя переменная var122
#define var99	BUFFER[814]	// Внутренняя переменная var99
#define idvar99	30070	// Внутренняя переменная var99
#define vainSFloat	BUFFER[816]	// Внутренняя переменная vainSFloat
#define idvainSFloat	30071	// Внутренняя переменная vainSFloat
#define var26	BUFFER[821]	// Внутренняя переменная var26
#define idvar26	30072	// Внутренняя переменная var26
#define var31	BUFFER[823]	// Внутренняя переменная var31
#define idvar31	30073	// Внутренняя переменная var31
#define var48	BUFFER[825]	// Внутренняя переменная var48
#define idvar48	30074	// Внутренняя переменная var48
#define var55	BUFFER[827]	// Внутренняя переменная var55
#define idvar55	30075	// Внутренняя переменная var55
#define var61	BUFFER[829]	// Внутренняя переменная var61
#define idvar61	30076	// Внутренняя переменная var61
#define var59	BUFFER[831]	// Внутренняя переменная var59
#define idvar59	30077	// Внутренняя переменная var59
#define var100	BUFFER[833]	// Внутренняя переменная var100
#define idvar100	30078	// Внутренняя переменная var100
#define var113	BUFFER[835]	// Внутренняя переменная var113
#define idvar113	30079	// Внутренняя переменная var113
#define var140	BUFFER[837]	// Внутренняя переменная var140
#define idvar140	30080	// Внутренняя переменная var140
#define vainSBool	BUFFER[839]	// Внутренняя переменная vainSBool
#define idvainSBool	30081	// Внутренняя переменная vainSBool
#define var143	BUFFER[841]	// Внутренняя переменная var143
#define idvar143	30082	// Внутренняя переменная var143
#define var20	BUFFER[843]	// Внутренняя переменная var20
#define idvar20	30083	// Внутренняя переменная var20
#define var51	BUFFER[845]	// Внутренняя переменная var51
#define idvar51	30084	// Внутренняя переменная var51
#define var53	BUFFER[847]	// Внутренняя переменная var53
#define idvar53	30085	// Внутренняя переменная var53
#define var69	BUFFER[849]	// Внутренняя переменная var69
#define idvar69	30086	// Внутренняя переменная var69
#define var114	BUFFER[851]	// Внутренняя переменная var114
#define idvar114	30087	// Внутренняя переменная var114
#define var44	BUFFER[853]	// Внутренняя переменная var44
#define idvar44	30088	// Внутренняя переменная var44
#define var81	BUFFER[855]	// Внутренняя переменная var81
#define idvar81	30089	// Внутренняя переменная var81
#define var40	BUFFER[857]	// Внутренняя переменная var40
#define idvar40	30090	// Внутренняя переменная var40
#define var64	BUFFER[859]	// Внутренняя переменная var64
#define idvar64	30091	// Внутренняя переменная var64
#define var67	BUFFER[861]	// Внутренняя переменная var67
#define idvar67	30092	// Внутренняя переменная var67
#define var137	BUFFER[863]	// Внутренняя переменная var137
#define idvar137	30093	// Внутренняя переменная var137
#define var6	BUFFER[865]	// Внутренняя переменная var6
#define idvar6	30094	// Внутренняя переменная var6
#define var34	BUFFER[867]	// Внутренняя переменная var34
#define idvar34	30095	// Внутренняя переменная var34
#define var76	BUFFER[869]	// Внутренняя переменная var76
#define idvar76	30096	// Внутренняя переменная var76
#define var97	BUFFER[871]	// Внутренняя переменная var97
#define idvar97	30097	// Внутренняя переменная var97
#define var25	BUFFER[873]	// Внутренняя переменная var25
#define idvar25	30098	// Внутренняя переменная var25
#define var119	BUFFER[875]	// Внутренняя переменная var119
#define idvar119	30099	// Внутренняя переменная var119
#define var145	BUFFER[877]	// Внутренняя переменная var145
#define idvar145	30100	// Внутренняя переменная var145
#define var16	BUFFER[879]	// Внутренняя переменная var16
#define idvar16	30101	// Внутренняя переменная var16
#define var24	BUFFER[881]	// Внутренняя переменная var24
#define idvar24	30102	// Внутренняя переменная var24
#define var85	BUFFER[883]	// Внутренняя переменная var85
#define idvar85	30103	// Внутренняя переменная var85
#define var134	BUFFER[885]	// Внутренняя переменная var134
#define idvar134	30104	// Внутренняя переменная var134
#define var142	BUFFER[887]	// Внутренняя переменная var142
#define idvar142	30105	// Внутренняя переменная var142
#define var56	BUFFER[889]	// Внутренняя переменная var56
#define idvar56	30106	// Внутренняя переменная var56
#define var71	BUFFER[891]	// Внутренняя переменная var71
#define idvar71	30107	// Внутренняя переменная var71
#define var115	BUFFER[893]	// Внутренняя переменная var115
#define idvar115	30108	// Внутренняя переменная var115
#define var12	BUFFER[898]	// Внутренняя переменная var12
#define idvar12	30109	// Внутренняя переменная var12
#define var29	BUFFER[900]	// Внутренняя переменная var29
#define idvar29	30110	// Внутренняя переменная var29
#define var30	BUFFER[902]	// Внутренняя переменная var30
#define idvar30	30111	// Внутренняя переменная var30
#define var42	BUFFER[904]	// Внутренняя переменная var42
#define idvar42	30112	// Внутренняя переменная var42
#define var50	BUFFER[906]	// Внутренняя переменная var50
#define idvar50	30113	// Внутренняя переменная var50
#define var135	BUFFER[908]	// Внутренняя переменная var135
#define idvar135	30114	// Внутренняя переменная var135
#define var139	BUFFER[911]	// Внутренняя переменная var139
#define idvar139	30115	// Внутренняя переменная var139
#define vainSLong	BUFFER[913]	// Внутренняя переменная vainSLong
#define idvainSLong	30116	// Внутренняя переменная vainSLong
#define var21	BUFFER[922]	// Внутренняя переменная var21
#define idvar21	30117	// Внутренняя переменная var21
#define var82	BUFFER[924]	// Внутренняя переменная var82
#define idvar82	30118	// Внутренняя переменная var82
#define var110	BUFFER[926]	// Внутренняя переменная var110
#define idvar110	30119	// Внутренняя переменная var110
#define var120	BUFFER[928]	// Внутренняя переменная var120
#define idvar120	30120	// Внутренняя переменная var120
#define var39	BUFFER[930]	// Внутренняя переменная var39
#define idvar39	30121	// Внутренняя переменная var39
#define var116	BUFFER[932]	// Внутренняя переменная var116
#define idvar116	30122	// Внутренняя переменная var116
#define var117	BUFFER[941]	// Внутренняя переменная var117
#define idvar117	30123	// Внутренняя переменная var117
#define var123	BUFFER[950]	// Внутренняя переменная var123
#define idvar123	30124	// Внутренняя переменная var123
#define var10	BUFFER[952]	// Внутренняя переменная var10
#define idvar10	30125	// Внутренняя переменная var10
#define var95	BUFFER[954]	// Внутренняя переменная var95
#define idvar95	30126	// Внутренняя переменная var95
#define var89	BUFFER[956]	// Внутренняя переменная var89
#define idvar89	30127	// Внутренняя переменная var89
#define var111	BUFFER[958]	// Внутренняя переменная var111
#define idvar111	30128	// Внутренняя переменная var111
#define var118	BUFFER[960]	// Внутренняя переменная var118
#define idvar118	30129	// Внутренняя переменная var118
#define var141	BUFFER[962]	// Внутренняя переменная var141
#define idvar141	30130	// Внутренняя переменная var141
#define var2	BUFFER[964]	// Внутренняя переменная var2
#define idvar2	30131	// Внутренняя переменная var2
#define var83	BUFFER[966]	// Внутренняя переменная var83
#define idvar83	30132	// Внутренняя переменная var83
#define var101	BUFFER[968]	// Внутренняя переменная var101
#define idvar101	30133	// Внутренняя переменная var101
#define var130	BUFFER[970]	// Внутренняя переменная var130
#define idvar130	30134	// Внутренняя переменная var130
#define var136	BUFFER[975]	// Внутренняя переменная var136
#define idvar136	30135	// Внутренняя переменная var136
#define var43	BUFFER[977]	// Внутренняя переменная var43
#define idvar43	30136	// Внутренняя переменная var43
#define var73	BUFFER[979]	// Внутренняя переменная var73
#define idvar73	30137	// Внутренняя переменная var73
#define var107	BUFFER[981]	// Внутренняя переменная var107
#define idvar107	30138	// Внутренняя переменная var107
#define var125	BUFFER[986]	// Внутренняя переменная var125
#define idvar125	30139	// Внутренняя переменная var125
#define var63	BUFFER[988]	// Внутренняя переменная var63
#define idvar63	30140	// Внутренняя переменная var63
#define var68	BUFFER[990]	// Внутренняя переменная var68
#define idvar68	30141	// Внутренняя переменная var68
#define var132	BUFFER[992]	// Внутренняя переменная var132
#define idvar132	30142	// Внутренняя переменная var132
#define var124	BUFFER[994]	// Внутренняя переменная var124
#define idvar124	30143	// Внутренняя переменная var124
#define var129	BUFFER[996]	// Внутренняя переменная var129
#define idvar129	30144	// Внутренняя переменная var129
#define var5	BUFFER[998]	// Внутренняя переменная var5
#define idvar5	30145	// Внутренняя переменная var5
#define var47	BUFFER[1000]	// Внутренняя переменная var47
#define idvar47	30146	// Внутренняя переменная var47
#define var74	BUFFER[1002]	// Внутренняя переменная var74
#define idvar74	30147	// Внутренняя переменная var74
#define var75	BUFFER[1004]	// Внутренняя переменная var75
#define idvar75	30148	// Внутренняя переменная var75
#define var79	BUFFER[1006]	// Внутренняя переменная var79
#define idvar79	30149	// Внутренняя переменная var79
#pragma pack(push,1)
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	 ...
	 30000	,1	,1	,&var3},	//Внутренняя переменная var3
	 30001	,1	,1	,&var23},	//Внутренняя переменная var23
	 30002	,1	,1	,&var96},	//Внутренняя переменная var96
	 30003	,1	,1	,&var138},	//Внутренняя переменная var138
	 30004	,1	,1	,&var106},	//Внутренняя переменная var106
	 30005	,1	,1	,&var4},	//Внутренняя переменная var4
	 30006	,1	,1	,&var14},	//Внутренняя переменная var14
	 30007	,1	,1	,&var52},	//Внутренняя переменная var52
	 30008	,1	,1	,&var57},	//Внутренняя переменная var57
	 30009	,1	,1	,&var102},	//Внутренняя переменная var102
	 30010	,1	,1	,&var128},	//Внутренняя переменная var128
	 30011	,1	,1	,&var1},	//Внутренняя переменная var1
	 30012	,1	,1	,&var32},	//Внутренняя переменная var32
	 30013	,1	,1	,&var86},	//Внутренняя переменная var86
	 30014	,1	,1	,&var90},	//Внутренняя переменная var90
	 30015	,1	,1	,&var112},	//Внутренняя переменная var112
	 30016	,1	,1	,&var54},	//Внутренняя переменная var54
	 30017	,1	,1	,&var62},	//Внутренняя переменная var62
	 30018	,1	,1	,&var98},	//Внутренняя переменная var98
	 30019	,1	,1	,&var15},	//Внутренняя переменная var15
	 30020	,3	,1	,&var33},	//Внутренняя переменная var33
	 30021	,1	,1	,&var131},	//Внутренняя переменная var131
	 30022	,3	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	 30023	,	,1	,&vainSChar},	//Внутренняя переменная vainSChar
	 30024	,8	,1	,&var104},	//Внутренняя переменная var104
	 30025	,1	,1	,&var17},	//Внутренняя переменная var17
	 30026	,1	,1	,&var27},	//Внутренняя переменная var27
	 30027	,1	,1	,&var87},	//Внутренняя переменная var87
	 30028	,1	,1	,&var88},	//Внутренняя переменная var88
	 30029	,1	,1	,&var94},	//Внутренняя переменная var94
	 30030	,1	,1	,&var38},	//Внутренняя переменная var38
	 30031	,1	,1	,&var58},	//Внутренняя переменная var58
	 30032	,1	,1	,&var66},	//Внутренняя переменная var66
	 30033	,8	,1	,&var108},	//Внутренняя переменная var108
	 30034	,1	,1	,&var11},	//Внутренняя переменная var11
	 30035	,1	,1	,&var49},	//Внутренняя переменная var49
	 30036	,1	,1	,&var93},	//Внутренняя переменная var93
	 30037	,1	,1	,&var7},	//Внутренняя переменная var7
	 30038	,1	,1	,&var28},	//Внутренняя переменная var28
	 30039	,1	,1	,&var65},	//Внутренняя переменная var65
	 30040	,1	,1	,&var72},	//Внутренняя переменная var72
	 30041	,	,1	,&var133},	//Внутренняя переменная var133
	 30042	,1	,1	,&var144},	//Внутренняя переменная var144
	 30043	,1	,1	,&var41},	//Внутренняя переменная var41
	 30044	,1	,1	,&var70},	//Внутренняя переменная var70
	 30045	,1	,1	,&var84},	//Внутренняя переменная var84
	 30046	,1	,1	,&var121},	//Внутренняя переменная var121
	 30047	,8	,1	,&var127},	//Внутренняя переменная var127
	 30048	,1	,1	,&var13},	//Внутренняя переменная var13
	 30049	,1	,1	,&var22},	//Внутренняя переменная var22
	 30050	,1	,1	,&var46},	//Внутренняя переменная var46
	 30051	,1	,1	,&var78},	//Внутренняя переменная var78
	 30052	,1	,1	,&var92},	//Внутренняя переменная var92
	 30053	,1	,1	,&var109},	//Внутренняя переменная var109
	 30054	,1	,1	,&var80},	//Внутренняя переменная var80
	 30055	,1	,1	,&var103},	//Внутренняя переменная var103
	 30056	,1	,1	,&var8},	//Внутренняя переменная var8
	 30057	,1	,1	,&var9},	//Внутренняя переменная var9
	 30058	,1	,1	,&var35},	//Внутренняя переменная var35
	 30059	,1	,1	,&var45},	//Внутренняя переменная var45
	 30060	,1	,1	,&var60},	//Внутренняя переменная var60
	 30061	,1	,1	,&var126},	//Внутренняя переменная var126
	 30062	,1	,1	,&var36},	//Внутренняя переменная var36
	 30063	,1	,1	,&var37},	//Внутренняя переменная var37
	 30064	,1	,1	,&var77},	//Внутренняя переменная var77
	 30065	,1	,1	,&var91},	//Внутренняя переменная var91
	 30066	,8	,1	,&var105},	//Внутренняя переменная var105
	 30067	,1	,1	,&var18},	//Внутренняя переменная var18
	 30068	,1	,1	,&var19},	//Внутренняя переменная var19
	 30069	,1	,1	,&var122},	//Внутренняя переменная var122
	 30070	,1	,1	,&var99},	//Внутренняя переменная var99
	 30071	,8	,1	,&vainSFloat},	//Внутренняя переменная vainSFloat
	 30072	,1	,1	,&var26},	//Внутренняя переменная var26
	 30073	,1	,1	,&var31},	//Внутренняя переменная var31
	 30074	,1	,1	,&var48},	//Внутренняя переменная var48
	 30075	,1	,1	,&var55},	//Внутренняя переменная var55
	 30076	,1	,1	,&var61},	//Внутренняя переменная var61
	 30077	,1	,1	,&var59},	//Внутренняя переменная var59
	 30078	,1	,1	,&var100},	//Внутренняя переменная var100
	 30079	,1	,1	,&var113},	//Внутренняя переменная var113
	 30080	,1	,1	,&var140},	//Внутренняя переменная var140
	 30081	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	 30082	,1	,1	,&var143},	//Внутренняя переменная var143
	 30083	,1	,1	,&var20},	//Внутренняя переменная var20
	 30084	,1	,1	,&var51},	//Внутренняя переменная var51
	 30085	,1	,1	,&var53},	//Внутренняя переменная var53
	 30086	,1	,1	,&var69},	//Внутренняя переменная var69
	 30087	,1	,1	,&var114},	//Внутренняя переменная var114
	 30088	,1	,1	,&var44},	//Внутренняя переменная var44
	 30089	,1	,1	,&var81},	//Внутренняя переменная var81
	 30090	,1	,1	,&var40},	//Внутренняя переменная var40
	 30091	,1	,1	,&var64},	//Внутренняя переменная var64
	 30092	,1	,1	,&var67},	//Внутренняя переменная var67
	 30093	,1	,1	,&var137},	//Внутренняя переменная var137
	 30094	,1	,1	,&var6},	//Внутренняя переменная var6
	 30095	,1	,1	,&var34},	//Внутренняя переменная var34
	 30096	,1	,1	,&var76},	//Внутренняя переменная var76
	 30097	,1	,1	,&var97},	//Внутренняя переменная var97
	 30098	,1	,1	,&var25},	//Внутренняя переменная var25
	 30099	,1	,1	,&var119},	//Внутренняя переменная var119
	 30100	,1	,1	,&var145},	//Внутренняя переменная var145
	 30101	,1	,1	,&var16},	//Внутренняя переменная var16
	 30102	,1	,1	,&var24},	//Внутренняя переменная var24
	 30103	,1	,1	,&var85},	//Внутренняя переменная var85
	 30104	,1	,1	,&var134},	//Внутренняя переменная var134
	 30105	,1	,1	,&var142},	//Внутренняя переменная var142
	 30106	,1	,1	,&var56},	//Внутренняя переменная var56
	 30107	,1	,1	,&var71},	//Внутренняя переменная var71
	 30108	,8	,1	,&var115},	//Внутренняя переменная var115
	 30109	,1	,1	,&var12},	//Внутренняя переменная var12
	 30110	,1	,1	,&var29},	//Внутренняя переменная var29
	 30111	,1	,1	,&var30},	//Внутренняя переменная var30
	 30112	,1	,1	,&var42},	//Внутренняя переменная var42
	 30113	,1	,1	,&var50},	//Внутренняя переменная var50
	 30114	,	,1	,&var135},	//Внутренняя переменная var135
	 30115	,1	,1	,&var139},	//Внутренняя переменная var139
	 30116	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	 30117	,1	,1	,&var21},	//Внутренняя переменная var21
	 30118	,1	,1	,&var82},	//Внутренняя переменная var82
	 30119	,1	,1	,&var110},	//Внутренняя переменная var110
	 30120	,1	,1	,&var120},	//Внутренняя переменная var120
	 30121	,1	,1	,&var39},	//Внутренняя переменная var39
	 30122	,11	,1	,&var116},	//Внутренняя переменная var116
	 30123	,11	,1	,&var117},	//Внутренняя переменная var117
	 30124	,1	,1	,&var123},	//Внутренняя переменная var123
	 30125	,1	,1	,&var10},	//Внутренняя переменная var10
	 30126	,1	,1	,&var95},	//Внутренняя переменная var95
	 30127	,1	,1	,&var89},	//Внутренняя переменная var89
	 30128	,1	,1	,&var111},	//Внутренняя переменная var111
	 30129	,1	,1	,&var118},	//Внутренняя переменная var118
	 30130	,1	,1	,&var141},	//Внутренняя переменная var141
	 30131	,1	,1	,&var2},	//Внутренняя переменная var2
	 30132	,1	,1	,&var83},	//Внутренняя переменная var83
	 30133	,1	,1	,&var101},	//Внутренняя переменная var101
	 30134	,8	,1	,&var130},	//Внутренняя переменная var130
	 30135	,1	,1	,&var136},	//Внутренняя переменная var136
	 30136	,1	,1	,&var43},	//Внутренняя переменная var43
	 30137	,1	,1	,&var73},	//Внутренняя переменная var73
	 30138	,8	,1	,&var107},	//Внутренняя переменная var107
	 30139	,1	,1	,&var125},	//Внутренняя переменная var125
	 30140	,1	,1	,&var63},	//Внутренняя переменная var63
	 30141	,1	,1	,&var68},	//Внутренняя переменная var68
	 30142	,1	,1	,&var132},	//Внутренняя переменная var132
	 30143	,1	,1	,&var124},	//Внутренняя переменная var124
	 30144	,1	,1	,&var129},	//Внутренняя переменная var129
	 30145	,1	,1	,&var5},	//Внутренняя переменная var5
	 30146	,1	,1	,&var47},	//Внутренняя переменная var47
	 30147	,1	,1	,&var74},	//Внутренняя переменная var74
	 30148	,1	,1	,&var75},	//Внутренняя переменная var75
	 30149	,1	,1	,&var79},	//Внутренняя переменная var79
	{-1,0,NULL},
}
...
static ModbusRegister coil_Baz2[]={
	{&A0EE05LZ2,2,4},	//( - , Baz2) Исправность сети АКНП1
	{&A0EE08LZ2,2,1},	//( - , Baz2) Исправность сети АКНП4
	{&A0EE07LZ2,2,2},	//( - , Baz2) Исправность сети АКНП3
	{&R0MD34LP1,2,0},	//( - , Baz2) Кнопка Квитировать
	{&R7II73LZ2,2,7},	//( - K07VDSR, Baz2) Сработала АС II УР РАД
	{&R7II71LZ2,2,6},	//( - K05VDSR, Baz2) Сработала АС IУР РАД (датчик 1)
	{&A0EE06LZ2,2,3},	//( - , Baz2) Исправность сети АКНП2
	{&R7II72LZ2,2,5},	//( - K06VDSR, Baz2) Сработала АС IУР РАД  (датчик 2)
	{&R0EE02LDU,2,8},	//( - , Baz2) Питание  АКНП  отключить
	{NULL,0,0},
}
#pragma pop
#pragma pack(push,1)
static ModbusRegister di_Baz2[]={
	{&A0EE04LZ2,2,13},	//( - , Baz2, SBz2DU) Исправность АКНП4
	{&A0VN81LZ2,2,4},	//( - , Baz2) АЗ по АС периода разгона АЗ1
	{&A0VT71LZ2,2,43},	//( - , Baz2, SBz2DU) АС по температуре в АЗ1
	{&R0ET02LZ2,2,31},	//( - , Baz2) Признак наличия неисправности по температуре АЗ2
	{&R0VN64LZ2,2,55},	//( - , Baz2) ПС по мощности канал 4
	{&B0VN81LZ2,2,3},	//( - , Baz2) АЗ по АС периода разгона АЗ2
	{&R0VN77LZ2,2,22},	//( - K02VDSR, Baz2) АС по периоду разгона канал  3
	{&B0VP41LZ2,2,32},	//( - , Baz2) Давление АЗ2 ниже АС
	{&B1VP41LZ2,2,41},	//( - , Baz2, SBz2DU) Давление СБРОС ББ2 ниже АС
	{&R0VN80LZ2,2,46},	//( - , Baz2) АЗ по АС периода разгона РУ
	{&A3VZ11LZ2,2,17},	//( - , Baz2) АЗ от НУП ИС1
	{&A0VT61LZ2,2,44},	//( - , Baz2) ПС по температуре в АЗ1
	{&R0VZ71LZ2,2,48},	//( - K05FDSR, Baz2) Обобщенный сигнал АЗ 2 канала
	{&B3VZ11LZ2,2,16},	//( - , Baz2) АЗ от НУП ИС2
	{&A0VZ71LZ2,2,10},	//( - , Baz2) Обобщенный сигнал АС по АЗ1
	{&A0EE02LZ2,2,12},	//( - , Baz2, SBz2DU) Исправность АКНП2
	{&R0VN78LZ2,2,21},	//( - K02VDSR, Baz2) АС по периоду разгона канал  4
	{&A2VP41LZ2,2,40},	//( - , Baz2) Давление СБРОС РБ1 ниже АС
	{&R0VN69LZ2,2,50},	//( - , Baz2) ПС по усредненному периоду
	{&A0VN71LZ2,2,6},	//( - , Baz2, SBz2DU) АЗ по АС мощности  АЗ1
	{&R0VN75LZ2,2,27},	//( - K02VDSR, Baz2) АС по периоду разгона канал 1
	{&R0VN62LZ2,2,57},	//( - , Baz2) ПС по мощности канал 2
	{&B0VT71LZ2,2,0},	//( - , Baz2, SBz2DU) АС по температуре в АЗ2
	{&A3VZ15LZ2,2,15},	//( - K02FDSR, Baz2) Имитация АЗ от НУП ИС
	{&B2VP81LZ2,2,36},	//( - , Baz2) Давление СБРОС РБ2 в норме
	{&R0VN70LZ2,2,47},	//( - , Baz2) АЗ по АС мощности РУ
	{&R0VN73LZ2,2,24},	//( - K01VDSR, Baz2) АС по мощности канал 3
	{&A3VZ31LZ2,2,19},	//( - , Baz2) АЗ от ВУ ИС1
	{&R0VN74LZ2,2,23},	//( - K01VDSR, Baz2) АС по мощности канал 4
	{&B0VP71LZ2,2,29},	//( - , Baz2, SBz2DU) АЗ по АС любого давления для АЗ2
	{&A0VP71LZ2,2,30},	//( - , Baz2, SBz2DU) АЗ по АС любого давления для АЗ1
	{&TestDiagnBaz2,2,20},	//( - , Baz2) Неисправность от
	{&R0VN72LZ2,2,26},	//( - K01VDSR, Baz2) АС по мощности канал 2
	{&R0VN65LZ2,2,54},	//( - , Baz2) ПС по периоду разгона канал 1
	{&B0EE00LZ2,2,8},	//( - , Baz2) Исправность АКНП АЗ2
	{&A0EE01LZ2,2,45},	//( - , Baz2, SBz2DU) Исправность АКНП1
	{&R0VN79LZ2,2,49},	//( - , Baz2) АС по усредненному периоду
	{&B0VZ71LZ2,2,7},	//( - , Baz2) Обобщенный сигнал АС по АЗ2
	{&B0VT61LZ2,2,1},	//( - , Baz2) ПС по температуре в АЗ2
	{&A0EE03LZ2,2,11},	//( - , Baz2, SBz2DU) Исправность АКНП3
	{&A0VP41LZ2,2,33},	//( - , Baz2) Давление АЗ1 ниже АС
	{&R0ET01LZ2,2,34},	//( - , Baz2) Признак наличия неисправности по температуре  АЗ1
	{&A3VZ13LZ2,2,14},	//( - K01FDSR, Baz2) Имитация АЗ от ВУ ИС
	{&A1VP41LZ2,2,42},	//( - , Baz2, SBz2DU) Давление СБРОС ББ1 ниже АС
	{&R0VN63LZ2,2,56},	//( - , Baz2) ПС по мощности канал 3
	{&A0EE00LZ2,2,9},	//( - , Baz2) Исправность АКНП АЗ1
	{&A2VP51LZ2,2,39},	//( - , Baz2) Давление СБРОС РБ1 ниже ПС
	{&R0VN76LZ2,2,25},	//( - K02VDSR, Baz2) АС по периоду разгона канал  2
	{&B2VP51LZ2,2,37},	//( - , Baz2) Давление СБРОС РБ2 ниже ПС
	{&R0VP73LZ2,2,2},	//( - , Baz2, SBz2DU) ПС давления для РУ
	{&R0VN66LZ2,2,53},	//( - , Baz2) ПС по периоду разгона канал 2
	{&B2VP41LZ2,2,38},	//( - , Baz2) Давление СБРОС РБ2 ниже АС
	{&R0VN68LZ2,2,51},	//( - , Baz2) ПС по периоду разгона канал 4
	{&B3VZ31LZ2,2,18},	//( - , Baz2) АЗ от ВУ ИС2
	{&R0VN71LZ2,2,28},	//( - K01VDSR, Baz2) АС по мощности канал 1
	{&A2VP81LZ2,2,35},	//( - , Baz2) Давление СБРОС РБ1 в норме
	{&B0VN71LZ2,2,5},	//( - , Baz2, SBz2DU) АЗ по АС мощности  АЗ2
	{&R0VN67LZ2,2,52},	//( - , Baz2) ПС по периоду разгона канал 3
	{&R0VN61LZ2,2,58},	//( - , Baz2) ПС по мощности канал 1
	{NULL,0,0},
}
#pragma pop
#pragma pack(push,1)
...
static ModbusRegister di_DiagnBaz2[]={
	{&R0DEB4LZ2,2,3},	//( - S13SBK, DiagnBaz2) диагностика шкафа Баз2 БП24Д место 6
	{&R0DEB1LZ2,2,0},	//( - S10SBK, DiagnBaz2) диагностика шкафа Баз2 БП5 место 5
	{&R0DEB2LZ2,2,1},	//( - S11SBK, DiagnBaz2) диагностика шкафа Баз2 БП24Д место 5
	{&R0DEB3LZ2,2,2},	//( - S12SBK, DiagnBaz2) диагностика шкафа Баз2 БП5 место 6
	{&R0DE3CLZ2,2,4},	//( - , DiagnBaz2) диагностика шкафа Баз2 БП5/24Д место 5
	{&R0DE3DLZ2,2,5},	//( - , DiagnBaz2) диагностика шкафа Баз2 БП5/24Д место 6
	{NULL,0,0},
}
#pragma pop
#pragma pack(push,1)
...
static ModbusDevice modbuses[]={
	{0,5002,&coil_Baz2[0],&di_Baz2[0],&di_Baz2[0],&hr_Baz2[0],NULL,NULL,NULL,0},	//Общий слэйв
	{0,5009,&coil_SBz2DU[0],&di_SBz2DU[0],&di_SBz2DU[0],&hr_SBz2DU[0],NULL,NULL,NULL,0},	//Слэйв для DU
	{0,5005,&coil_DiagnBaz2[0],&di_DiagnBaz2[0],&di_DiagnBaz2[0],&hr_DiagnBaz2[0],NULL,NULL,NULL,0},	//Диагностика Baz2
	{1,5004,&coil_MBz2S[0],&di_MBz2S[0],&di_MBz2S[0],&hr_MBz2S[0],NULL,MBz2S_ip1,MBz2S_ip2,100},	//Мастер Баз2 в SCM
	{1,5019,&coil_MBz2A1[0],&di_MBz2A1[0],&di_MBz2A1[0],&hr_MBz2A1[0],NULL,MBz2A1_ip1,MBz2A1_ip2,20},	//Мастер Баз2 в AKNP1
	{1,5020,&coil_MBz2A2[0],&di_MBz2A2[0],&di_MBz2A2[0],&hr_MBz2A2[0],NULL,MBz2A2_ip1,MBz2A2_ip2,20},	//Мастер Баз2 в AKNP2
	{1,5021,&coil_MBz2A3[0],&di_MBz2A3[0],&di_MBz2A3[0],&hr_MBz2A3[0],NULL,MBz2A3_ip1,MBz2A3_ip2,20},	//Мастер Баз2 в AKNP3
	{1,5022,&coil_MBz2A4[0],&di_MBz2A4[0],&di_MBz2A4[0],&hr_MBz2A4[0],NULL,MBz2A4_ip1,MBz2A4_ip2,20},	//Мастер Баз2 в AKNP4
...
#pragma pop
#include <fp8/drivers/vas84r.h>/nstatic char buf_VAS84[30];	//VAS84
...
#pragma pop
#include <fp8/drivers/vds32r.h>/nstatic char buf_VDS321[132];	//VDS321
...
#pragma pop
#include <fp8/drivers/vds32r.h>/nstatic char buf_VDS322[132];	//VDS322
...
#pragma pop
#include <fp8/drivers/vds32r.h>/nstatic char buf_VDS323[132];	//VDS323
...
#pragma pop
#include <fp8/drivers/vds32r.h>/nstatic char buf_VDS324[132];	//VDS324
...
static Drive drivers[]={
	{0x96,0x0a,40,def_buf_FDS16,&table_FDS16},	//FDS16
	{0xcc,0x20,26,def_buf_SBKFP,&table_SBKFP},	//SBKFP
	{0xc6,0x04,30,def_buf_VAS84,&table_VAS84},	//VAS84
	{0xc2,0x05,132,def_buf_VDS321,&table_VDS321},	//VDS32
	{0xc2,0x06,132,def_buf_VDS322,&table_VDS322},	//VDS32
	{0xc2,0x07,132,def_buf_VDS323,&table_VDS323},	//VDS32
	{0xc2,0x08,132,def_buf_VDS324,&table_VDS324},	//VDS32
	{0,0,0,0,NULL,NULL},
};
#pragma pop
...
void MainCycle(void){
	if ((getAsShort(R0S01LZ2) == 2) || (getAsShort(R0S01LZ2) == 3)) {
		if(delay++<200) return;
