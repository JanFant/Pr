...
#define A1VP41LZ2	 BUFFER[292]	//( - , SBz2DU) Давление СБРОС ББ1 ниже АС
#define idA1VP41LZ2	 120	//( - , SBz2DU) Давление СБРОС ББ1 ниже АС
#define B1VP41LZ2	 BUFFER[294]	//( - , SBz2DU) Давление СБРОС ББ2 ниже АС
#define idB1VP41LZ2	 121	//( - , SBz2DU) Давление СБРОС ББ2 ниже АС
...
static VarCtrl allVariables[]={      // Описание всех переменных
	...
	{ 120	,1	,1	, &A1VP41LZ2},	//( - , SBz2DU) Давление СБРОС ББ1 ниже АС
	{ 121	,1	,1	, &B1VP41LZ2},	//( - , SBz2DU) Давление СБРОС ББ2 ниже АС
...
static ModbusRegister di_Baz2[]={  // 
	...
	{&R7II72LZ2,1,26},	//( - K06VDSR, Baz2) Сработала АС IУР РАД (датчик 2)
	{&R7II71LZ2,1,27},	//( - K05VDSR, Baz2) Сработала АС IУР РАД (датчик 1)
	{&R7II73LZ2,1,28},	//( - K07VDSR, Baz2) Сработала АС II УР РАД
	...
	{&B3VZ11LZ2,1,48},	//( - , Baz2) АЗ от НУП ИС2
	{&A3VZ11LZ2,1,49},	//( - , Baz2) АЗ от НУП ИС1
	{&B3VZ31LZ2,1,50},	//( - , Baz2) АЗ от ВУ ИС2
	{&A3VZ31LZ2,1,51},	//( - , Baz2) АЗ от ВУ ИС1
	{&R0VN68LZ2,1,52},	//( - , Baz2) ПС по периоду разгона канал 4
	{&R0VN67LZ2,1,53},	//( - , Baz2) ПС по периоду разгона канал 3
	{&R0VN66LZ2,1,54},	//( - , Baz2) ПС по периоду разгона канал 2
	{&R0VN65LZ2,1,55},	//( - , Baz2) ПС по периоду разгона канал 1
	{&R0VN64LZ2,1,56},	//( - , Baz2) ПС по мощности канал 4
	{&R0VN63LZ2,1,57},	//( - , Baz2) ПС по мощности канал 3
	{&R0VN62LZ2,1,58},	//( - , Baz2) ПС по мощности канал 2
	{&R0VN61LZ2,1,59},	//( - , Baz2) ПС по мощности канал 1
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
static ModbusRegister ir_Baz2[]={  // 
	...
	{&R0VN04RZ2,8,7},	//( - , Baz2) Уровень мощности по каналу 4
	{&R0VN03RZ2,8,9},	//( - , Baz2) Уровень мощности по каналу 3
	{&R0VN02RZ2,8,11},	//( - , Baz2) Уровень мощности по каналу 2
	{&R0VN01RZ2,8,13},	//( - , Baz2) Уровень мощности по каналу 1
	{&A0EP02IZ2,3,15},	//( - , Baz2) Индикатор -Давление  АЗ1 ниже АС
	{&B0EP02IZ2,3,16},	//( - , Baz2) Индикатор -Давление  АЗ2 ниже АС
	{&B2CP01RZ2,8,17},	//( - , Baz2) Текущее давление СБРОС РБ2
	{&A2CP01RZ2,8,19},	//( - , Baz2) Текущее давление СБРОС РБ1
	{&A0CT01IZ2,8,21},	//( - , Baz2, SBz2DU) Температура АЗ1-1
	{&R0VR02RZ2,8,23},	//( - , Baz2) Усредненная реактивность
	{&R0VN09RZ2,8,25},	//( - , Baz2, SBz2DU) Усредненный период разгона
	{&R0VN08RZ2,8,27},	//( - , Baz2) Период разгона по каналу 4
	{&R0VN07RZ2,8,29},	//( - , Baz2) Период разгона по каналу 3
	{&R0VN06RZ2,8,31},	//( - , Baz2) Период разгона по каналу 2
	{&R0VN05RZ2,8,33},	//( - , Baz2) Период разгона по каналу 1
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
