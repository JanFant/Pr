...
#define R0S01LZ2	 BUFFER[126]	//(vds32:08 - K08VDSR, - ) Отключение сетевых передач в Баз2
#define idR0S01LZ2	 59	//(vds32:08 - K08VDSR, - ) Отключение сетевых передач в Баз2
...
static VarCtrl allVariables[]={      // Описание всех переменных
	...
	{ 59	,1	,1	, &R0S01LZ2},	//(vds32:08 - K08VDSR, - ) Отключение сетевых передач в Баз2
