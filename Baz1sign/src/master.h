...
int master = 1;
int nomer = 1;
#define A0IT01IZ1	 BUFFER[0]	//(K01VASR)- Температура АЗ1-1
#define idA0IT01IZ1	 1	//(K01VASR)- Температура АЗ1-1
#define A2IP01IZ1	 BUFFER[3]	//(K02VASR)- Текущее давление СБРОС РБ1
#define idA2IP01IZ1	 2	//(K02VASR)- Текущее давление СБРОС РБ1
#define B0IT01IZ1	 BUFFER[6]	//(K03VASR)- Температура АЗ2-1
#define idB0IT01IZ1	 3	//(K03VASR)- Температура АЗ2-1
#define B2IP01IZ1	 BUFFER[9]	//(K04VASR)- Текущее давление СБРОС РБ2
#define idB2IP01IZ1	 4	//(K04VASR)- Текущее давление СБРОС РБ2
...
#define R0VN71LZ1	 BUFFER[24]	//(s05_K01VDSR)- АС по мощности канал 1
#define idR0VN71LZ1	 9	//(s05_K01VDSR)- АС по мощности канал 1
#define R0VN75LZ1	 BUFFER[26]	//(s05_K02VDSR)- АС по периоду разгона канал  1
#define idR0VN75LZ1	 10	//(s05_K02VDSR)- АС по периоду разгона канал  1
#define A0EE01LS1	 BUFFER[28]	//(s05_K03VDSR)- Исправность АКНП канал 1 
#define idA0EE01LS1	 11	//(s05_K03VDSR)- Исправность АКНП канал 1 
#define A0VN71LS1	 BUFFER[30]	//(s05_K04VDSR)- Блокировка автоматического подъёма ББ канал 1
#define idA0VN71LS1	 12	//(s05_K04VDSR)- Блокировка автоматического подъёма ББ канал 1
#define A3IS11LZ1	 BUFFER[32]	//(s05_K05VDSR)- Приход на ВУ ИС1
#define idA3IS11LZ1	 13	//(s05_K05VDSR)- Приход на ВУ ИС1
#define A3IS22LZ1	 BUFFER[34]	//(s05_K06VDSR)- Приход на НУП ИС1
#define idA3IS22LZ1	 14	//(s05_K06VDSR)- Приход на НУП ИС1
#define R0AD03LZ1	 BUFFER[36]	//(s05_K07VDSR)- Имитация прихода на ВУ ИС
#define idR0AD03LZ1	 15	//(s05_K07VDSR)- Имитация прихода на ВУ ИС
#define R0AD04LZ1	 BUFFER[38]	//(s05_K08VDSR)- Имитация срабатывания верхней АС II УР
#define idR0AD04LZ1	 16	//(s05_K08VDSR)- Имитация срабатывания верхней АС II УР
#define R0AD05LZ1	 BUFFER[40]	//(s05_K09VDSR)- Имитация ухода с НУП ИС
#define idR0AD05LZ1	 17	//(s05_K09VDSR)- Имитация ухода с НУП ИС
#define A2IS12LZ1	 BUFFER[42]	//(s05_K10VDSR)- Магнит РБ1 зацеплен (для БАЗ1)
#define idA2IS12LZ1	 18	//(s05_K10VDSR)- Магнит РБ1 зацеплен (для БАЗ1)
#define B2IS12LZ1	 BUFFER[44]	//(s05_K11VDSR)- Магнит РБ2 зацеплен (для БАЗ1)
#define idB2IS12LZ1	 19	//(s05_K11VDSR)- Магнит РБ2 зацеплен (для БАЗ1)
...
#define R0VN72LZ1	 BUFFER[88]	//(s06_K01VDSR)- АС по мощности канал 2
#define idR0VN72LZ1	 41	//(s06_K01VDSR)- АС по мощности канал 2
#define R0VN76LZ1	 BUFFER[90]	//(s06_K02VDSR)- АС по периоду разгона канал  2
#define idR0VN76LZ1	 42	//(s06_K02VDSR)- АС по периоду разгона канал  2
#define A0EE01LS2	 BUFFER[92]	//(s06_K03VDSR)- Исправность АКНП  канал 2
#define idA0EE01LS2	 43	//(s06_K03VDSR)- Исправность АКНП  канал 2
#define A0VN71LS2	 BUFFER[94]	//(s06_K04VDSR)- Блокировка автоматического подъёма ББ канал 2
#define idA0VN71LS2	 44	//(s06_K04VDSR)- Блокировка автоматического подъёма ББ канал 2
#define B3IS11LZ1	 BUFFER[96]	//(s06_K05VDSR)- Приход на ВУ ИС2
#define idB3IS11LZ1	 45	//(s06_K05VDSR)- Приход на ВУ ИС2
#define B3IS22LZ1	 BUFFER[98]	//(s06_K06VDSR)- Приход на НУП ИС2
#define idB3IS22LZ1	 46	//(s06_K06VDSR)- Приход на НУП ИС2
...
#define R0VN74LZ1	 BUFFER[152]	//(s07_K01VDSR)- АС по мощности канал 4
#define idR0VN74LZ1	 73	//(s07_K01VDSR)- АС по мощности канал 4
#define R0VN78LZ1	 BUFFER[154]	//(s07_K02VDSR)- АС по периоду разгона канал  4
#define idR0VN78LZ1	 74	//(s07_K02VDSR)- АС по периоду разгона канал  4
#define A0EE01LS4	 BUFFER[156]	//(s07_K03VDSR)- Исправность АКНП канал 4
#define idA0EE01LS4	 75	//(s07_K03VDSR)- Исправность АКНП канал 4
#define A0VN71LS4	 BUFFER[158]	//(s07_K04VDSR)- Блокировка автоматического подъёма ББ канал 4
#define idA0VN71LS4	 76	//(s07_K04VDSR)- Блокировка автоматического подъёма ББ канал 4
#define R6IS66LZ1	 BUFFER[160]	//(s07_K05VDSR)- Исправность ВИП 4,0 (№5) ССДИ-1-1
#define idR6IS66LZ1	 77	//(s07_K05VDSR)- Исправность ВИП 4,0 (№5) ССДИ-1-1
#define R6IS67LZ1	 BUFFER[162]	//(s07_K06VDSR)- Исправность ВИП 4,0 (№6) ССДИ-1-2
#define idR6IS67LZ1	 78	//(s07_K06VDSR)- Исправность ВИП 4,0 (№6) ССДИ-1-2
#define R6IS68LZ1	 BUFFER[164]	//(s07_K07VDSR)- Исправность ВИП 4,0 (№7) ССДИ-2
#define idR6IS68LZ1	 79	//(s07_K07VDSR)- Исправность ВИП 4,0 (№7) ССДИ-2
...
#define R0VN73LZ1	 BUFFER[216]	//(s08_K01VDSR)-АС по мощности канал 3
#define idR0VN73LZ1	 105	//(s08_K01VDSR)-АС по мощности канал 3
#define R0VN77LZ1	 BUFFER[218]	//(s08_K02VDSR)-АС по периоду разгона канал  3
#define idR0VN77LZ1	 106	//(s08_K02VDSR)-АС по периоду разгона канал  3
#define A0EE01LS3	 BUFFER[220]	//(s08_K03VDSR)-Исправность АКНП канал 3
#define idA0EE01LS3	 107	//(s08_K03VDSR)-Исправность АКНП канал 3
#define A0VN71LS3	 BUFFER[222]	//(s08_K04VDSR)-Блокировка автоматического подъёма ББ канал 3
#define idA0VN71LS3	 108	//(s08_K04VDSR)-Блокировка автоматического подъёма ББ канал 3
#define R7II71LZ1	 BUFFER[224]	//(s08_K05VDSR)-Сработала АС IУР РАД (датчик 1)
#define idR7II71LZ1	 109	//(s08_K05VDSR)-Сработала АС IУР РАД (датчик 1)
#define R7II72LZ1	 BUFFER[226]	//(s08_K06VDSR)-Сработала АС IУР РАД  (датчик 2)
#define idR7II72LZ1	 110	//(s08_K06VDSR)-Сработала АС IУР РАД  (датчик 2)
#define R7II73LZ1	 BUFFER[228]	//(s08_K07VDSR)-Сработала АС II УР РАД
#define idR7II73LZ1	 111	//(s08_K07VDSR)-Сработала АС II УР РАД
#define s08_K08VDSR	 BUFFER[230]	//(s08_K08VDSR)-
#define ids08_K08VDSR	 112	//(s08_K08VDSR)-
#define A0VP81LZ1	 BUFFER[232]	//(s08_K09VDSR)-Давление  АЗ1 в норме
#define idA0VP81LZ1	 113	//(s08_K09VDSR)-Давление  АЗ1 в норме
#define A1VP81LZ1	 BUFFER[234]	//(s08_K10VDSR)-Давление СБРОС ББ1 в норме
#define idA1VP81LZ1	 114	//(s08_K10VDSR)-Давление СБРОС ББ1 в норме
#define R0VP81LZ1	 BUFFER[236]	//(s08_K11VDSR)-Давление  в СИСТЕМЕ -1 в норме
#define idR0VP81LZ1	 115	//(s08_K11VDSR)-Давление  в СИСТЕМЕ -1 в норме
#define B0VP81LZ1	 BUFFER[238]	//(s08_K12VDSR)-Давление АЗ2 в норме
#define idB0VP81LZ1	 116	//(s08_K12VDSR)-Давление АЗ2 в норме
#define B1VP81LZ1	 BUFFER[240]	//(s08_K13VDSR)-Давление СБРОС ББ2 в норме
#define idB1VP81LZ1	 117	//(s08_K13VDSR)-Давление СБРОС ББ2 в норме
#define R0VP82LZ1	 BUFFER[242]	//(s08_K14VDSR)-Давление  в СИСТЕМЕ - 2 в норме
#define idR0VP82LZ1	 118	//(s08_K14VDSR)-Давление  в СИСТЕМЕ - 2 в норме
...
#define A3VZ13LZ1	 BUFFER[280]	//(s10_K01FDSR)- Имитация АЗ от ВУ ИС
#define idA3VZ13LZ1	 137	//(s10_K01FDSR)- Имитация АЗ от ВУ ИС
#define A3VZ15LZ1	 BUFFER[282]	//(s10_K02FDSR)- Имитация АЗ от НУП ИС
#define idA3VZ15LZ1	 138	//(s10_K02FDSR)- Имитация АЗ от НУП ИС
#define R0AD14LZ1	 BUFFER[284]	//(s10_K03FDSR)- Имитация АЗ от IIУР
#define idR0AD14LZ1	 139	//(s10_K03FDSR)- Имитация АЗ от IIУР
#define A1VN71LZ1	 BUFFER[286]	//(s10_K04FDSR)- Блокировка автоматического подъёма ББ
#define idA1VN71LZ1	 140	//(s10_K04FDSR)- Блокировка автоматического подъёма ББ
#define R0VZ71LZ1	 BUFFER[288]	//(s10_K05FDSR)- Обобщенный сигнал АЗ1 канала
#define idR0VZ71LZ1	 141	//(s10_K05FDSR)- Обобщенный сигнал АЗ1 канала
#define OEBB1Z1	 BUFFER[290]	//(s10_K06FDSR)- (сигнал не подтвержден) Обесточивание ЭМ ББ1 и ЭПК ББ1 
#define idOEBB1Z1	 142	//(s10_K06FDSR)- (сигнал не подтвержден) Обесточивание ЭМ ББ1 и ЭПК ББ1 
#define OEBB2Z1	 BUFFER[292]	//(s10_K07FDSR)- (сигнал не подтвержден) Обесточивание ЭМ ББ2 и ЭПК ББ2
#define idOEBB2Z1	 143	//(s10_K07FDSR)- (сигнал не подтвержден) Обесточивание ЭМ ББ2 и ЭПК ББ2
#define OERB1Z1	 BUFFER[294]	//(s10_K08FDSR)- (сигнал не подтвержден) Обесточивание ЭМ РБ1 и ЭПК РБ1
#define idOERB1Z1	 144	//(s10_K08FDSR)- (сигнал не подтвержден) Обесточивание ЭМ РБ1 и ЭПК РБ1
#define OERB2Z1	 BUFFER[296]	//(s10_K09FDSR)- (сигнал не подтвержден) Обесточивание ЭМ РБ2 и ЭПК РБ2 
#define idOERB2Z1	 145	//(s10_K09FDSR)- (сигнал не подтвержден) Обесточивание ЭМ РБ2 и ЭПК РБ2 
#define A3IS11LDU	 BUFFER[298]	//(s10_K10FDSR)- (сигнал не подтвержден) Приход на ВУ ИС1 для ДУ
#define idA3IS11LDU	 146	//(s10_K10FDSR)- (сигнал не подтвержден) Приход на ВУ ИС1 для ДУ
#define A3IS22LDU	 BUFFER[300]	//(s10_K11FDSR)- (сигнал не подтвержден) Приход на НУП ИС1 для ДУ
#define idA3IS22LDU	 147	//(s10_K11FDSR)- (сигнал не подтвержден) Приход на НУП ИС1 для ДУ
#define A3IS11LZ2	 BUFFER[302]	//(s10_K12FDSR)- (сигнал не подтвержден) Приход на ВУ ИС1 для УСБ2
#define idA3IS11LZ2	 148	//(s10_K12FDSR)- (сигнал не подтвержден) Приход на ВУ ИС1 для УСБ2
#define A3IS22LZ2	 BUFFER[304]	//(s10_K13FDSR)- (сигнал не подтвержден) Приход на НУП ИС1 для УСБ2
#define idA3IS22LZ2	 149	//(s10_K13FDSR)- (сигнал не подтвержден) Приход на НУП ИС1 для УСБ2
#define A0VP81LZ2	 BUFFER[306]	//(s10_K14FDSR)- (сигнал не подтвержден) Давление  АЗ1 в норме для УСБ2
#define idA0VP81LZ2	 150	//(s10_K14FDSR)- (сигнал не подтвержден) Давление  АЗ1 в норме для УСБ2
#define A1VP81LZ2	 BUFFER[308]	//(s10_K15FDSR)- (сигнал не подтвержден) Давление СБРОС ББ1 в норме для УСБ2
#define idA1VP81LZ2	 151	//(s10_K15FDSR)- (сигнал не подтвержден) Давление СБРОС ББ1 в норме для УСБ2
#define s10_K16FDSR	 BUFFER[310]	//(s10_K16FDSR)- 
#define ids10_K16FDSR	 152	//(s10_K16FDSR)- 
#pragma pack(push,1)
static VarCtrl allVariables[]={      // Описание всех переменных
	{ 1	,3	,1	, &A0IT01IZ1},	//(K01VASR)- Температура АЗ1-1
	{ 2	,3	,1	, &A2IP01IZ1},	//(K02VASR)- Текущее давление СБРОС РБ1
	{ 3	,3	,1	, &B0IT01IZ1},	//(K03VASR)- Температура АЗ2-1
	{ 4	,3	,1	, &B2IP01IZ1},	//(K04VASR)- Текущее давление СБРОС РБ2
	{ 5	,3	,1	, &s04_K05VASR},	//(K05VASR)- 
	{ 6	,3	,1	, &s04_K06VASR},	//(K06VASR)- 
	{ 7	,3	,1	, &s04_K07VASR},	//(K07VASR)- 
	{ 8	,3	,1	, &s04_K08VASR},	//(K08VASR)- 
	{ 9	,1	,1	, &R0VN71LZ1},	//(s05_K01VDSR)- АС по мощности канал 1
	{ 10	,1	,1	, &R0VN75LZ1},	//(s05_K02VDSR)- АС по периоду разгона канал  1
	{ 11	,1	,1	, &A0EE01LS1},	//(s05_K03VDSR)- Исправность АКНП канал 1 
	{ 12	,1	,1	, &A0VN71LS1},	//(s05_K04VDSR)- Блокировка автоматического подъёма ББ канал 1
	{ 13	,1	,1	, &A3IS11LZ1},	//(s05_K05VDSR)- Приход на ВУ ИС1
	{ 14	,1	,1	, &A3IS22LZ1},	//(s05_K06VDSR)- Приход на НУП ИС1
	{ 15	,1	,1	, &R0AD03LZ1},	//(s05_K07VDSR)- Имитация прихода на ВУ ИС
	{ 16	,1	,1	, &R0AD04LZ1},	//(s05_K08VDSR)- Имитация срабатывания верхней АС II УР
	{ 17	,1	,1	, &R0AD05LZ1},	//(s05_K09VDSR)- Имитация ухода с НУП ИС
	{ 18	,1	,1	, &A2IS12LZ1},	//(s05_K10VDSR)- Магнит РБ1 зацеплен (для БАЗ1)
	{ 19	,1	,1	, &B2IS12LZ1},	//(s05_K11VDSR)- Магнит РБ2 зацеплен (для БАЗ1)
	...
	{ 41	,1	,1	, &R0VN72LZ1},	//(s06_K01VDSR)- АС по мощности канал 2
	{ 42	,1	,1	, &R0VN76LZ1},	//(s06_K02VDSR)- АС по периоду разгона канал  2
	{ 43	,1	,1	, &A0EE01LS2},	//(s06_K03VDSR)- Исправность АКНП  канал 2
	{ 44	,1	,1	, &A0VN71LS2},	//(s06_K04VDSR)- Блокировка автоматического подъёма ББ канал 2
	{ 45	,1	,1	, &B3IS11LZ1},	//(s06_K05VDSR)- Приход на ВУ ИС2
	{ 46	,1	,1	, &B3IS22LZ1},	//(s06_K06VDSR)- Приход на НУП ИС2
	...
	{ 73	,1	,1	, &R0VN74LZ1},	//(s07_K01VDSR)- АС по мощности канал 4
	{ 74	,1	,1	, &R0VN78LZ1},	//(s07_K02VDSR)- АС по периоду разгона канал  4
	{ 75	,1	,1	, &A0EE01LS4},	//(s07_K03VDSR)- Исправность АКНП канал 4
	{ 76	,1	,1	, &A0VN71LS4},	//(s07_K04VDSR)- Блокировка автоматического подъёма ББ канал 4
	{ 77	,1	,1	, &R6IS66LZ1},	//(s07_K05VDSR)- Исправность ВИП 4,0 (№5) ССДИ-1-1
	{ 78	,1	,1	, &R6IS67LZ1},	//(s07_K06VDSR)- Исправность ВИП 4,0 (№6) ССДИ-1-2
	{ 79	,1	,1	, &R6IS68LZ1},	//(s07_K07VDSR)- Исправность ВИП 4,0 (№7) ССДИ-2
	...
	{ 105	,1	,1	, &R0VN73LZ1},	//(s08_K01VDSR)-АС по мощности канал 3
	{ 106	,1	,1	, &R0VN77LZ1},	//(s08_K02VDSR)-АС по периоду разгона канал  3
	{ 107	,1	,1	, &A0EE01LS3},	//(s08_K03VDSR)-Исправность АКНП канал 3
	{ 108	,1	,1	, &A0VN71LS3},	//(s08_K04VDSR)-Блокировка автоматического подъёма ББ канал 3
	{ 109	,1	,1	, &R7II71LZ1},	//(s08_K05VDSR)-Сработала АС IУР РАД (датчик 1)
	{ 110	,1	,1	, &R7II72LZ1},	//(s08_K06VDSR)-Сработала АС IУР РАД  (датчик 2)
	{ 111	,1	,1	, &R7II73LZ1},	//(s08_K07VDSR)-Сработала АС II УР РАД
	{ 112	,1	,1	, &s08_K08VDSR},	//(s08_K08VDSR)-
	{ 113	,1	,1	, &A0VP81LZ1},	//(s08_K09VDSR)-Давление  АЗ1 в норме
	{ 114	,1	,1	, &A1VP81LZ1},	//(s08_K10VDSR)-Давление СБРОС ББ1 в норме
	{ 115	,1	,1	, &R0VP81LZ1},	//(s08_K11VDSR)-Давление  в СИСТЕМЕ -1 в норме
	{ 116	,1	,1	, &B0VP81LZ1},	//(s08_K12VDSR)-Давление АЗ2 в норме
	{ 117	,1	,1	, &B1VP81LZ1},	//(s08_K13VDSR)-Давление СБРОС ББ2 в норме
	{ 118	,1	,1	, &R0VP82LZ1},	//(s08_K14VDSR)-Давление  в СИСТЕМЕ - 2 в норме
	...
	{ 137	,1	,1	, &A3VZ13LZ1},	//(s10_K01FDSR)- Имитация АЗ от ВУ ИС
	{ 138	,1	,1	, &A3VZ15LZ1},	//(s10_K02FDSR)- Имитация АЗ от НУП ИС
	{ 139	,1	,1	, &R0AD14LZ1},	//(s10_K03FDSR)- Имитация АЗ от IIУР
	{ 140	,1	,1	, &A1VN71LZ1},	//(s10_K04FDSR)- Блокировка автоматического подъёма ББ
	{ 141	,1	,1	, &R0VZ71LZ1},	//(s10_K05FDSR)- Обобщенный сигнал АЗ1 канала
	{ 142	,1	,1	, &OEBB1Z1},	//(s10_K06FDSR)- (сигнал не подтвержден) Обесточивание ЭМ ББ1 и ЭПК ББ1 
	{ 143	,1	,1	, &OEBB2Z1},	//(s10_K07FDSR)- (сигнал не подтвержден) Обесточивание ЭМ ББ2 и ЭПК ББ2
	{ 144	,1	,1	, &OERB1Z1},	//(s10_K08FDSR)- (сигнал не подтвержден) Обесточивание ЭМ РБ1 и ЭПК РБ1
	{ 145	,1	,1	, &OERB2Z1},	//(s10_K09FDSR)- (сигнал не подтвержден) Обесточивание ЭМ РБ2 и ЭПК РБ2 
	{ 146	,1	,1	, &A3IS11LDU},	//(s10_K10FDSR)- (сигнал не подтвержден) Приход на ВУ ИС1 для ДУ
	{ 147	,1	,1	, &A3IS22LDU},	//(s10_K11FDSR)- (сигнал не подтвержден) Приход на НУП ИС1 для ДУ
	{ 148	,1	,1	, &A3IS11LZ2},	//(s10_K12FDSR)- (сигнал не подтвержден) Приход на ВУ ИС1 для УСБ2
	{ 149	,1	,1	, &A3IS22LZ2},	//(s10_K13FDSR)- (сигнал не подтвержден) Приход на НУП ИС1 для УСБ2
	{ 150	,1	,1	, &A0VP81LZ2},	//(s10_K14FDSR)- (сигнал не подтвержден) Давление  АЗ1 в норме для УСБ2
	{ 151	,1	,1	, &A1VP81LZ2},	//(s10_K15FDSR)- (сигнал не подтвержден) Давление СБРОС ББ1 в норме для УСБ2
...
#pragma pop
#pragma pack(push,1)
static ModbusRegister di_Baz1sign[]={  // 
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
static ModbusRegister ir_Baz1sign[]={  // 
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
static ModbusRegister hr_Baz1sign[]={  // 
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
static ModbusDevice modbuses[]={
	{0,5002,&coil_Baz1sign[0],&di_Baz1sign[0],&ir_Baz1sign[0],&hr_Baz1sign[0],NULL,NULL,NULL,0},	 //Общий слэйв

	{0,-1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0},};
#pragma pop
#include <fp8/drivers/vas84r.h>
static char buf_VAS84_04[28];	//VAS84_04
static vas84r_inipar ini_VAS84_04={0xc6,255,1,8,0xff,0,16,};
#pragma pack(push,1)
