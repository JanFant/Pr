...
static ModbusRegister di_SCM[]={  // 
	{&A2IS11LIM,1,0},	//(A2IS11LIM) Магнит РБ1 обесточен
	{&A2IS32LIM,1,1},	//(A2IS32LIM) Клапан cброса РБ1 открыт(обесточен)
	{&B2IS11LIM,1,2},	//(B2IS11LIM) Магнит РБ2 обесточен
	{&B2IS32LIM,1,3},	//(B2IS32LIM) Клапан cброса РБ2 открыт(обесточен)
	{&A6VS22LDU,1,4},	//(A6VS22LDU) Движение створок БЗ1  к ЗАКРЫТА
	{&A6VS12LDU,1,5},	//(A6VS12LDU) Движение створок БЗ1  к  ОТКРЫТА
	{&B6VS22LDU,1,6},	//(B6VS22LDU) Движение створок БЗ2  к ЗАКРЫТА
	{&B6VS12LDU,1,7},	//(B6VS12LDU) Движение створок БЗ2  к ОТКРЫТА
	{&A5VS22LDU,1,8},	//(A5VS22LDU) Движение НЛ1 в сторону НУ
	{&A5VS12LDU,1,9},	//(A5VS12LDU) Движение НЛ1 в сторону ВУ
	{&B5VS22LDU,1,10},	//(B5VS22LDU) Движение НЛ2 в сторону НУ
	{&B5VS12LDU,1,11},	//(B5VS12LDU) Движение НЛ2 в сторону ВУ
	{&R1VS22LDU,1,12},	//(R1VS22LDU) Движение МДЗ1 в сторону НУ
	{&R2VS22LDU,1,13},	//(R2VS22LDU) Движение МДЗ2 в сторону НУ
	{&R2VS12LDU,1,14},	//(R2VS12LDU) Движение МДЗ2 в сторону ВУ
	{&R1VS12LDU,1,15},	//(R1VS12LDU) Движение МДЗ1 в сторону ВУ
	{&R4VS22LDU,1,16},	//(R4VS22LDU) Движение реактора к «У ЗАЩИТЫ»
	{&R4VS12LDU,1,17},	//(R4VS12LDU) Движение реактора  к «У ОБРАЗЦОВ»
	{&A2VP82LDU,1,18},	//(A2VP82LDU) Давление ПОДЪЁМ РБ1 в норме
	{&A3VP81LDU,1,19},	//(A3VP81LDU) Давление СПУСК ИС1 в норме
	{&B3VP81LDU,1,20},	//(B3VP81LDU) Давление СПУСК ИС2 в норме
	{&B2VP82LDU,1,21},	//(B2VP82LDU) Давление ПОДЪЁМ РБ2 в норме
	{&B4IS21LDU,1,22},	//(B4IS21LDU) Приход на НУ НИ2
	{&A4VP82LDU,1,23},	//(A4VP82LDU) Давление ПОДЪЁМ НИ1 в норме
	{&B4VP82LDU,1,24},	//(B4VP82LDU) Давление ПОДЪЁМ НИ2 в норме
	{&A1IE03LDU,1,25},	//(A1IE03LDU) Движение ББ1 вперед (от БУШД)
	{&A1IE04LDU,1,26},	//(A1IE04LDU) Движение ББ1 назад (от БУШД)
	{&B1IE03LDU,1,27},	//(B1IE03LDU) Движение ББ2 вперед (от БУШД)
	{&B1IE04LDU,1,28},	//(B1IE04LDU) Движение ББ2 назад (от БУШД)
	{&A1IS11LIM,1,29},	//(A1IS11LIM) Магнит ББ1 обесточен
	{&A1IS32LIM,1,30},	//(A1IS32LIM) Клапан cброса ББ1 открыт(обесточен)
	{&B1IS11LIM,1,31},	//(B1IS11LIM) Магнит ББ2 обесточен
	{&B1IS32LIM,1,32},	//(B1IS32LIM) Клапан cброса ББ2 открыт(обесточен)
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
