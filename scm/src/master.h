...
void InitSetConst(void){      // Инициализация  переменных для сохранения
	...
	setAsFloat(651,0.01);
	setAsFloat(652,0.5);
	setAsFloat(653,100.0);
	setAsShort(654,0);
	setAsShort(655,0);
	setAsShort(656,0);
	setAsFloat(657,25);
	setAsFloat(658,-0.18505518);
	setAsFloat(659,0.0);
	setAsFloat(660,25);
	setAsFloat(661,0);
	setAsFloat(662,0);
	...
	setAsShort(720,0);
	setAsShort(721,0);
	setAsFloat(722,1269.0);
	setAsFloat(723,256.0);
	setAsFloat(724,506.6);
	setAsShort(725,0);
	setAsShort(726,0);
	setAsShort(727,0);
	setAsShort(728,0);
...
void InitInternalParametr(void)
{
  int i;
  for( i=0;i<2;i++ )
    array_m1082_tst_1[i] = &(&internal1_m1082_tst)[i*5];
  for( i=0;i<2;i++ )
    array_m1082_trz_1[i] = &(&internal1_m1082_trz)[i*5];
  for( i=0;i<2;i++ )
    array_m1082_N1_1[i] = &(&internal1_m1082_N1)[i*5];
  for( i=0;i<2;i++ )
    array_m1082_N2_1[i] = &(&internal1_m1082_N2)[i*5];
  for( i=0;i<2;i++ )
    array_m1024_tst_1[i] = &(&internal1_m1024_tst)[i*5];
  for( i=0;i<2;i++ )
    array_m1024_trz_1[i] = &(&internal1_m1024_trz)[i*5];
  for( i=0;i<2;i++ )
    array_m1024_N1_1[i] = &(&internal1_m1024_N1)[i*5];
  for( i=0;i<2;i++ )
    array_m1024_N2_1[i] = &(&internal1_m1024_N2)[i*5];
  for( i=0;i<2;i++ )
    array_m896_tst_1[i] = &(&internal1_m896_tst)[i*5];
  for( i=0;i<2;i++ )
    array_m896_trz_1[i] = &(&internal1_m896_trz)[i*5];
  for( i=0;i<2;i++ )
    array_m896_N1_1[i] = &(&internal1_m896_N1)[i*5];
  for( i=0;i<2;i++ )
    array_m896_N2_1[i] = &(&internal1_m896_N2)[i*5];
  for( i=0;i<2;i++ )
    array_m841_tst_1[i] = &(&internal1_m841_tst)[i*5];
  for( i=0;i<2;i++ )
    array_m841_trz_1[i] = &(&internal1_m841_trz)[i*5];
  for( i=0;i<2;i++ )
    array_m841_N1_1[i] = &(&internal1_m841_N1)[i*5];
  for( i=0;i<2;i++ )
    array_m841_N2_1[i] = &(&internal1_m841_N2)[i*5];
  for( i=0;i<6;i++ )
