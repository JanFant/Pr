...
#define B8IC01UDU	 BUFFER[102]	//( - , SDu, SA1, SA2, SA3, SA4, SRP) Координата АЗ2
#define idB8IC01UDU	 49	//( - , SDu, SA1, SA2, SA3, SA4, SRP) Координата АЗ2
...
static VarCtrl allVariables[]={      // Описание всех переменных
	...
	{ 49	,5	,1	, &B8IC01UDU},	//( - , SDu, SA1, SA2, SA3, SA4, SRP) Координата АЗ2
