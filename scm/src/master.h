...
#define B4VP82LDU	 BUFFER[28]	//( - , SCM) Давление ПОДЪЁМ НИ2 в норме
#define idB4VP82LDU	 15	//( - , SCM) Давление ПОДЪЁМ НИ2 в норме
#define A4VP82LDU	 BUFFER[30]	//( - , SCM) Давление ПОДЪЁМ НИ1 в норме
#define idA4VP82LDU	 16	//( - , SCM) Давление ПОДЪЁМ НИ1 в норме
...
#define B2VP82LDU	 BUFFER[138]	//( - , SCM) Давление ПОДЪЁМ РБ2 в норме
#define idB2VP82LDU	 64	//( - , SCM) Давление ПОДЪЁМ РБ2 в норме
...
#define R0MW11IP1	 BUFFER[238]	//( - , SCM) Переключатель ВЫСТРЕЛ
#define idR0MW11IP1	 87	//( - , SCM) Переключатель ВЫСТРЕЛ
...
#define B3VP81LDU	 BUFFER[601]	//( - , SCM) Давление СПУСК ИС2 в норме
#define idB3VP81LDU	 233	//( - , SCM) Давление СПУСК ИС2 в норме
#define A3VP81LDU	 BUFFER[603]	//( - , SCM) Давление СПУСК ИС1 в норме
#define idA3VP81LDU	 234	//( - , SCM) Давление СПУСК ИС1 в норме
...
#define A2VP82LDU	 BUFFER[626]	//( - , SCM) Давление ПОДЪЁМ РБ1 в норме
#define idA2VP82LDU	 242	//( - , SCM) Давление ПОДЪЁМ РБ1 в норме
...
static VarCtrl allVariables[]={      // Описание всех переменных
	...
	{ 15	,1	,1	, &B4VP82LDU},	//( - , SCM) Давление ПОДЪЁМ НИ2 в норме
	{ 16	,1	,1	, &A4VP82LDU},	//( - , SCM) Давление ПОДЪЁМ НИ1 в норме
	...
	{ 64	,1	,1	, &B2VP82LDU},	//( - , SCM) Давление ПОДЪЁМ РБ2 в норме
	...
	{ 87	,3	,1	, &R0MW11IP1},	//( - , SCM) Переключатель ВЫСТРЕЛ
	...
	{ 233	,1	,1	, &B3VP81LDU},	//( - , SCM) Давление СПУСК ИС2 в норме
	{ 234	,1	,1	, &A3VP81LDU},	//( - , SCM) Давление СПУСК ИС1 в норме
	...
	{ 242	,1	,1	, &A2VP82LDU},	//( - , SCM) Давление ПОДЪЁМ РБ1 в норме
...
static ModbusRegister di_SCM[]={  // 
	{&A2IS32LIM,1,0},	//( - , SCM) Клапан cброса РБ1 открыт(обесточен)
	{&B2IS11LIM,1,1},	//( - , SCM) Магнит РБ2 обесточен
	{&B2IS32LIM,1,2},	//( - , SCM) Клапан cброса РБ2 открыт(обесточен)
	{&A6VS22LDU,1,3},	//( - , SCM) Движение створок БЗ1  к ЗАКРЫТА
	{&A6VS12LDU,1,4},	//( - , SCM) Движение створок БЗ1  к  ОТКРЫТА
	{&B6VS22LDU,1,5},	//( - , SCM) Движение створок БЗ2  к ЗАКРЫТА
	{&B6VS12LDU,1,6},	//( - , SCM) Движение створок БЗ2  к ОТКРЫТА
	{&A5VS22LDU,1,7},	//( - , SCM) Движение НЛ1 в сторону НУ
	{&A5VS12LDU,1,8},	//( - , SCM) Движение НЛ1 в сторону ВУ
	{&B5VS22LDU,1,9},	//( - , SCM) Движение НЛ2 в сторону НУ
	{&B5VS12LDU,1,10},	//( - , SCM) Движение НЛ2 в сторону ВУ
	{&R1VS22LDU,1,11},	//( - , SCM) Движение МДЗ1 в сторону НУ
	{&R2VS22LDU,1,12},	//( - , SCM) Движение МДЗ2 в сторону НУ
	{&R2VS12LDU,1,13},	//( - , SCM) Движение МДЗ2 в сторону ВУ
	{&R1VS12LDU,1,14},	//( - , SCM) Движение МДЗ1 в сторону ВУ
	{&R4VS22LDU,1,15},	//( - , SCM) Движение реактора к «У ЗАЩИТЫ»
	{&R4VS12LDU,1,16},	//( - , SCM) Движение реактора  к «У ОБРАЗЦОВ»
	{&A2VP82LDU,1,17},	//( - , SCM) Давление ПОДЪЁМ РБ1 в норме
	{&A3VP81LDU,1,18},	//( - , SCM) Давление СПУСК ИС1 в норме
	{&B3VP81LDU,1,19},	//( - , SCM) Давление СПУСК ИС2 в норме
	{&B2VP82LDU,1,20},	//( - , SCM) Давление ПОДЪЁМ РБ2 в норме
	{&B4IS21LDU,1,21},	//( - K08DO, SCM) Приход на НУ НИ2
	{&A4VP82LDU,1,22},	//( - , SCM) Давление ПОДЪЁМ НИ1 в норме
	{&B4VP82LDU,1,23},	//( - , SCM) Давление ПОДЪЁМ НИ2 в норме
	{&A1IE03LDU,1,24},	//( - , SCM) Движение ББ1 вперед (от БУШД)
	{&A1IE04LDU,1,25},	//( - , SCM) Движение ББ1 назад (от БУШД)
	{&B1IE03LDU,1,26},	//( - , SCM) Движение ББ2 вперед (от БУШД)
	{&B1IE04LDU,1,27},	//( - , SCM) Движение ББ2 назад (от БУШД)
	{&A1IS11LIM,1,28},	//( - , SCM) Магнит ББ1 обесточен
	{&A1IS32LIM,1,29},	//( - , SCM) Клапан cброса ББ1 открыт(обесточен)
	{&B1IS11LIM,1,30},	//( - , SCM) Магнит ББ2 обесточен
	{&B1IS32LIM,1,31},	//( - , SCM) Клапан cброса ББ2 открыт(обесточен)
	{&A2IS11LIM,1,32},	//( - , SCM) Магнит РБ1 обесточен
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
