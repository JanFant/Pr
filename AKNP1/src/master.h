...
#define idvar2	108	// Внутренняя переменная var2
#define var27	BUFFER[412]	// Внутренняя переменная var27
#define idvar27	109	// Внутренняя переменная var27
#define var29	BUFFER[414]	// Внутренняя переменная var29
#define idvar29	110	// Внутренняя переменная var29
#define vainSBool	BUFFER[416]	// Внутренняя переменная vainSBool
#define idvainSBool	111	// Внутренняя переменная vainSBool
#define var1	BUFFER[418]	// Внутренняя переменная var1
#define idvar1	112	// Внутренняя переменная var1
#define var12	BUFFER[423]	// Внутренняя переменная var12
#define idvar12	113	// Внутренняя переменная var12
#define var21	BUFFER[425]	// Внутренняя переменная var21
#define idvar21	114	// Внутренняя переменная var21
#define var14	BUFFER[430]	// Внутренняя переменная var14
#define idvar14	115	// Внутренняя переменная var14
#define var19	BUFFER[432]	// Внутренняя переменная var19
#define idvar19	116	// Внутренняя переменная var19
#define var25	BUFFER[437]	// Внутренняя переменная var25
#define idvar25	117	// Внутренняя переменная var25
#define var31	BUFFER[439]	// Внутренняя переменная var31
#define idvar31	118	// Внутренняя переменная var31
#define var33	BUFFER[441]	// Внутренняя переменная var33
#define idvar33	119	// Внутренняя переменная var33
#define var4	BUFFER[443]	// Внутренняя переменная var4
#define idvar4	120	// Внутренняя переменная var4
#define var9	BUFFER[448]	// Внутренняя переменная var9
#define idvar9	121	// Внутренняя переменная var9
#define var13	BUFFER[450]	// Внутренняя переменная var13
#define idvar13	122	// Внутренняя переменная var13
#define var17	BUFFER[452]	// Внутренняя переменная var17
#define idvar17	123	// Внутренняя переменная var17
#define var18	BUFFER[454]	// Внутренняя переменная var18
#define idvar18	124	// Внутренняя переменная var18
#define var32	BUFFER[459]	// Внутренняя переменная var32
#define idvar32	125	// Внутренняя переменная var32
#define vainSLong	BUFFER[464]	// Внутренняя переменная vainSLong
#define idvainSLong	126	// Внутренняя переменная vainSLong
#define vainSInt	BUFFER[473]	// Внутренняя переменная vainSInt
#define idvainSInt	127	// Внутренняя переменная vainSInt
...
#define idvar10	129	// Внутренняя переменная var10
#define var15	BUFFER[480]	// Внутренняя переменная var15
#define idvar15	130	// Внутренняя переменная var15
#define var24	BUFFER[483]	// Внутренняя переменная var24
#define idvar24	131	// Внутренняя переменная var24
#define vainSFloat	BUFFER[486]	// Внутренняя переменная vainSFloat
#define idvainSFloat	132	// Внутренняя переменная vainSFloat
#define var6	BUFFER[491]	// Внутренняя переменная var6
#define idvar6	133	// Внутренняя переменная var6
#define var7	BUFFER[496]	// Внутренняя переменная var7
#define idvar7	134	// Внутренняя переменная var7
#define var20	BUFFER[501]	// Внутренняя переменная var20
#define idvar20	135	// Внутренняя переменная var20
#define var23	BUFFER[503]	// Внутренняя переменная var23
#define idvar23	136	// Внутренняя переменная var23
#define var26	BUFFER[508]	// Внутренняя переменная var26
#define idvar26	137	// Внутренняя переменная var26
#define var30	BUFFER[513]	// Внутренняя переменная var30
...
#define var16	BUFFER[517]	// Внутренняя переменная var16
#define idvar16	140	// Внутренняя переменная var16
#define var22	BUFFER[519]	// Внутренняя переменная var22
#define idvar22	141	// Внутренняя переменная var22
#define var28	BUFFER[524]	// Внутренняя переменная var28
#define idvar28	142	// Внутренняя переменная var28
#define var3	BUFFER[526]	// Внутренняя переменная var3
#define idvar3	143	// Внутренняя переменная var3
#define var5	BUFFER[531]	// Внутренняя переменная var5
...
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{108	,8	,1	,&var2},	//Внутренняя переменная var2
	{109	,1	,1	,&var27},	//Внутренняя переменная var27
	{110	,1	,1	,&var29},	//Внутренняя переменная var29
	{111	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	{112	,8	,1	,&var1},	//Внутренняя переменная var1
	{113	,1	,1	,&var12},	//Внутренняя переменная var12
	{114	,8	,1	,&var21},	//Внутренняя переменная var21
	{115	,1	,1	,&var14},	//Внутренняя переменная var14
	{116	,8	,1	,&var19},	//Внутренняя переменная var19
	{117	,1	,1	,&var25},	//Внутренняя переменная var25
	{118	,1	,1	,&var31},	//Внутренняя переменная var31
	{119	,1	,1	,&var33},	//Внутренняя переменная var33
	{120	,8	,1	,&var4},	//Внутренняя переменная var4
	{121	,1	,1	,&var9},	//Внутренняя переменная var9
	{122	,1	,1	,&var13},	//Внутренняя переменная var13
	{123	,1	,1	,&var17},	//Внутренняя переменная var17
	{124	,8	,1	,&var18},	//Внутренняя переменная var18
	{125	,8	,1	,&var32},	//Внутренняя переменная var32
	{126	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	{127	,3	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	{128	,1	,1	,&var8},	//Внутренняя переменная var8
	{129	,1	,1	,&var10},	//Внутренняя переменная var10
	{130	,3	,1	,&var15},	//Внутренняя переменная var15
	{131	,3	,1	,&var24},	//Внутренняя переменная var24
	{132	,8	,1	,&vainSFloat},	//Внутренняя переменная vainSFloat
	{133	,8	,1	,&var6},	//Внутренняя переменная var6
	{134	,8	,1	,&var7},	//Внутренняя переменная var7
	{135	,1	,1	,&var20},	//Внутренняя переменная var20
	{136	,8	,1	,&var23},	//Внутренняя переменная var23
	{137	,8	,1	,&var26},	//Внутренняя переменная var26
	{138	,1	,1	,&var30},	//Внутренняя переменная var30
	{139	,1	,1	,&var11},	//Внутренняя переменная var11
	{140	,1	,1	,&var16},	//Внутренняя переменная var16
	{141	,8	,1	,&var22},	//Внутренняя переменная var22
	{142	,1	,1	,&var28},	//Внутренняя переменная var28
	{143	,8	,1	,&var3},	//Внутренняя переменная var3
