...
#define R0IN02FI1	 BUFFER[50]	//( - , MA1S) Выход КНК15-1 Гц от ПТИ
#define idR0IN02FI1	 22	//( - , MA1S) Выход КНК15-1 Гц от ПТИ
...
#define R0IN01FI1	 BUFFER[62]	//( - , MA1S) Выход СНМ-11 Гц от ПТИ
#define idR0IN01FI1	 25	//( - , MA1S) Выход СНМ-11 Гц от ПТИ
#define R0IN02FS1	 BUFFER[67]	//(vchs:01 - K02VCHS, - ) Выход КНК15-1 Гц
#define idR0IN02FS1	 26	//(vchs:01 - K02VCHS, - ) Выход КНК15-1 Гц
#define R0IN03FI1	 BUFFER[72]	//( - , MA1S) Выход КНК53М Гц от ПТИ
#define idR0IN03FI1	 27	//( - , MA1S) Выход КНК53М Гц от ПТИ
#define R0VN02RS1	 BUFFER[77]	//( - , A1Bz1, A1Bz2) Уровень мощности
#define idR0VN02RS1	 28	//( - , A1Bz1, A1Bz2) Уровень мощности
#define R0VN01RS1	 BUFFER[82]	//( - , A1Bz1, A1Bz2) Период разгона канал1
#define idR0VN01RS1	 29	//( - , A1Bz1, A1Bz2) Период разгона канал1
#define R0VN61LS1	 BUFFER[87]	//( - , A1Bz1, A1Bz2) ПС по мощности канал1
#define idR0VN61LS1	 30	//( - , A1Bz1, A1Bz2) ПС по мощности канал1
#define R0VN71LZ1	 BUFFER[89]	//(fds16:05 - K09FDSR, - ) АС по мощности на БАЗ1
#define idR0VN71LZ1	 31	//(fds16:05 - K09FDSR, - ) АС по мощности на БАЗ1
#define R0VN65LS1	 BUFFER[91]	//( - , A1Bz1, A1Bz2) ПС по периоду разгона канал1
#define idR0VN65LS1	 32	//( - , A1Bz1, A1Bz2) ПС по периоду разгона канал1
#define R0VN75LZ1	 BUFFER[93]	//(fds16:05 - K10FDSR, - ) АС по периоду разгонана БАЗ1
#define idR0VN75LZ1	 33	//(fds16:05 - K10FDSR, - ) АС по периоду разгонана БАЗ1
#define A0EE01LS1	 BUFFER[95]	//(fds16:05 - K11FDSR, - ) Исправность АКНП1 на БАЗ1
#define idA0EE01LS1	 34	//(fds16:05 - K11FDSR, - ) Исправность АКНП1 на БАЗ1
#define R0VN03RS1	 BUFFER[97]	//( - , AKNP1) Измеренный нейтронный поток
#define idR0VN03RS1	 35	//( - , AKNP1) Измеренный нейтронный поток
#define R0VN04RS1	 BUFFER[102]	//( - , AKNP1) Реактивность канал1
#define idR0VN04RS1	 36	//( - , AKNP1) Реактивность канал1
#define A0VN71LS1	 BUFFER[107]	//(fds16:05 - K12FDSR, - ) Блокировка автоматического  подъёма ББ на БАЗ1
...
#define R0VN33RS1	 BUFFER[127]	//( - , AKNP1) Нейтронный поток по камере КНК53М
#define idR0VN33RS1	 44	//( - , AKNP1) Нейтронный поток по камере КНК53М
#define R0VN15RS1	 BUFFER[132]	//( - , AKNP1) Номер ведущей камеры 1-СНМ-11,2-КНК-15М-1,3-КНК-53М,0-нет ведущей
#define idR0VN15RS1	 45	//( - , AKNP1) Номер ведущей камеры 1-СНМ-11,2-КНК-15М-1,3-КНК-53М,0-нет ведущей
#define R0IE01LS1	 BUFFER[135]	//(fds16:05 - K02FDSR, - ) Отключение питание детекторов 1 канала
#define idR0IE01LS1	 46	//(fds16:05 - K02FDSR, - ) Отключение питание детекторов 1 канала
#define R0IE02LS1	 BUFFER[137]	//(fds16:05 - K01FDSR, - ) Отключить питание ПР, ПУ 1 канала
#define idR0IE02LS1	 47	//(fds16:05 - K01FDSR, - ) Отключить питание ПР, ПУ 1 канала
#define R0VN71LZ2	 BUFFER[139]	//(fds16:05 - K13FDSR, - ) АС по мощности на БАЗ2
#define idR0VN71LZ2	 48	//(fds16:05 - K13FDSR, - ) АС по мощности на БАЗ2
#define R0VN75LZ2	 BUFFER[141]	//(fds16:05 - K14FDSR, - ) АС по периоду разгонана БАЗ2
#define idR0VN75LZ2	 49	//(fds16:05 - K14FDSR, - ) АС по периоду разгонана БАЗ2
#define A1EE01LS1	 BUFFER[143]	//(fds16:05 - K15FDSR, - ) Исправность АКНП1 на БАЗ2
#define idA1EE01LS1	 50	//(fds16:05 - K15FDSR, - ) Исправность АКНП1 на БАЗ2
#define A1VN71LS1	 BUFFER[145]	//(fds16:05 - K16FDSR, - ) Блокировка автоматического  подъёма ББ на БАЗ2
#define idA1VN71LS1	 51	//(fds16:05 - K16FDSR, - ) Блокировка автоматического  подъёма ББ на БАЗ2
#define B8VC01RDU	 BUFFER[147]	//( - , A1Bz1, A1Bz2) Координата АЗ2, мм
#define idB8VC01RDU	 52	//( - , A1Bz1, A1Bz2) Координата АЗ2, мм
#define R0EE01LZ1	 BUFFER[152]	//( - , AKNP1) Питание  АКНП1  отключить
#define idR0EE01LZ1	 53	//( - , AKNP1) Питание  АКНП1  отключить
#define R0EE01LZ2	 BUFFER[154]	//( - , AKNP1) Питание  АКНП1  отключить
...
#define fEM_R0UH22RSS	 BUFFER[296]	//(R0UH22RSS) Верхняя граница измерения частоты импульсов(имп/с) КНК-15-1
#define idfEM_R0UH22RSS	 83	//(R0UH22RSS) Верхняя граница измерения частоты импульсов(имп/с) КНК-15-1
#define fEM_R0UH23RSS	 BUFFER[301]	//(R0UH23RSS) Верхняя граница измерения частоты импульсов(имп/с) КНК-53М
...
#define internal1_m19_Nk	 BUFFER[308]	//(internal1_m19_Nk) Nk - ведущая камера
#define idinternal1_m19_Nk	 86	//(internal1_m19_Nk) Nk - ведущая камера
#define internal1_m58_flst	 BUFFER[311]	//(internal1_m58_flst)  флаг старта измерения
...
static VarCtrl allVariables[]={      // Описание всех переменных
	...
	{ 22	,8	,1	, &R0IN02FI1},	//( - , MA1S) Выход КНК15-1 Гц от ПТИ
	{ 23	,8	,1	, &R0IN03FS1},	//(vchs:02 - K01VCHS, - ) Выход КНК53М Гц
	{ 24	,1	,1	, &R0IS01FI0},	//( - , MA1S) Признак работы с имитатором
	{ 25	,8	,1	, &R0IN01FI1},	//( - , MA1S) Выход СНМ-11 Гц от ПТИ
	{ 26	,8	,1	, &R0IN02FS1},	//(vchs:01 - K02VCHS, - ) Выход КНК15-1 Гц
	{ 27	,8	,1	, &R0IN03FI1},	//( - , MA1S) Выход КНК53М Гц от ПТИ
...
_S_andn  S_andn_72_1 = {array_m72_x_1,&iRM_5_,&var4};
...
_S_react  S_react_59_1 = {&var22,&var28};
