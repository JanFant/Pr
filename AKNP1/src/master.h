...
#define var8	BUFFER[407]	// Внутренняя переменная var8
#define idvar8	108	// Внутренняя переменная var8
#define var12	BUFFER[409]	// Внутренняя переменная var12
#define idvar12	109	// Внутренняя переменная var12
#define vainSLong	BUFFER[411]	// Внутренняя переменная vainSLong
#define idvainSLong	110	// Внутренняя переменная vainSLong
#define vainSInt	BUFFER[420]	// Внутренняя переменная vainSInt
#define idvainSInt	111	// Внутренняя переменная vainSInt
#define var7	BUFFER[423]	// Внутренняя переменная var7
#define idvar7	112	// Внутренняя переменная var7
#define var17	BUFFER[428]	// Внутренняя переменная var17
#define idvar17	113	// Внутренняя переменная var17
#define var27	BUFFER[430]	// Внутренняя переменная var27
#define idvar27	114	// Внутренняя переменная var27
#define var3	BUFFER[432]	// Внутренняя переменная var3
#define idvar3	115	// Внутренняя переменная var3
#define var32	BUFFER[437]	// Внутренняя переменная var32
#define idvar32	116	// Внутренняя переменная var32
#define var33	BUFFER[442]	// Внутренняя переменная var33
#define idvar33	117	// Внутренняя переменная var33
#define var31	BUFFER[444]	// Внутренняя переменная var31
#define idvar31	118	// Внутренняя переменная var31
#define var4	BUFFER[446]	// Внутренняя переменная var4
#define idvar4	119	// Внутренняя переменная var4
#define var11	BUFFER[451]	// Внутренняя переменная var11
#define idvar11	120	// Внутренняя переменная var11
#define var15	BUFFER[453]	// Внутренняя переменная var15
#define idvar15	121	// Внутренняя переменная var15
#define var20	BUFFER[456]	// Внутренняя переменная var20
#define idvar20	122	// Внутренняя переменная var20
#define var22	BUFFER[458]	// Внутренняя переменная var22
#define idvar22	123	// Внутренняя переменная var22
#define var30	BUFFER[463]	// Внутренняя переменная var30
#define idvar30	124	// Внутренняя переменная var30
#define vainSBool	BUFFER[465]	// Внутренняя переменная vainSBool
...
#define var21	BUFFER[469]	// Внутренняя переменная var21
#define idvar21	127	// Внутренняя переменная var21
...
#define var28	BUFFER[482]	// Внутренняя переменная var28
#define idvar28	130	// Внутренняя переменная var28
#define var1	BUFFER[484]	// Внутренняя переменная var1
#define idvar1	131	// Внутренняя переменная var1
#define var6	BUFFER[489]	// Внутренняя переменная var6
#define idvar6	132	// Внутренняя переменная var6
#define var29	BUFFER[494]	// Внутренняя переменная var29
#define idvar29	133	// Внутренняя переменная var29
#define var9	BUFFER[496]	// Внутренняя переменная var9
#define idvar9	134	// Внутренняя переменная var9
...
#define idvar19	136	// Внутренняя переменная var19
#define var25	BUFFER[508]	// Внутренняя переменная var25
#define idvar25	137	// Внутренняя переменная var25
#define var26	BUFFER[510]	// Внутренняя переменная var26
#define idvar26	138	// Внутренняя переменная var26
#define vainSFloat	BUFFER[515]	// Внутренняя переменная vainSFloat
#define idvainSFloat	139	// Внутренняя переменная vainSFloat
#define var2	BUFFER[520]	// Внутренняя переменная var2
...
#define var13	BUFFER[530]	// Внутренняя переменная var13
#define idvar13	142	// Внутренняя переменная var13
#define var14	BUFFER[532]	// Внутренняя переменная var14
#define idvar14	143	// Внутренняя переменная var14
#define var16	BUFFER[534]	// Внутренняя переменная var16
...
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{108	,1	,1	,&var8},	//Внутренняя переменная var8
	{109	,1	,1	,&var12},	//Внутренняя переменная var12
	{110	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	{111	,3	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	{112	,8	,1	,&var7},	//Внутренняя переменная var7
	{113	,1	,1	,&var17},	//Внутренняя переменная var17
	{114	,1	,1	,&var27},	//Внутренняя переменная var27
	{115	,8	,1	,&var3},	//Внутренняя переменная var3
	{116	,8	,1	,&var32},	//Внутренняя переменная var32
	{117	,1	,1	,&var33},	//Внутренняя переменная var33
	{118	,1	,1	,&var31},	//Внутренняя переменная var31
	{119	,8	,1	,&var4},	//Внутренняя переменная var4
	{120	,1	,1	,&var11},	//Внутренняя переменная var11
	{121	,3	,1	,&var15},	//Внутренняя переменная var15
	{122	,1	,1	,&var20},	//Внутренняя переменная var20
	{123	,8	,1	,&var22},	//Внутренняя переменная var22
	{124	,1	,1	,&var30},	//Внутренняя переменная var30
	{125	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	{126	,1	,1	,&var10},	//Внутренняя переменная var10
	{127	,8	,1	,&var21},	//Внутренняя переменная var21
	{128	,8	,1	,&var23},	//Внутренняя переменная var23
	{129	,3	,1	,&var24},	//Внутренняя переменная var24
	{130	,1	,1	,&var28},	//Внутренняя переменная var28
	{131	,8	,1	,&var1},	//Внутренняя переменная var1
	{132	,8	,1	,&var6},	//Внутренняя переменная var6
	{133	,1	,1	,&var29},	//Внутренняя переменная var29
	{134	,1	,1	,&var9},	//Внутренняя переменная var9
	{135	,8	,1	,&var18},	//Внутренняя переменная var18
	{136	,8	,1	,&var19},	//Внутренняя переменная var19
	{137	,1	,1	,&var25},	//Внутренняя переменная var25
	...
	{144	,1	,1	,&var16},	//Внутренняя переменная var16
	{-1,0,NULL},
};
