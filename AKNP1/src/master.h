...
#define SIZE_BUFFER 402
static char BUFFER[402];
...
#define internal1_m55_flst	 BUFFER[356]	//(internal1_m55_flst)  флаг старта измерения
#define idinternal1_m55_flst	 96	//(internal1_m55_flst)  флаг старта измерения
#define internal1_m55_chsr	 BUFFER[359]	//(internal1_m55_chsr)  счетчик усреднения
#define idinternal1_m55_chsr	 97	//(internal1_m55_chsr)  счетчик усреднения
#define internal1_m55_chizm	 BUFFER[362]	//(internal1_m55_chizm)  счетчик уменьшения мощности
#define idinternal1_m55_chizm	 98	//(internal1_m55_chizm)  счетчик уменьшения мощности
#define internal1_m55_sumtim	 BUFFER[365]	//(internal1_m55_sumtim)  время измерения мощности
#define idinternal1_m55_sumtim	 99	//(internal1_m55_sumtim)  время измерения мощности
#define internal1_m55_W1	 BUFFER[370]	//(internal1_m55_W1)  мощность на старте измерения
#define idinternal1_m55_W1	 100	//(internal1_m55_W1)  мощность на старте измерения
#define internal1_m55_W2	 BUFFER[375]	//(internal1_m55_W2)  мощность в конце измерения
#define idinternal1_m55_W2	 101	//(internal1_m55_W2)  мощность в конце измерения
...
#define internal1_m55_Wmax	 BUFFER[385]	//(internal1_m55_Wmax)  максимальное измерение в серии
#define idinternal1_m55_Wmax	 103	//(internal1_m55_Wmax)  максимальное измерение в серии
#define internal1_m55_Wlast	 BUFFER[390]	//(internal1_m55_Wlast)  последнее растущее измерение
#define idinternal1_m55_Wlast	 104	//(internal1_m55_Wlast)  последнее растущее измерение
#define internal1_m55_y0	 BUFFER[395]	//(internal1_m55_y0) y0 - внутренний параметр
#define idinternal1_m55_y0	 105	//(internal1_m55_y0) y0 - внутренний параметр
#define internal1_m55_MyFirstEnterFlag	 BUFFER[400]	//(internal1_m55_MyFirstEnterFlag)  FirstEnterFlag
#define idinternal1_m55_MyFirstEnterFlag	 106	//(internal1_m55_MyFirstEnterFlag)  FirstEnterFlag
#pragma pack(push,1)
static VarCtrl allVariables[]={      // Описание всех переменных
	...
	{ 96	,3	,1	, &internal1_m55_flst},	//(internal1_m55_flst)  флаг старта измерения
	{ 97	,3	,1	, &internal1_m55_chsr},	//(internal1_m55_chsr)  счетчик усреднения
	{ 98	,3	,1	, &internal1_m55_chizm},	//(internal1_m55_chizm)  счетчик уменьшения мощности
	{ 99	,8	,1	, &internal1_m55_sumtim},	//(internal1_m55_sumtim)  время измерения мощности
	{ 100	,8	,1	, &internal1_m55_W1},	//(internal1_m55_W1)  мощность на старте измерения
	{ 101	,8	,1	, &internal1_m55_W2},	//(internal1_m55_W2)  мощность в конце измерения
	{ 102	,8	,1	, &internal1_m55_Wmin},	//(internal1_m55_Wmin)  минимальное измерение в серии
	{ 103	,8	,1	, &internal1_m55_Wmax},	//(internal1_m55_Wmax)  максимальное измерение в серии
	{ 104	,8	,1	, &internal1_m55_Wlast},	//(internal1_m55_Wlast)  последнее растущее измерение
	{ 105	,8	,1	, &internal1_m55_y0},	//(internal1_m55_y0) y0 - внутренний параметр
	{ 106	,1	,1	, &internal1_m55_MyFirstEnterFlag},	//(internal1_m55_MyFirstEnterFlag)  FirstEnterFlag
	{-1,0,NULL},
};
...
/* Объявление массивов */
psbool  array_m67_x_1[5] = {&lRM_1_,&var19,&R0IE13LS1,&R0IE12LS1,&R0IE11LS1};
psbool  array_m97_x_1[5] = {&var9,&var8,&R0DE37LS1,&R0DE38LS1,&R0DE39LS1};
psint  array_m87_x_1[4] = {&R0DE01LS1,&R0DE02LS1,&R0DE04LS1,&R0DE05LS1};

/* Объявление структур */
_S_pogrvh  S_pogrvh_116_1 = {&R0IN03FV1,&fEM_R0IN31FN1,&fEM_R0IN32FN1,&var1};
_S_pogrvh  S_pogrvh_114_1 = {&R0IN02FV1,&fEM_R0IN21FN1,&fEM_R0IN22FN1,&var2};
_S_pogrvh  S_pogrvh_112_1 = {&R0IN01FV1,&fEM_R0IN11FN1,&fEM_R0IN12FN1,&var3};
...
_S_noto  S_noto_101_1 = {&var11,&vainSBool};
_S_andn  S_andn_67_1 = {array_m67_x_1,&iRM_5_,&var7};
_S_or2  S_or2_102_1 = {&R0DEB3LS1,&R0DEB4LS1,&var8};
_S_or2  S_or2_95_1 = {&R0DEB1LS1,&R0DEB2LS1,&var9};
_S_orn  S_orn_97_1 = {array_m97_x_1,&iRM_5_,&var10};
_S_or3  S_or3_100_1 = {&var13,&var12,&var10,&var11};
_S_and2  S_and2_88_1 = {&R0DE31LS1,&R0DE32LS1,&var12};
_S_diagndev  S_diagndev_87_1 = {array_m87_x_1,&iRM_4_,&var13,&var14};
_S_and2  S_and2_66_1 = {&var29,&var26,&var15};
_S_and2  S_and2_65_1 = {&var30,&var29,&var16};
_S_ocham  S_ocham_17_1 = {&var6,&var5,&var4,&B8VC01RDU,&fEM_R7UX00RSS,&fEM_R7UY00RSS,&fEM_A0UX00RSS,&fEM_A0UX01RSS,&fEM_B0UX01RSS,&fEM_A0UX02RSS,&fEM_B0UX02RSS,&fEM_A0UX03RSS,&fEM_B0UX03RSS,&fEM_R7UX01RSS,&fEM_R7UY01RSS,&fEM_R7UX02RSS,&fEM_R7UY02RSS,&fEM_R7UX03RSS,&fEM_R7UY03RSS,&bRM_2_,&fEM_R0UH01RSS,&fEM_R0UH02RSS,&fEM_R0UH03RSS,&fEM_R0UH05RSS,&fEM_R0UH21RSS,&fEM_R0UH22RSS,&fEM_R0UH23RSS,&var17,&var18,&var19,&var20,&var21,&var22,&var23,&internal1_m17_Nk};
_S_or2  S_or2_75_1 = {&R0EE01LZ1,&R0EE01LZ2,&var24};
_S_period  S_period_55_1 = {&var18,&var7,&iRM_5_,&fEM_R0UL01RSS,&fEM_R0UL02RSS,&fEM_R0UN03RSS,&var25,&internal1_m55_flst,&internal1_m55_chsr,&internal1_m55_chizm,&internal1_m55_sumtim,&internal1_m55_W1,&internal1_m55_W2,&internal1_m55_Wmin,&internal1_m55_Wmax,&internal1_m55_Wlast,&internal1_m55_y0,&internal1_m55_MyFirstEnterFlag};
_S_bol  S_bol_59_1 = {&fEM_R0UL41RSS,&var25,&var26};
_S_bol  S_bol_42_1 = {&var18,&fEM_R0UL52RSS,&var27};
_S_bol  S_bol_37_1 = {&var18,&fEM_R0UL42RSS,&var28};
_S_bol  S_bol_58_1 = {&var18,&fEM_R0UN03RSS,&var29};
_S_bol  S_bol_57_1 = {&fEM_R0UL51RSS,&var25,&var30};
_S_react  S_react_56_1 = {&var25,&var31};
_S_bol  S_bol_47_1 = {&var18,&fEM_R0UR01RSS,&var32};
...
if(getAsBool(idbFirstEnterFlag)==0) InitInternalParametr();
  ...
  setData(idA1VN71LS1,&var32);
  setData(idA1EE01LS1,&var7);
  setData(idR0VN75LZ2,&var16);
  setData(idR0VN71LZ2,&var27);
  setData(idR0IE02LS1,&var24);
  setData(idR0IE01LS1,&var24);
  setData(idR0VN15RS1,&var23);
  setData(idR0VN33RS1,&var22);
  setData(idR0VN23RS1,&var21);
  setData(idR0VN13RS1,&var20);
  setData(idA0EE02LS1,&var19);
  setData(idA0VN71LS1,&var32);
  setData(idR0VN04RS1,&var31);
  setData(idR0VN03RS1,&var17);
  setData(idA0EE01LS1,&var7);
  setData(idR0VN75LZ1,&var16);
  setData(idR0VN65LS1,&var15);
  setData(idR0VN71LZ1,&var27);
  setData(idR0VN61LS1,&var28);
  setData(idR0VN01RS1,&var25);
  setData(idR0VN02RS1,&var18);
