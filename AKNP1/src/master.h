...
#define ttlfa1	BUFFER[407]	// ( - , AKNP1, A1Bz1, A1Bz2) ttlf float
#define idttlfa1	108	// ( - , AKNP1, A1Bz1, A1Bz2) ttlf float
#define vainSBool	BUFFER[412]	// Внутренняя переменная vainSBool
#define idvainSBool	109	// Внутренняя переменная vainSBool
#define vainSFloat	BUFFER[414]	// Внутренняя переменная vainSFloat
#define idvainSFloat	110	// Внутренняя переменная vainSFloat
#define vainSInt	BUFFER[419]	// Внутренняя переменная vainSInt
#define idvainSInt	111	// Внутренняя переменная vainSInt
#define vainSLong	BUFFER[424]	// Внутренняя переменная vainSLong
#define idvainSLong	112	// Внутренняя переменная vainSLong
#define var1	BUFFER[433]	// Внутренняя переменная var1
#define idvar1	113	// Внутренняя переменная var1
#define var10	BUFFER[438]	// Внутренняя переменная var10
#define idvar10	114	// Внутренняя переменная var10
#define var11	BUFFER[440]	// Внутренняя переменная var11
#define idvar11	115	// Внутренняя переменная var11
#define var12	BUFFER[442]	// Внутренняя переменная var12
#define idvar12	116	// Внутренняя переменная var12
#define var13	BUFFER[444]	// Внутренняя переменная var13
#define idvar13	117	// Внутренняя переменная var13
#define var14	BUFFER[446]	// Внутренняя переменная var14
#define idvar14	118	// Внутренняя переменная var14
#define var15	BUFFER[448]	// Внутренняя переменная var15
#define idvar15	119	// Внутренняя переменная var15
#define var16	BUFFER[453]	// Внутренняя переменная var16
#define idvar16	120	// Внутренняя переменная var16
#define var17	BUFFER[458]	// Внутренняя переменная var17
#define idvar17	121	// Внутренняя переменная var17
#define var18	BUFFER[460]	// Внутренняя переменная var18
#define idvar18	122	// Внутренняя переменная var18
#define var19	BUFFER[462]	// Внутренняя переменная var19
#define idvar19	123	// Внутренняя переменная var19
#define var2	BUFFER[467]	// Внутренняя переменная var2
#define idvar2	124	// Внутренняя переменная var2
#define var20	BUFFER[472]	// Внутренняя переменная var20
#define idvar20	125	// Внутренняя переменная var20
#define var21	BUFFER[477]	// Внутренняя переменная var21
#define idvar21	126	// Внутренняя переменная var21
#define var22	BUFFER[479]	// Внутренняя переменная var22
#define idvar22	127	// Внутренняя переменная var22
#define var23	BUFFER[484]	// Внутренняя переменная var23
#define idvar23	128	// Внутренняя переменная var23
#define var24	BUFFER[489]	// Внутренняя переменная var24
#define idvar24	129	// Внутренняя переменная var24
#define var25	BUFFER[494]	// Внутренняя переменная var25
#define idvar25	130	// Внутренняя переменная var25
#define var26	BUFFER[499]	// Внутренняя переменная var26
#define idvar26	131	// Внутренняя переменная var26
#define var27	BUFFER[501]	// Внутренняя переменная var27
#define idvar27	132	// Внутренняя переменная var27
#define var28	BUFFER[506]	// Внутренняя переменная var28
#define idvar28	133	// Внутренняя переменная var28
#define var29	BUFFER[508]	// Внутренняя переменная var29
#define idvar29	134	// Внутренняя переменная var29
#define var3	BUFFER[510]	// Внутренняя переменная var3
#define idvar3	135	// Внутренняя переменная var3
#define var30	BUFFER[515]	// Внутренняя переменная var30
#define idvar30	136	// Внутренняя переменная var30
#define var31	BUFFER[517]	// Внутренняя переменная var31
#define idvar31	137	// Внутренняя переменная var31
#define var32	BUFFER[519]	// Внутренняя переменная var32
#define idvar32	138	// Внутренняя переменная var32
#define var33	BUFFER[521]	// Внутренняя переменная var33
#define idvar33	139	// Внутренняя переменная var33
#define var34	BUFFER[526]	// Внутренняя переменная var34
#define idvar34	140	// Внутренняя переменная var34
#define var4	BUFFER[528]	// Внутренняя переменная var4
#define idvar4	141	// Внутренняя переменная var4
#define var5	BUFFER[533]	// Внутренняя переменная var5
#define idvar5	142	// Внутренняя переменная var5
#define var6	BUFFER[538]	// Внутренняя переменная var6
#define idvar6	143	// Внутренняя переменная var6
#define var7	BUFFER[543]	// Внутренняя переменная var7
#define idvar7	144	// Внутренняя переменная var7
#define var8	BUFFER[548]	// Внутренняя переменная var8
#define idvar8	145	// Внутренняя переменная var8
#define var9	BUFFER[550]	// Внутренняя переменная var9
...
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{108	,8	,1	,&ttlfa1},	//( - , AKNP1, A1Bz1, A1Bz2) ttlf float
	{109	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	{110	,8	,1	,&vainSFloat},	//Внутренняя переменная vainSFloat
	{111	,5	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	{112	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	{113	,8	,1	,&var1},	//Внутренняя переменная var1
	{114	,1	,1	,&var10},	//Внутренняя переменная var10
	{115	,1	,1	,&var11},	//Внутренняя переменная var11
	{116	,1	,1	,&var12},	//Внутренняя переменная var12
	{117	,1	,1	,&var13},	//Внутренняя переменная var13
	{118	,1	,1	,&var14},	//Внутренняя переменная var14
	{119	,5	,1	,&var15},	//Внутренняя переменная var15
	{120	,8	,1	,&var16},	//Внутренняя переменная var16
	{121	,1	,1	,&var17},	//Внутренняя переменная var17
	{122	,1	,1	,&var18},	//Внутренняя переменная var18
	{123	,8	,1	,&var19},	//Внутренняя переменная var19
	{124	,8	,1	,&var2},	//Внутренняя переменная var2
	{125	,8	,1	,&var20},	//Внутренняя переменная var20
	{126	,1	,1	,&var21},	//Внутренняя переменная var21
	{127	,8	,1	,&var22},	//Внутренняя переменная var22
	{128	,8	,1	,&var23},	//Внутренняя переменная var23
	{129	,8	,1	,&var24},	//Внутренняя переменная var24
	{130	,5	,1	,&var25},	//Внутренняя переменная var25
	{131	,1	,1	,&var26},	//Внутренняя переменная var26
	{132	,8	,1	,&var27},	//Внутренняя переменная var27
	{133	,1	,1	,&var28},	//Внутренняя переменная var28
	{134	,1	,1	,&var29},	//Внутренняя переменная var29
	{135	,8	,1	,&var3},	//Внутренняя переменная var3
	{136	,1	,1	,&var30},	//Внутренняя переменная var30
	{137	,1	,1	,&var31},	//Внутренняя переменная var31
	{138	,1	,1	,&var32},	//Внутренняя переменная var32
	{139	,8	,1	,&var33},	//Внутренняя переменная var33
	{140	,1	,1	,&var34},	//Внутренняя переменная var34
	{141	,8	,1	,&var4},	//Внутренняя переменная var4
	{142	,8	,1	,&var5},	//Внутренняя переменная var5
	{143	,8	,1	,&var6},	//Внутренняя переменная var6
	{144	,8	,1	,&var7},	//Внутренняя переменная var7
	{145	,1	,1	,&var8},	//Внутренняя переменная var8
	{146	,1	,1	,&var9},	//Внутренняя переменная var9
	{-1,0,NULL},
};
...
static ModbusRegister ir_AKNP1[]={
	...
	{&ttlfa1,8,18},	//( - , AKNP1, A1Bz1, A1Bz2) ttlf float
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
