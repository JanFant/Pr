...
#define R0IN01FI1	 BUFFER[62]	//(R0IN01FI1) Выход СНМ-11 Гц
#define idR0IN01FI1	 25	//(R0IN01FI1) Выход СНМ-11 Гц
#define R0IN02FS1	 BUFFER[67]	//(R0IN02FS1) Выход КНК15-1 Гц
#define idR0IN02FS1	 26	//(R0IN02FS1) Выход КНК15-1 Гц
#define R0IN03FI1	 BUFFER[72]	//(R0IN03FI1) Выход КНК53М Гц
#define idR0IN03FI1	 27	//(R0IN03FI1) Выход КНК53М Гц
#define R0VN02RS1	 BUFFER[77]	//(R0VN02RS1) Уровень мощности
#define idR0VN02RS1	 28	//(R0VN02RS1) Уровень мощности
#define R0VN01RS1	 BUFFER[82]	//(R0VN01RS1) Период разгона канал1
#define idR0VN01RS1	 29	//(R0VN01RS1) Период разгона канал1
#define R0VN61LS1	 BUFFER[87]	//(R0VN61LS1) ПС по мощности канал1
#define idR0VN61LS1	 30	//(R0VN61LS1) ПС по мощности канал1
#define R0VN71LZ1	 BUFFER[89]	//(R0VN71LZ1) АС по мощности на БАЗ1
#define idR0VN71LZ1	 31	//(R0VN71LZ1) АС по мощности на БАЗ1
#define R0VN65LS1	 BUFFER[91]	//(R0VN65LS1) ПС по периоду разгона канал1
#define idR0VN65LS1	 32	//(R0VN65LS1) ПС по периоду разгона канал1
#define R0VN75LZ1	 BUFFER[93]	//(R0VN75LZ1) АС по периоду разгонана БАЗ1
#define idR0VN75LZ1	 33	//(R0VN75LZ1) АС по периоду разгонана БАЗ1
#define A0EE01LS1	 BUFFER[95]	//(A0EE01LS1) Исправность АКНП1 на БАЗ1
#define idA0EE01LS1	 34	//(A0EE01LS1) Исправность АКНП1 на БАЗ1
#define R0VN03RS1	 BUFFER[97]	//(R0VN03RS1) Измеренный нейтронный поток
#define idR0VN03RS1	 35	//(R0VN03RS1) Измеренный нейтронный поток
#define R0VN04RS1	 BUFFER[102]	//(R0VN04RS1) Реактивность канал1
#define idR0VN04RS1	 36	//(R0VN04RS1) Реактивность канал1
#define A0VN71LS1	 BUFFER[107]	//(A0VN71LS1) Блокировка автоматического  подъёма ББ на БАЗ1
#define idA0VN71LS1	 37	//(A0VN71LS1) Блокировка автоматического  подъёма ББ на БАЗ1
#define A0EE02LS1	 BUFFER[109]	//(A0EE02LS1) Исправность АКНП1 (от сшивки каналов) канал 1
#define idA0EE02LS1	 38	//(A0EE02LS1) Исправность АКНП1 (от сшивки каналов) канал 1
#define R0IE11LS1	 BUFFER[111]	//(R0IE11LS1) Исправность ВИП 1,6 (№8) СНМ11 1 канала
#define idR0IE11LS1	 39	//(R0IE11LS1) Исправность ВИП 1,6 (№8) СНМ11 1 канала
#define R0IE12LS1	 BUFFER[113]	//(R0IE12LS1) Исправность ВИП 0,5 (№9) КНК15-1 1 канала
#define idR0IE12LS1	 40	//(R0IE12LS1) Исправность ВИП 0,5 (№9) КНК15-1 1 канала
#define R0IE13LS1	 BUFFER[115]	//(R0IE13LS1) Исправность ВИП 0,5 (№10) КНК53М 1 канала
#define idR0IE13LS1	 41	//(R0IE13LS1) Исправность ВИП 0,5 (№10) КНК53М 1 канала
#define R0VN13RS1	 BUFFER[117]	//(R0VN13RS1) Нейтронный поток по камере СНМ11
#define idR0VN13RS1	 42	//(R0VN13RS1) Нейтронный поток по камере СНМ11
#define R0VN23RS1	 BUFFER[122]	//(R0VN23RS1) Нейтронный поток по камере КНК15-1
#define idR0VN23RS1	 43	//(R0VN23RS1) Нейтронный поток по камере КНК15-1
#define R0VN33RS1	 BUFFER[127]	//(R0VN33RS1) Нейтронный поток по камере КНК53М
#define idR0VN33RS1	 44	//(R0VN33RS1) Нейтронный поток по камере КНК53М
#define R0VN15RS1	 BUFFER[132]	//(R0VN15RS1) Номер ведущей камеры 1-СНМ-11,2-КНК-15М-1,3-КНК-53М,0-нет ведущей
#define idR0VN15RS1	 45	//(R0VN15RS1) Номер ведущей камеры 1-СНМ-11,2-КНК-15М-1,3-КНК-53М,0-нет ведущей
#define R0IE01LS1	 BUFFER[135]	//(R0IE01LS1) Отключение питание детекторов 1 канала
#define idR0IE01LS1	 46	//(R0IE01LS1) Отключение питание детекторов 1 канала
#define R0IE02LS1	 BUFFER[137]	//(R0IE02LS1) Отключить питание ПР, ПУ 1 канала
#define idR0IE02LS1	 47	//(R0IE02LS1) Отключить питание ПР, ПУ 1 канала
#define R0VN71LZ2	 BUFFER[139]	//(R0VN71LZ2) АС по мощности на БАЗ2
#define idR0VN71LZ2	 48	//(R0VN71LZ2) АС по мощности на БАЗ2
#define R0VN75LZ2	 BUFFER[141]	//(R0VN75LZ2) АС по периоду разгонана БАЗ2
#define idR0VN75LZ2	 49	//(R0VN75LZ2) АС по периоду разгонана БАЗ2
#define A1EE01LS1	 BUFFER[143]	//(A1EE01LS1) Исправность АКНП1 на БАЗ2
#define idA1EE01LS1	 50	//(A1EE01LS1) Исправность АКНП1 на БАЗ2
#define A1VN71LS1	 BUFFER[145]	//(A1VN71LS1) Блокировка автоматического  подъёма ББ на БАЗ2
...
#define R0EE01LZ1	 BUFFER[152]	//(R0EE01LZ1) Питание  АКНП1  отключить
...
#define fEM_R0UR01RSS	 BUFFER[156]	//(R0UR01RSS) Уставка АКНП ПС  АЗ по периоду (сек)
...
#define fEM_R7UX01RSS	 BUFFER[196]	//(R7UX01RSS) X-координата камеры R7IN11
#define idfEM_R7UX01RSS	 63	//(R7UX01RSS) X-координата камеры R7IN11
#define fEM_R7UX02RSS	 BUFFER[201]	//(R7UX02RSS) X-координата камеры R7IN12 (см)
#define idfEM_R7UX02RSS	 64	//(R7UX02RSS) X-координата камеры R7IN12 (см)
#define fEM_R7UX03RSS	 BUFFER[206]	//(R7UX03RSS) X-координата камеры R7IN13 (см)
...
#define fEM_R7UY01RSS	 BUFFER[216]	//(R7UY01RSS) Y-координата камеры R7IN11
#define idfEM_R7UY01RSS	 67	//(R7UY01RSS) Y-координата камеры R7IN11
#define fEM_R7UY02RSS	 BUFFER[221]	//(R7UY02RSS) Y-координата камеры R7IN12 (см)
#define idfEM_R7UY02RSS	 68	//(R7UY02RSS) Y-координата камеры R7IN12 (см)
#define fEM_R7UY03RSS	 BUFFER[226]	//(R7UY03RSS) Y-координата камеры R7IN13 (см)
...
#define fEM_A0UX01RSS	 BUFFER[236]	//(A0UX01RSS) Первый коэффициент калибровки камеры 1
#define idfEM_A0UX01RSS	 71	//(A0UX01RSS) Первый коэффициент калибровки камеры 1
#define fEM_A0UX02RSS	 BUFFER[241]	//(A0UX02RSS) Первый коэффициент калибровки камеры 2
#define idfEM_A0UX02RSS	 72	//(A0UX02RSS) Первый коэффициент калибровки камеры 2
#define fEM_A0UX03RSS	 BUFFER[246]	//(A0UX03RSS) Первый коэффициент калибровки камеры 3
#define idfEM_A0UX03RSS	 73	//(A0UX03RSS) Первый коэффициент калибровки камеры 3
#define fEM_B0UX01RSS	 BUFFER[251]	//(B0UX01RSS) Второй коэффициент калибровки камеры 1
#define idfEM_B0UX01RSS	 74	//(B0UX01RSS) Второй коэффициент калибровки камеры 1
#define fEM_B0UX02RSS	 BUFFER[256]	//(B0UX02RSS) Второй коэффициент калибровки камеры 2
#define idfEM_B0UX02RSS	 75	//(B0UX02RSS) Второй коэффициент калибровки камеры 2
#define fEM_B0UX03RSS	 BUFFER[261]	//(B0UX03RSS) Второй коэффициент калибровки камеры 3
...
static ModbusDevice modbuses[]={
	...
	{0,5004,&coil_DiagnAKNP1[0],&di_DiagnAKNP1[0],&ir_DiagnAKNP1[0],&hr_DiagnAKNP1[0],NULL,NULL,NULL,0},	 //Диагностика корзины АКНП1
...
_S_fsumz  S_fsumz_2_1 = {&var32,&iRM_1_,&var6};
