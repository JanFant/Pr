...
#define var12	BUFFER[407]	// Внутренняя переменная var12
#define idvar12	108	// Внутренняя переменная var12
#define var21	BUFFER[409]	// Внутренняя переменная var21
#define idvar21	109	// Внутренняя переменная var21
#define var24	BUFFER[414]	// Внутренняя переменная var24
#define idvar24	110	// Внутренняя переменная var24
#define var31	BUFFER[419]	// Внутренняя переменная var31
#define idvar31	111	// Внутренняя переменная var31
#define vainSFloat	BUFFER[421]	// Внутренняя переменная vainSFloat
#define idvainSFloat	112	// Внутренняя переменная vainSFloat
#define var9	BUFFER[426]	// Внутренняя переменная var9
#define idvar9	113	// Внутренняя переменная var9
#define var19	BUFFER[428]	// Внутренняя переменная var19
#define idvar19	114	// Внутренняя переменная var19
#define var22	BUFFER[433]	// Внутренняя переменная var22
#define idvar22	115	// Внутренняя переменная var22
#define vainSBool	BUFFER[438]	// Внутренняя переменная vainSBool
#define idvainSBool	116	// Внутренняя переменная vainSBool
#define var5	BUFFER[440]	// Внутренняя переменная var5
#define idvar5	117	// Внутренняя переменная var5
#define var11	BUFFER[445]	// Внутренняя переменная var11
#define idvar11	118	// Внутренняя переменная var11
#define var16	BUFFER[447]	// Внутренняя переменная var16
#define idvar16	119	// Внутренняя переменная var16
#define var30	BUFFER[449]	// Внутренняя переменная var30
#define idvar30	120	// Внутренняя переменная var30
#define var32	BUFFER[451]	// Внутренняя переменная var32
#define idvar32	121	// Внутренняя переменная var32
#define var29	BUFFER[456]	// Внутренняя переменная var29
#define idvar29	122	// Внутренняя переменная var29
#define var7	BUFFER[458]	// Внутренняя переменная var7
...
#define var14	BUFFER[465]	// Внутренняя переменная var14
#define idvar14	125	// Внутренняя переменная var14
#define var17	BUFFER[467]	// Внутренняя переменная var17
#define idvar17	126	// Внутренняя переменная var17
#define var25	BUFFER[469]	// Внутренняя переменная var25
#define idvar25	127	// Внутренняя переменная var25
#define var8	BUFFER[471]	// Внутренняя переменная var8
#define idvar8	128	// Внутренняя переменная var8
#define var23	BUFFER[473]	// Внутренняя переменная var23
#define idvar23	129	// Внутренняя переменная var23
#define var26	BUFFER[478]	// Внутренняя переменная var26
#define idvar26	130	// Внутренняя переменная var26
#define var33	BUFFER[483]	// Внутренняя переменная var33
#define idvar33	131	// Внутренняя переменная var33
#define var4	BUFFER[485]	// Внутренняя переменная var4
#define idvar4	132	// Внутренняя переменная var4
#define var13	BUFFER[490]	// Внутренняя переменная var13
#define idvar13	133	// Внутренняя переменная var13
#define var18	BUFFER[492]	// Внутренняя переменная var18
#define idvar18	134	// Внутренняя переменная var18
#define var27	BUFFER[497]	// Внутренняя переменная var27
#define idvar27	135	// Внутренняя переменная var27
#define var28	BUFFER[499]	// Внутренняя переменная var28
#define idvar28	136	// Внутренняя переменная var28
#define var1	BUFFER[501]	// Внутренняя переменная var1
#define idvar1	137	// Внутренняя переменная var1
#define var20	BUFFER[506]	// Внутренняя переменная var20
#define idvar20	138	// Внутренняя переменная var20
#define vainSLong	BUFFER[508]	// Внутренняя переменная vainSLong
#define idvainSLong	139	// Внутренняя переменная vainSLong
#define var2	BUFFER[517]	// Внутренняя переменная var2
#define idvar2	140	// Внутренняя переменная var2
#define var3	BUFFER[522]	// Внутренняя переменная var3
#define idvar3	141	// Внутренняя переменная var3
#define var6	BUFFER[527]	// Внутренняя переменная var6
#define idvar6	142	// Внутренняя переменная var6
#define var15	BUFFER[532]	// Внутренняя переменная var15
#define idvar15	143	// Внутренняя переменная var15
...
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{108	,1	,1	,&var12},	//Внутренняя переменная var12
	{109	,8	,1	,&var21},	//Внутренняя переменная var21
	{110	,5	,1	,&var24},	//Внутренняя переменная var24
	{111	,1	,1	,&var31},	//Внутренняя переменная var31
	{112	,8	,1	,&vainSFloat},	//Внутренняя переменная vainSFloat
	{113	,1	,1	,&var9},	//Внутренняя переменная var9
	{114	,8	,1	,&var19},	//Внутренняя переменная var19
	{115	,8	,1	,&var22},	//Внутренняя переменная var22
	{116	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	{117	,8	,1	,&var5},	//Внутренняя переменная var5
	{118	,1	,1	,&var11},	//Внутренняя переменная var11
	{119	,1	,1	,&var16},	//Внутренняя переменная var16
	{120	,1	,1	,&var30},	//Внутренняя переменная var30
	{121	,8	,1	,&var32},	//Внутренняя переменная var32
	{122	,1	,1	,&var29},	//Внутренняя переменная var29
	{123	,8	,1	,&var7},	//Внутренняя переменная var7
	{124	,1	,1	,&var10},	//Внутренняя переменная var10
	{125	,1	,1	,&var14},	//Внутренняя переменная var14
	{126	,1	,1	,&var17},	//Внутренняя переменная var17
	{127	,1	,1	,&var25},	//Внутренняя переменная var25
	...
	{131	,1	,1	,&var33},	//Внутренняя переменная var33
	{132	,8	,1	,&var4},	//Внутренняя переменная var4
	{133	,1	,1	,&var13},	//Внутренняя переменная var13
	{134	,8	,1	,&var18},	//Внутренняя переменная var18
	{135	,1	,1	,&var27},	//Внутренняя переменная var27
	{136	,1	,1	,&var28},	//Внутренняя переменная var28
	{137	,8	,1	,&var1},	//Внутренняя переменная var1
	{138	,1	,1	,&var20},	//Внутренняя переменная var20
	{139	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	{140	,8	,1	,&var2},	//Внутренняя переменная var2
	{141	,8	,1	,&var3},	//Внутренняя переменная var3
	{142	,8	,1	,&var6},	//Внутренняя переменная var6
	{143	,5	,1	,&var15},	//Внутренняя переменная var15
