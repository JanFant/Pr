...
#define var24	BUFFER[407]	// Внутренняя переменная var24
#define idvar24	108	// Внутренняя переменная var24
#define var28	BUFFER[412]	// Внутренняя переменная var28
#define idvar28	109	// Внутренняя переменная var28
#define var29	BUFFER[414]	// Внутренняя переменная var29
#define idvar29	110	// Внутренняя переменная var29
#define var3	BUFFER[416]	// Внутренняя переменная var3
#define idvar3	111	// Внутренняя переменная var3
#define var15	BUFFER[421]	// Внутренняя переменная var15
#define idvar15	112	// Внутренняя переменная var15
#define var18	BUFFER[426]	// Внутренняя переменная var18
#define idvar18	113	// Внутренняя переменная var18
#define var19	BUFFER[431]	// Внутренняя переменная var19
#define idvar19	114	// Внутренняя переменная var19
#define var30	BUFFER[436]	// Внутренняя переменная var30
#define idvar30	115	// Внутренняя переменная var30
#define vainSLong	BUFFER[438]	// Внутренняя переменная vainSLong
#define idvainSLong	116	// Внутренняя переменная vainSLong
#define var9	BUFFER[447]	// Внутренняя переменная var9
#define idvar9	117	// Внутренняя переменная var9
#define var14	BUFFER[449]	// Внутренняя переменная var14
...
#define var27	BUFFER[453]	// Внутренняя переменная var27
#define idvar27	120	// Внутренняя переменная var27
#define var5	BUFFER[455]	// Внутренняя переменная var5
#define idvar5	121	// Внутренняя переменная var5
#define var12	BUFFER[460]	// Внутренняя переменная var12
#define idvar12	122	// Внутренняя переменная var12
#define var23	BUFFER[462]	// Внутренняя переменная var23
#define idvar23	123	// Внутренняя переменная var23
#define var31	BUFFER[467]	// Внутренняя переменная var31
#define idvar31	124	// Внутренняя переменная var31
#define vainSBool	BUFFER[469]	// Внутренняя переменная vainSBool
#define idvainSBool	125	// Внутренняя переменная vainSBool
#define var10	BUFFER[471]	// Внутренняя переменная var10
...
#define var16	BUFFER[475]	// Внутренняя переменная var16
#define idvar16	128	// Внутренняя переменная var16
#define vainSFloat	BUFFER[477]	// Внутренняя переменная vainSFloat
#define idvainSFloat	129	// Внутренняя переменная vainSFloat
#define var22	BUFFER[482]	// Внутренняя переменная var22
#define idvar22	130	// Внутренняя переменная var22
#define var25	BUFFER[487]	// Внутренняя переменная var25
#define idvar25	131	// Внутренняя переменная var25
#define vainSInt	BUFFER[489]	// Внутренняя переменная vainSInt
#define idvainSInt	132	// Внутренняя переменная vainSInt
#define var6	BUFFER[494]	// Внутренняя переменная var6
...
#define idvar20	136	// Внутренняя переменная var20
#define var32	BUFFER[508]	// Внутренняя переменная var32
#define idvar32	137	// Внутренняя переменная var32
#define var33	BUFFER[513]	// Внутренняя переменная var33
#define idvar33	138	// Внутренняя переменная var33
#define var2	BUFFER[515]	// Внутренняя переменная var2
...
#define var8	BUFFER[525]	// Внутренняя переменная var8
#define idvar8	141	// Внутренняя переменная var8
#define var26	BUFFER[527]	// Внутренняя переменная var26
#define idvar26	142	// Внутренняя переменная var26
...
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{108	,5	,1	,&var24},	//Внутренняя переменная var24
	{109	,1	,1	,&var28},	//Внутренняя переменная var28
	{110	,1	,1	,&var29},	//Внутренняя переменная var29
	{111	,8	,1	,&var3},	//Внутренняя переменная var3
	{112	,5	,1	,&var15},	//Внутренняя переменная var15
	{113	,8	,1	,&var18},	//Внутренняя переменная var18
	{114	,8	,1	,&var19},	//Внутренняя переменная var19
	{115	,1	,1	,&var30},	//Внутренняя переменная var30
	{116	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	...
	{120	,1	,1	,&var27},	//Внутренняя переменная var27
	{121	,8	,1	,&var5},	//Внутренняя переменная var5
	{122	,1	,1	,&var12},	//Внутренняя переменная var12
	...
	{128	,1	,1	,&var16},	//Внутренняя переменная var16
	{129	,8	,1	,&vainSFloat},	//Внутренняя переменная vainSFloat
	{130	,8	,1	,&var22},	//Внутренняя переменная var22
	{131	,1	,1	,&var25},	//Внутренняя переменная var25
	{132	,5	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	{133	,8	,1	,&var6},	//Внутренняя переменная var6
	{134	,8	,1	,&var7},	//Внутренняя переменная var7
	{135	,1	,1	,&var13},	//Внутренняя переменная var13
	{136	,1	,1	,&var20},	//Внутренняя переменная var20
	...
	{142	,8	,1	,&var26},	//Внутренняя переменная var26
