...
static ModbusRegister ir_AKNP1[]={
	...
	{&R0IN02FS1,8,2},	//( - , AKNP1) Выход КНК15-1 Гц
	{&R0IN03FS1,8,4},	//( - , AKNP1) Выход КНК53М Гц
	{&R0IN01FS1,8,6},	//( - , AKNP1) Выход СНМ-11 Гц
	{&TTLa1,3,8},	//( - , AKNP1) ttl
	{&R0VN15RS1,3,9},	//( - , AKNP1) Номер ведущей камеры 1-СНМ-11,2-КНК-15М-1,3-КНК-53М,0-нет ведущей
	{&R0VN33RS1,8,10},	//( - , AKNP1) Нейтронный поток по камере КНК53М
	{&R0VN23RS1,8,12},	//( - , AKNP1) Нейтронный поток по камере КНК15-1
	{&R0VN13RS1,8,14},	//( - , AKNP1) Нейтронный поток по камере СНМ11
	{&R0VN04RS1,8,16},	//( - , AKNP1) Реактивность канал1
	{&R0VN03RS1,8,18},	//( - , AKNP1) Измеренный нейтронный поток
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
static ModbusRegister hr_AKNP1[]={
	{&R0IN03FV1,8,0},	//( - K01VCHS, AKNP1) Частота с ВЧС к 3
	{&R0IN02FV1,8,2},	//( - K02VCHS, AKNP1) Частота с ВЧС к 2
	{&R0IN01FV1,8,4},	//( - K01VCHS, AKNP1) Частота с ВЧС к 1
	{&fEM_R0UR01RSS,8,6},	//( - , AKNP1) Уставка АКНП ПС  АЗ по периоду (сек)
	{&fEM_R0UL52RSS,8,8},	//( - , AKNP1) Уровень АС по мощности
	{&fEM_R0UL41RSS,8,10},	//( - , AKNP1) Уровень ПС по периоду разгона
	{&fEM_R0UL51RSS,8,12},	//( - , AKNP1) Уровень АС по периоду разгона
	{&fEM_R0UH02RSS,8,14},	//( - , AKNP1) Коэфф. преобразования частота->нейтр/с КНК15-1
	{&fEM_R0UH03RSS,8,16},	//( - , AKNP1) Коэфф. преобразования частота->нейтр/с КНК53М
	{&fEM_R0UL42RSS,8,18},	//( - , AKNP1) Уровень ПС по мощности
	{&fEM_R7UX00RSS,8,20},	//( - , AKNP1) X-координата АЗ1 (см)
	{&fEM_R7UX01RSS,8,22},	//( - , AKNP1) X-координата камеры R7IN11
	{&fEM_R7UX02RSS,8,24},	//( - , AKNP1) X-координата камеры R7IN12 (см)
	{&fEM_R7UX03RSS,8,26},	//( - , AKNP1) X-координата камеры R7IN13 (см)
	{&fEM_R7UY00RSS,8,28},	//( - , AKNP1) Y-координата АЗ1 (см)
	{&fEM_R7UY01RSS,8,30},	//( - , AKNP1) Y-координата камеры R7IN11
	{&fEM_R7UY02RSS,8,32},	//( - , AKNP1) Y-координата камеры R7IN12 (см)
	{&fEM_R7UY03RSS,8,34},	//( - , AKNP1) Y-координата камеры R7IN13 (см)
	{&fEM_A0UX00RSS,8,36},	//( - , AKNP1) Эффективный радиус АЗ
	{&fEM_A0UX01RSS,8,38},	//( - , AKNP1) Первый коэффициент калибровки камеры 1
	{&fEM_A0UX02RSS,8,40},	//( - , AKNP1) Первый коэффициент калибровки камеры 2
	{&fEM_A0UX03RSS,8,42},	//( - , AKNP1) Первый коэффициент калибровки камеры 3
	{&fEM_B0UX01RSS,8,44},	//( - , AKNP1) Второй коэффициент калибровки камеры 1
	{&fEM_B0UX02RSS,8,46},	//( - , AKNP1) Второй коэффициент калибровки камеры 2
	{&fEM_B0UX03RSS,8,48},	//( - , AKNP1) Второй коэффициент калибровки камеры 3
	{&fEM_R0UH05RSS,8,50},	//( - , AKNP1) Кол-во делений/сек на 1 ватт * E^6
	{&fEM_R0UN03RSS,8,52},	//( - , AKNP1) Нижняя граница интервала мощности для измерения периода (ватт)
	{&fEM_R0UL01RSS,8,54},	//( - , AKNP1) Шаг (мс) измерения периода
	{&fEM_R0UL02RSS,8,56},	//( - , AKNP1) Tф-постоянная времени, с
	{&fEM_R0UH01RSS,8,58},	//( - , AKNP1) Коэфф. преобразования частота->нейтр/с СНМ-11
	{&fEM_R0UH21RSS,8,60},	//( - , AKNP1) Верхняя граница измерения частоты импульсов(имп/с) СНМ-11
	{&fEM_R0UH22RSS,8,62},	//( - , AKNP1) Верхняя граница измерения частоты импульсов(имп/с) КНК-15-1
	{&fEM_R0UH23RSS,8,64},	//( - , AKNP1) Верхняя граница измерения частоты импульсов(имп/с) КНК-53М
	{&fEM_R0IN11FN1,8,66},	//( - , AKNP1) Коэффициент А (А1 к 1)
	{&fEM_R0IN12FN1,8,68},	//( - , AKNP1) Коэффициент B (А1 к 1)
	{&fEM_R0IN21FN1,8,70},	//( - , AKNP1) Коэффициент A (А1 к 2)
	{&fEM_R0IN22FN1,8,72},	//( - , AKNP1) Коэффициент B (А1 к 2)
	{&fEM_R0IN31FN1,8,74},	//( - , AKNP1) Коэффициент A (А1 к 3)
	{&fEM_R0IN32FN1,8,76},	//( - , AKNP1) Коэффициент B (А1 к 3)
	{NULL,0,0},
};
#pragma pop
#pragma pack(push,1)
