...
#define B8IC01UDU	 BUFFER[69]	//( - , MA4S) Координата АЗ2 (дел. енк)
#define idB8IC01UDU	 28	//( - , MA4S) Координата АЗ2 (дел. енк)
#define R0VN02RS4	 BUFFER[74]	//( - , A4Bz1, A4Bz2) Уровень мощности канал 4
#define idR0VN02RS4	 29	//( - , A4Bz1, A4Bz2) Уровень мощности канал 4
#define R0VN01RS4	 BUFFER[79]	//( - , A4Bz1, A4Bz2) Период разгона канал 4
#define idR0VN01RS4	 30	//( - , A4Bz1, A4Bz2) Период разгона канал 4
#define R0VN61LS4	 BUFFER[84]	//( - , A4Bz1, A4Bz2) ПС по мощности канал 4
#define idR0VN61LS4	 31	//( - , A4Bz1, A4Bz2) ПС по мощности канал 4
#define R0VN74LZ1	 BUFFER[86]	//(fds16:05 - K09FDSR, - ) АС по мощности канал 4 на БАЗ1
#define idR0VN74LZ1	 32	//(fds16:05 - K09FDSR, - ) АС по мощности канал 4 на БАЗ1
#define R0VN65LS4	 BUFFER[88]	//( - , A4Bz1, A4Bz2) ПС по периоду разгона канал 4
#define idR0VN65LS4	 33	//( - , A4Bz1, A4Bz2) ПС по периоду разгона канал 4
#define R0VN78LZ1	 BUFFER[90]	//(fds16:05 - K10FDSR, - ) АС по периоду разгона канал 4 на БАЗ1
#define idR0VN78LZ1	 34	//(fds16:05 - K10FDSR, - ) АС по периоду разгона канал 4 на БАЗ1
#define A0EE01LS4	 BUFFER[92]	//(fds16:05 - K11FDSR, - ) Исправность АКНП канал 4 на БАЗ1
#define idA0EE01LS4	 35	//(fds16:05 - K11FDSR, - ) Исправность АКНП канал 4 на БАЗ1
#define R0IN01FS4	 BUFFER[94]	//(vchs:01 - K01VCHS, AKNP4) Выход СНМ-11 Гц
#define idR0IN01FS4	 36	//(vchs:01 - K01VCHS, AKNP4) Выход СНМ-11 Гц
#define R0IN02FI4	 BUFFER[99]	//( - , MA4S) Выход КНК15-1 Гц
#define idR0IN02FI4	 37	//( - , MA4S) Выход КНК15-1 Гц
#define R0VN03RS4	 BUFFER[104]	//( - , AKNP4) Измеренный нейтронный поток канал 4
#define idR0VN03RS4	 38	//( - , AKNP4) Измеренный нейтронный поток канал 4
#define R0VN04RS4	 BUFFER[109]	//( - , AKNP4) Реактивность канал 4
#define idR0VN04RS4	 39	//( - , AKNP4) Реактивность канал 4
#define A1VN71LS4	 BUFFER[114]	//(fds16:05 - K16FDSR, - ) Блокировка автоматического  подъёма ББ канал 4 на БАЗ2
#define idA1VN71LS4	 40	//(fds16:05 - K16FDSR, - ) Блокировка автоматического  подъёма ББ канал 4 на БАЗ2
#define R0IN03FS4	 BUFFER[116]	//(vchs:02 - K01VCHS, AKNP4) Выход КНК53М Гц
#define idR0IN03FS4	 41	//(vchs:02 - K01VCHS, AKNP4) Выход КНК53М Гц
#define A0EE02LS4	 BUFFER[121]	//( - , AKNP4) Исправность АКНП4 (от сшивки каналов) канал 4
#define idA0EE02LS4	 42	//( - , AKNP4) Исправность АКНП4 (от сшивки каналов) канал 4
#define R0IE11LS4	 BUFFER[123]	//(vds32:04 - K01VDSR, - ) Исправность ВИП 1,6 (№17) СНМ11 4 канала
#define idR0IE11LS4	 43	//(vds32:04 - K01VDSR, - ) Исправность ВИП 1,6 (№17) СНМ11 4 канала
#define R0IE12LS4	 BUFFER[125]	//(vds32:04 - K02VDSR, - ) Исправность ВИП 0,5 (№18) КНК15-1 4 канала
#define idR0IE12LS4	 44	//(vds32:04 - K02VDSR, - ) Исправность ВИП 0,5 (№18) КНК15-1 4 канала
#define R0IE13LS4	 BUFFER[127]	//(vds32:04 - K03VDSR, - ) Исправность ВИП 0,5 (№19) КНК53М 4 канала
#define idR0IE13LS4	 45	//(vds32:04 - K03VDSR, - ) Исправность ВИП 0,5 (№19) КНК53М 4 канала
#define R0VN13RS4	 BUFFER[129]	//( - , AKNP4) Нейтронный поток по камере СНМ11 канал 4
#define idR0VN13RS4	 46	//( - , AKNP4) Нейтронный поток по камере СНМ11 канал 4
#define R0VN23RS4	 BUFFER[134]	//( - , AKNP4) Нейтронный поток по камере КНК15-1 канал 4
#define idR0VN23RS4	 47	//( - , AKNP4) Нейтронный поток по камере КНК15-1 канал 4
#define R0VN33RS4	 BUFFER[139]	//( - , AKNP4) Нейтронный поток по камере КНК53М канал 4
#define idR0VN33RS4	 48	//( - , AKNP4) Нейтронный поток по камере КНК53М канал 4
#define R0VN15RS4	 BUFFER[144]	//( - , AKNP4) Номер ведущей камеры канал 4
#define idR0VN15RS4	 49	//( - , AKNP4) Номер ведущей камеры канал 4
#define R0IE01LS4	 BUFFER[147]	//(fds16:05 - K02FDSR, - ) Отключение питание детекторов канал 4
#define idR0IE01LS4	 50	//(fds16:05 - K02FDSR, - ) Отключение питание детекторов канал 4
#define R0IE02LS4	 BUFFER[149]	//(fds16:05 - K01FDSR, - ) Отключить питание ПР, ПУ канал 4
#define idR0IE02LS4	 51	//(fds16:05 - K01FDSR, - ) Отключить питание ПР, ПУ канал 4
#define A0VN71LS4	 BUFFER[151]	//(fds16:05 - K12FDSR, - ) Блокировка автоматического  подъёма ББ канал 4 на БАЗ1
#define idA0VN71LS4	 52	//(fds16:05 - K12FDSR, - ) Блокировка автоматического  подъёма ББ канал 4 на БАЗ1
#define R0VN74LZ2	 BUFFER[153]	//(fds16:05 - K13FDSR, - ) АС по мощности канал 4 на БАЗ2
#define idR0VN74LZ2	 53	//(fds16:05 - K13FDSR, - ) АС по мощности канал 4 на БАЗ2
#define R0VN78LZ2	 BUFFER[155]	//(fds16:05 - K14FDSR, - ) АС по периоду разгона канал 4 на БАЗ2
#define idR0VN78LZ2	 54	//(fds16:05 - K14FDSR, - ) АС по периоду разгона канал 4 на БАЗ2
#define A1EE01LS4	 BUFFER[157]	//(fds16:05 - K15FDSR, - ) Исправность АКНП канал 4 на БАЗ2
#define idA1EE01LS4	 55	//(fds16:05 - K15FDSR, - ) Исправность АКНП канал 4 на БАЗ2
#define B8VC01RDU	 BUFFER[159]	//( - , AKNP4) Координата АЗ2, мм
#define idB8VC01RDU	 56	//( - , AKNP4) Координата АЗ2, мм
...
#define fEM_R7UY00RSS	 BUFFER[204]	//(R7UY00RSS) Y-координата АЗ1 (см)
#define idfEM_R7UY00RSS	 65	//(R7UY00RSS) Y-координата АЗ1 (см)
#define fEM_R7UX10RSS	 BUFFER[209]	//(R7UX10RSS) X-координата камеры R7IN41
#define idfEM_R7UX10RSS	 66	//(R7UX10RSS) X-координата камеры R7IN41
#define fEM_R7UX11RSS	 BUFFER[214]	//(R7UX11RSS) X-координата камеры R7IN42
#define idfEM_R7UX11RSS	 67	//(R7UX11RSS) X-координата камеры R7IN42
#define fEM_R7UX12RSS	 BUFFER[219]	//(R7UX12RSS) X-координата камеры R7IN43
#define idfEM_R7UX12RSS	 68	//(R7UX12RSS) X-координата камеры R7IN43
#define fEM_R7UY10RSS	 BUFFER[224]	//(R7UY10RSS) Y-координата камеры R7IN41
#define idfEM_R7UY10RSS	 69	//(R7UY10RSS) Y-координата камеры R7IN41
#define fEM_R7UY11RSS	 BUFFER[229]	//(R7UY11RSS) Y-координата камеры R7IN42
#define idfEM_R7UY11RSS	 70	//(R7UY11RSS) Y-координата камеры R7IN42
#define fEM_R7UY12RSS	 BUFFER[234]	//(R7UY12RSS) Y-координата камеры R7IN43
#define idfEM_R7UY12RSS	 71	//(R7UY12RSS) Y-координата камеры R7IN43
#define fEM_A0UX00RSS	 BUFFER[239]	//(A0UX00RSS) Эффективный радиус АЗ
#define idfEM_A0UX00RSS	 72	//(A0UX00RSS) Эффективный радиус АЗ
#define fEM_A0UX10RSS	 BUFFER[244]	//(A0UX10RSS) Первый коэффициент калибровки камеры 10
#define idfEM_A0UX10RSS	 73	//(A0UX10RSS) Первый коэффициент калибровки камеры 10
#define fEM_A0UX11RSS	 BUFFER[249]	//(A0UX11RSS) Первый коэффициент калибровки камеры 11
#define idfEM_A0UX11RSS	 74	//(A0UX11RSS) Первый коэффициент калибровки камеры 11
#define fEM_A0UX12RSS	 BUFFER[254]	//(A0UX12RSS) Первый коэффициент калибровки камеры 12
#define idfEM_A0UX12RSS	 75	//(A0UX12RSS) Первый коэффициент калибровки камеры 12
#define fEM_B0UX10RSS	 BUFFER[259]	//(B0UX10RSS) Второй коэффициент калибровки камеры 10
#define idfEM_B0UX10RSS	 76	//(B0UX10RSS) Второй коэффициент калибровки камеры 10
#define fEM_B0UX11RSS	 BUFFER[264]	//(B0UX11RSS) Второй коэффициент калибровки камеры 11
#define idfEM_B0UX11RSS	 77	//(B0UX11RSS) Второй коэффициент калибровки камеры 11
#define fEM_B0UX12RSS	 BUFFER[269]	//(B0UX12RSS) Второй коэффициент калибровки камеры 12
#define idfEM_B0UX12RSS	 78	//(B0UX12RSS) Второй коэффициент калибровки камеры 12
...
#define lEM_EE01LS4	 BUFFER[292]	//(EE01LS4) Исправность АКНП4
#define idlEM_EE01LS4	 83	//(EE01LS4) Исправность АКНП4
#define bFirstEnterFlag	 BUFFER[294]	//(bFirstEnterFlag) 
#define idbFirstEnterFlag	 84	//(bFirstEnterFlag) 
#define internal1_m22_Nk	 BUFFER[296]	//(internal1_m22_Nk) Nk - ведущая камера
#define idinternal1_m22_Nk	 85	//(internal1_m22_Nk) Nk - ведущая камера
...
static VarCtrl allVariables[]={      // Описание всех переменных
	...
	{ 28	,5	,1	, &B8IC01UDU},	//( - , MA4S) Координата АЗ2 (дел. енк)
	{ 29	,8	,1	, &R0VN02RS4},	//( - , A4Bz1, A4Bz2) Уровень мощности канал 4
	{ 30	,8	,1	, &R0VN01RS4},	//( - , A4Bz1, A4Bz2) Период разгона канал 4
	{ 31	,1	,1	, &R0VN61LS4},	//( - , A4Bz1, A4Bz2) ПС по мощности канал 4
	{ 32	,1	,1	, &R0VN74LZ1},	//(fds16:05 - K09FDSR, - ) АС по мощности канал 4 на БАЗ1
	{ 33	,1	,1	, &R0VN65LS4},	//( - , A4Bz1, A4Bz2) ПС по периоду разгона канал 4
	{ 34	,1	,1	, &R0VN78LZ1},	//(fds16:05 - K10FDSR, - ) АС по периоду разгона канал 4 на БАЗ1
	{ 35	,1	,1	, &A0EE01LS4},	//(fds16:05 - K11FDSR, - ) Исправность АКНП канал 4 на БАЗ1
	{ 36	,8	,1	, &R0IN01FS4},	//(vchs:01 - K01VCHS, AKNP4) Выход СНМ-11 Гц
	{ 37	,8	,1	, &R0IN02FI4},	//( - , MA4S) Выход КНК15-1 Гц
	{ 38	,8	,1	, &R0VN03RS4},	//( - , AKNP4) Измеренный нейтронный поток канал 4
	{ 39	,8	,1	, &R0VN04RS4},	//( - , AKNP4) Реактивность канал 4
	{ 40	,1	,1	, &A1VN71LS4},	//(fds16:05 - K16FDSR, - ) Блокировка автоматического  подъёма ББ канал 4 на БАЗ2
	{ 41	,8	,1	, &R0IN03FS4},	//(vchs:02 - K01VCHS, AKNP4) Выход КНК53М Гц
	{ 42	,1	,1	, &A0EE02LS4},	//( - , AKNP4) Исправность АКНП4 (от сшивки каналов) канал 4
	{ 43	,1	,1	, &R0IE11LS4},	//(vds32:04 - K01VDSR, - ) Исправность ВИП 1,6 (№17) СНМ11 4 канала
	{ 44	,1	,1	, &R0IE12LS4},	//(vds32:04 - K02VDSR, - ) Исправность ВИП 0,5 (№18) КНК15-1 4 канала
	{ 45	,1	,1	, &R0IE13LS4},	//(vds32:04 - K03VDSR, - ) Исправность ВИП 0,5 (№19) КНК53М 4 канала
	{ 46	,8	,1	, &R0VN13RS4},	//( - , AKNP4) Нейтронный поток по камере СНМ11 канал 4
	{ 47	,8	,1	, &R0VN23RS4},	//( - , AKNP4) Нейтронный поток по камере КНК15-1 канал 4
	{ 48	,8	,1	, &R0VN33RS4},	//( - , AKNP4) Нейтронный поток по камере КНК53М канал 4
	{ 49	,3	,1	, &R0VN15RS4},	//( - , AKNP4) Номер ведущей камеры канал 4
	{ 50	,1	,1	, &R0IE01LS4},	//(fds16:05 - K02FDSR, - ) Отключение питание детекторов канал 4
	{ 51	,1	,1	, &R0IE02LS4},	//(fds16:05 - K01FDSR, - ) Отключить питание ПР, ПУ канал 4
	{ 52	,1	,1	, &A0VN71LS4},	//(fds16:05 - K12FDSR, - ) Блокировка автоматического  подъёма ББ канал 4 на БАЗ1
	{ 53	,1	,1	, &R0VN74LZ2},	//(fds16:05 - K13FDSR, - ) АС по мощности канал 4 на БАЗ2
	{ 54	,1	,1	, &R0VN78LZ2},	//(fds16:05 - K14FDSR, - ) АС по периоду разгона канал 4 на БАЗ2
	{ 55	,1	,1	, &A1EE01LS4},	//(fds16:05 - K15FDSR, - ) Исправность АКНП канал 4 на БАЗ2
	{ 56	,8	,1	, &B8VC01RDU},	//( - , AKNP4) Координата АЗ2, мм
	...
	{ 65	,8	,1	, &fEM_R7UY00RSS},	//(R7UY00RSS) Y-координата АЗ1 (см)
	{ 66	,8	,1	, &fEM_R7UX10RSS},	//(R7UX10RSS) X-координата камеры R7IN41
	{ 67	,8	,1	, &fEM_R7UX11RSS},	//(R7UX11RSS) X-координата камеры R7IN42
	{ 68	,8	,1	, &fEM_R7UX12RSS},	//(R7UX12RSS) X-координата камеры R7IN43
	{ 69	,8	,1	, &fEM_R7UY10RSS},	//(R7UY10RSS) Y-координата камеры R7IN41
	{ 70	,8	,1	, &fEM_R7UY11RSS},	//(R7UY11RSS) Y-координата камеры R7IN42
	{ 71	,8	,1	, &fEM_R7UY12RSS},	//(R7UY12RSS) Y-координата камеры R7IN43
	{ 72	,8	,1	, &fEM_A0UX00RSS},	//(A0UX00RSS) Эффективный радиус АЗ
	{ 73	,8	,1	, &fEM_A0UX10RSS},	//(A0UX10RSS) Первый коэффициент калибровки камеры 10
	{ 74	,8	,1	, &fEM_A0UX11RSS},	//(A0UX11RSS) Первый коэффициент калибровки камеры 11
	{ 75	,8	,1	, &fEM_A0UX12RSS},	//(A0UX12RSS) Первый коэффициент калибровки камеры 12
	{ 76	,8	,1	, &fEM_B0UX10RSS},	//(B0UX10RSS) Второй коэффициент калибровки камеры 10
	{ 77	,8	,1	, &fEM_B0UX11RSS},	//(B0UX11RSS) Второй коэффициент калибровки камеры 11
	{ 78	,8	,1	, &fEM_B0UX12RSS},	//(B0UX12RSS) Второй коэффициент калибровки камеры 12
	...
	{ 83	,1	,1	, &lEM_EE01LS4},	//(EE01LS4) Исправность АКНП4
	{ 84	,1	,1	, &bFirstEnterFlag},	//(bFirstEnterFlag) 
	{ 85	,3	,1	, &internal1_m22_Nk},	//(internal1_m22_Nk) Nk - ведущая камера
...
static ModbusRegister ir_MA4S[]={  // 
	...
	{&R0IN01FI4,8,2},	//( - , SA4) Выход СНМ-11 Гц от ПТИ
	{&R0IN02FI4,8,4},	//( - , SA4) Выход КНК15-1 Гц от ПТИ
	{&R0IN03FI4,8,6},	//( - , SA4) Выход КНК53М Гц от ПТИ
