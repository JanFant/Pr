...
/* Объявление структур */
_S_and5  S_and5_63_1 = {&R0IE12LS4,&R0IE13LS4,&R0IE11LS4,&A0EE03LS4,&var6,&var1};
_S_and2  S_and2_54_1 = {&var16,&var17,&var2};
_S_and2  S_and2_55_1 = {&var16,&var13,&var3};
_S_ocham  S_ocham_15_1 = {&R0IN01FS4,&R0IN02FS4,&R0IN03FS4,&B8VC01RDU,&fEM_R7UX00RSS,&fEM_R7UY00RSS,&fEM_A0UX00RSS,&fEM_A0UX10RSS,&fEM_B0UX10RSS,&fEM_A0UX11RSS,&fEM_B0UX11RSS,&fEM_A0UX12RSS,&fEM_B0UX12RSS,&fEM_R7UX10RSS,&fEM_R7UY10RSS,&fEM_R7UX11RSS,&fEM_R7UY11RSS,&fEM_R7UX12RSS,&fEM_R7UY12RSS,&bRM_1_,&fRM_2_0,&fEM_R0UH02RSS,&fEM_R0UH03RSS,&fEM_R0UH05RSS,&var4,&var5,&var6,&var7,&var8,&var9,&var10,&internal1_m15_Nk};
_S_or2  S_or2_65_1 = {&R0EE04LZ1,&R0EE04LZ2,&var11};
...
if(getAsBool(idbFirstEnterFlag)==0) InitInternalParametr();
  ...
  and2(&S_and2_55_1);
  and2(&S_and2_54_1);
  setData(idA1EE01LS4,&var1);
  setData(idR0VN78LZ2,&var2);
  setData(idR0VN74LZ2,&var14);
  setData(idA0VN71LS4,&var19);
  setData(idR0IE02LS4,&var11);
  setData(idR0IE01LS4,&var11);
  setData(idR0VN15RS4,&var10);
  setData(idR0VN33RS4,&var9);
  setData(idR0VN23RS4,&var8);
  setData(idR0VN13RS4,&var7);
  setData(idA0EE02LS4,&var6);
  setData(idA1VN71LS4,&var19);
  setData(idR0VN04RS4,&var18);
  setData(idR0VN03RS4,&var4);
  setData(idA0EE01LS4,&var1);
  setData(idR0VN78LZ1,&var2);
  setData(idR0VN65LS4,&var3);
  setData(idR0VN74LZ1,&var14);
  setData(idR0VN61LS4,&var15);
  setData(idR0VN01RS4,&var12);
  setData(idR0VN02RS4,&var5);
