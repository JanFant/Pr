...
#define R0DE3ALS4	 BUFFER[45]	//(R0DE3ALS4) диагностика шкафа АКНП4 БП5/24Д место 5
#define idR0DE3ALS4	 20	//(R0DE3ALS4) диагностика шкафа АКНП4 БП5/24Д место 5
#define R0DE3BLS4	 BUFFER[47]	//(R0DE3BLS4) диагностика шкафа АКНП4 БП5/24Д место 6
#define idR0DE3BLS4	 21	//(R0DE3BLS4) диагностика шкафа АКНП4 БП5/24Д место 6
#define R0DE3CLS4	 BUFFER[49]	//(R0DE3CLS4) диагностика шкафа АКНП4 БП5/24Д место 7
#define idR0DE3CLS4	 22	//(R0DE3CLS4) диагностика шкафа АКНП4 БП5/24Д место 7
#define R0DE3DLS4	 BUFFER[51]	//(R0DE3DLS4) диагностика шкафа АКНП4 БП5/24Д место 8
#define idR0DE3DLS4	 23	//(R0DE3DLS4) диагностика шкафа АКНП4 БП5/24Д место 8
#define TTLaknp4	 BUFFER[53]	//(TTLaknp4) ttl
#define idTTLaknp4	 24	//(TTLaknp4) ttl
#define TestDiagnAKNP4	 BUFFER[56]	//(TestDiagnAKNP4) Неисправность от диагностики
#define idTestDiagnAKNP4	 25	//(TestDiagnAKNP4) Неисправность от диагностики
#define R0VN02RS4	 BUFFER[58]	//(R0VN02RS4) Уровень мощности канал 4
#define idR0VN02RS4	 26	//(R0VN02RS4) Уровень мощности канал 4
#define R0VN01RS4	 BUFFER[63]	//(R0VN01RS4) Период разгона канал 4
#define idR0VN01RS4	 27	//(R0VN01RS4) Период разгона канал 4
#define R0VN61LS4	 BUFFER[68]	//(R0VN61LS4) ПС по мощности канал 4
#define idR0VN61LS4	 28	//(R0VN61LS4) ПС по мощности канал 4
#define R0VN74LZ1	 BUFFER[70]	//(R0VN74LZ1) АС по мощности канал 4 на БАЗ1
#define idR0VN74LZ1	 29	//(R0VN74LZ1) АС по мощности канал 4 на БАЗ1
#define R0VN65LS4	 BUFFER[72]	//(R0VN65LS4) ПС по периоду разгона канал 4
#define idR0VN65LS4	 30	//(R0VN65LS4) ПС по периоду разгона канал 4
#define R0VN78LZ1	 BUFFER[74]	//(R0VN78LZ1) АС по периоду разгона канал 4 на БАЗ1
#define idR0VN78LZ1	 31	//(R0VN78LZ1) АС по периоду разгона канал 4 на БАЗ1
#define A0EE01LS4	 BUFFER[76]	//(A0EE01LS4) Исправность АКНП канал 4 на БАЗ1
#define idA0EE01LS4	 32	//(A0EE01LS4) Исправность АКНП канал 4 на БАЗ1
#define R0IN01FS4	 BUFFER[78]	//(R0IN01FS4) Выход СНМ-11 Гц
#define idR0IN01FS4	 33	//(R0IN01FS4) Выход СНМ-11 Гц
#define R0IN02FS4	 BUFFER[83]	//(R0IN02FS4) Выход КНК15-1 Гц
#define idR0IN02FS4	 34	//(R0IN02FS4) Выход КНК15-1 Гц
#define R0VN03RS4	 BUFFER[88]	//(R0VN03RS4) Измеренный нейтронный поток канал 4
#define idR0VN03RS4	 35	//(R0VN03RS4) Измеренный нейтронный поток канал 4
#define R0VN04RS4	 BUFFER[93]	//(R0VN04RS4) Реактивность канал 4
#define idR0VN04RS4	 36	//(R0VN04RS4) Реактивность канал 4
#define A1VN71LS4	 BUFFER[98]	//(A1VN71LS4) Блокировка автоматического  подъёма ББ канал 4 на БАЗ2
#define idA1VN71LS4	 37	//(A1VN71LS4) Блокировка автоматического  подъёма ББ канал 4 на БАЗ2
#define R0IN03FS4	 BUFFER[100]	//(R0IN03FS4) Выход КНК53М Гц
#define idR0IN03FS4	 38	//(R0IN03FS4) Выход КНК53М Гц
#define A0EE02LS4	 BUFFER[105]	//(A0EE02LS4) Исправность АКНП4 (от сшивки каналов) канал 4
#define idA0EE02LS4	 39	//(A0EE02LS4) Исправность АКНП4 (от сшивки каналов) канал 4
#define R0IE11LS4	 BUFFER[107]	//(R0IE11LS4) Исправность ВИП 1,6 (№17) СНМ11 4 канала
#define idR0IE11LS4	 40	//(R0IE11LS4) Исправность ВИП 1,6 (№17) СНМ11 4 канала
#define R0IE12LS4	 BUFFER[109]	//(R0IE12LS4) Исправность ВИП 0,5 (№18) КНК15-1 4 канала
#define idR0IE12LS4	 41	//(R0IE12LS4) Исправность ВИП 0,5 (№18) КНК15-1 4 канала
#define R0IE13LS4	 BUFFER[111]	//(R0IE13LS4) Исправность ВИП 0,5 (№19) КНК53М 4 канала
#define idR0IE13LS4	 42	//(R0IE13LS4) Исправность ВИП 0,5 (№19) КНК53М 4 канала
#define R0VN13RS4	 BUFFER[113]	//(R0VN13RS4) Нейтронный поток по камере СНМ11 канал 4
#define idR0VN13RS4	 43	//(R0VN13RS4) Нейтронный поток по камере СНМ11 канал 4
#define R0VN23RS4	 BUFFER[118]	//(R0VN23RS4) Нейтронный поток по камере КНК15-1 канал 4
#define idR0VN23RS4	 44	//(R0VN23RS4) Нейтронный поток по камере КНК15-1 канал 4
#define R0VN33RS4	 BUFFER[123]	//(R0VN33RS4) Нейтронный поток по камере КНК53М канал 4
#define idR0VN33RS4	 45	//(R0VN33RS4) Нейтронный поток по камере КНК53М канал 4
#define R0VN15RS4	 BUFFER[128]	//(R0VN15RS4) Номер ведущей камеры канал 4
#define idR0VN15RS4	 46	//(R0VN15RS4) Номер ведущей камеры канал 4
#define A0EE03LS4	 BUFFER[131]	//(A0EE03LS4) Подключена сеть питания АКНП канал 4
#define idA0EE03LS4	 47	//(A0EE03LS4) Подключена сеть питания АКНП канал 4
#define R0IE01LS4	 BUFFER[133]	//(R0IE01LS4) Отключение питание детекторов канал 4
#define idR0IE01LS4	 48	//(R0IE01LS4) Отключение питание детекторов канал 4
#define R0IE02LS4	 BUFFER[135]	//(R0IE02LS4) Отключить питание ПР, ПУ канал 4
#define idR0IE02LS4	 49	//(R0IE02LS4) Отключить питание ПР, ПУ канал 4
#define A0VN71LS4	 BUFFER[137]	//(A0VN71LS4) Блокировка автоматического  подъёма ББ канал 4 на БАЗ1
#define idA0VN71LS4	 50	//(A0VN71LS4) Блокировка автоматического  подъёма ББ канал 4 на БАЗ1
...
#define fEM_R7UY00RSS	 BUFFER[179]	//(R7UY00RSS) Y-координата АЗ1 (см)
#define idfEM_R7UY00RSS	 59	//(R7UY00RSS) Y-координата АЗ1 (см)
#define fEM_R7UX10RSS	 BUFFER[184]	//(R7UX10RSS) X-координата камеры R7IN41
#define idfEM_R7UX10RSS	 60	//(R7UX10RSS) X-координата камеры R7IN41
#define fEM_R7UX11RSS	 BUFFER[189]	//(R7UX11RSS) X-координата камеры R7IN42
#define idfEM_R7UX11RSS	 61	//(R7UX11RSS) X-координата камеры R7IN42
#define fEM_R7UX12RSS	 BUFFER[194]	//(R7UX12RSS) X-координата камеры R7IN43
#define idfEM_R7UX12RSS	 62	//(R7UX12RSS) X-координата камеры R7IN43
#define fEM_R7UY10RSS	 BUFFER[199]	//(R7UY10RSS) Y-координата камеры R7IN41
#define idfEM_R7UY10RSS	 63	//(R7UY10RSS) Y-координата камеры R7IN41
#define fEM_R7UY11RSS	 BUFFER[204]	//(R7UY11RSS) Y-координата камеры R7IN42
#define idfEM_R7UY11RSS	 64	//(R7UY11RSS) Y-координата камеры R7IN42
#define fEM_R7UY12RSS	 BUFFER[209]	//(R7UY12RSS) Y-координата камеры R7IN43
#define idfEM_R7UY12RSS	 65	//(R7UY12RSS) Y-координата камеры R7IN43
#define fEM_A0UX00RSS	 BUFFER[214]	//(A0UX00RSS) Эффективный радиус АЗ
#define idfEM_A0UX00RSS	 66	//(A0UX00RSS) Эффективный радиус АЗ
#define fEM_A0UX10RSS	 BUFFER[219]	//(A0UX10RSS) Первый коэффициент калибровки камеры 10
#define idfEM_A0UX10RSS	 67	//(A0UX10RSS) Первый коэффициент калибровки камеры 10
#define fEM_A0UX11RSS	 BUFFER[224]	//(A0UX11RSS) Первый коэффициент калибровки камеры 11
#define idfEM_A0UX11RSS	 68	//(A0UX11RSS) Первый коэффициент калибровки камеры 11
#define fEM_A0UX12RSS	 BUFFER[229]	//(A0UX12RSS) Первый коэффициент калибровки камеры 12
#define idfEM_A0UX12RSS	 69	//(A0UX12RSS) Первый коэффициент калибровки камеры 12
#define fEM_B0UX10RSS	 BUFFER[234]	//(B0UX10RSS) Второй коэффициент калибровки камеры 10
#define idfEM_B0UX10RSS	 70	//(B0UX10RSS) Второй коэффициент калибровки камеры 10
#define fEM_B0UX11RSS	 BUFFER[239]	//(B0UX11RSS) Второй коэффициент калибровки камеры 11
#define idfEM_B0UX11RSS	 71	//(B0UX11RSS) Второй коэффициент калибровки камеры 11
#define fEM_B0UX12RSS	 BUFFER[244]	//(B0UX12RSS) Второй коэффициент калибровки камеры 12
#define idfEM_B0UX12RSS	 72	//(B0UX12RSS) Второй коэффициент калибровки камеры 12
...
static VarCtrl allVariables[]={      // Описание всех переменных
	...
	{ 20	,1	,1	, &R0DE3ALS4},	//(R0DE3ALS4) диагностика шкафа АКНП4 БП5/24Д место 5
	{ 21	,1	,1	, &R0DE3BLS4},	//(R0DE3BLS4) диагностика шкафа АКНП4 БП5/24Д место 6
	{ 22	,1	,1	, &R0DE3CLS4},	//(R0DE3CLS4) диагностика шкафа АКНП4 БП5/24Д место 7
	{ 23	,1	,1	, &R0DE3DLS4},	//(R0DE3DLS4) диагностика шкафа АКНП4 БП5/24Д место 8
	{ 24	,3	,1	, &TTLaknp4},	//(TTLaknp4) ttl
	{ 25	,1	,1	, &TestDiagnAKNP4},	//(TestDiagnAKNP4) Неисправность от диагностики
	{ 26	,8	,1	, &R0VN02RS4},	//(R0VN02RS4) Уровень мощности канал 4
	{ 27	,8	,1	, &R0VN01RS4},	//(R0VN01RS4) Период разгона канал 4
	{ 28	,1	,1	, &R0VN61LS4},	//(R0VN61LS4) ПС по мощности канал 4
	{ 29	,1	,1	, &R0VN74LZ1},	//(R0VN74LZ1) АС по мощности канал 4 на БАЗ1
	{ 30	,1	,1	, &R0VN65LS4},	//(R0VN65LS4) ПС по периоду разгона канал 4
	{ 31	,1	,1	, &R0VN78LZ1},	//(R0VN78LZ1) АС по периоду разгона канал 4 на БАЗ1
	{ 32	,1	,1	, &A0EE01LS4},	//(A0EE01LS4) Исправность АКНП канал 4 на БАЗ1
	{ 33	,8	,1	, &R0IN01FS4},	//(R0IN01FS4) Выход СНМ-11 Гц
	{ 34	,8	,1	, &R0IN02FS4},	//(R0IN02FS4) Выход КНК15-1 Гц
	{ 35	,8	,1	, &R0VN03RS4},	//(R0VN03RS4) Измеренный нейтронный поток канал 4
	{ 36	,8	,1	, &R0VN04RS4},	//(R0VN04RS4) Реактивность канал 4
	{ 37	,1	,1	, &A1VN71LS4},	//(A1VN71LS4) Блокировка автоматического  подъёма ББ канал 4 на БАЗ2
	{ 38	,8	,1	, &R0IN03FS4},	//(R0IN03FS4) Выход КНК53М Гц
	{ 39	,1	,1	, &A0EE02LS4},	//(A0EE02LS4) Исправность АКНП4 (от сшивки каналов) канал 4
	{ 40	,1	,1	, &R0IE11LS4},	//(R0IE11LS4) Исправность ВИП 1,6 (№17) СНМ11 4 канала
	{ 41	,1	,1	, &R0IE12LS4},	//(R0IE12LS4) Исправность ВИП 0,5 (№18) КНК15-1 4 канала
	{ 42	,1	,1	, &R0IE13LS4},	//(R0IE13LS4) Исправность ВИП 0,5 (№19) КНК53М 4 канала
	{ 43	,8	,1	, &R0VN13RS4},	//(R0VN13RS4) Нейтронный поток по камере СНМ11 канал 4
	{ 44	,8	,1	, &R0VN23RS4},	//(R0VN23RS4) Нейтронный поток по камере КНК15-1 канал 4
	{ 45	,8	,1	, &R0VN33RS4},	//(R0VN33RS4) Нейтронный поток по камере КНК53М канал 4
	{ 46	,3	,1	, &R0VN15RS4},	//(R0VN15RS4) Номер ведущей камеры канал 4
	{ 47	,1	,1	, &A0EE03LS4},	//(A0EE03LS4) Подключена сеть питания АКНП канал 4
	{ 48	,1	,1	, &R0IE01LS4},	//(R0IE01LS4) Отключение питание детекторов канал 4
	{ 49	,1	,1	, &R0IE02LS4},	//(R0IE02LS4) Отключить питание ПР, ПУ канал 4
	{ 50	,1	,1	, &A0VN71LS4},	//(A0VN71LS4) Блокировка автоматического  подъёма ББ канал 4 на БАЗ1
	...
	{ 59	,8	,1	, &fEM_R7UY00RSS},	//(R7UY00RSS) Y-координата АЗ1 (см)
	{ 60	,8	,1	, &fEM_R7UX10RSS},	//(R7UX10RSS) X-координата камеры R7IN41
	{ 61	,8	,1	, &fEM_R7UX11RSS},	//(R7UX11RSS) X-координата камеры R7IN42
	{ 62	,8	,1	, &fEM_R7UX12RSS},	//(R7UX12RSS) X-координата камеры R7IN43
	{ 63	,8	,1	, &fEM_R7UY10RSS},	//(R7UY10RSS) Y-координата камеры R7IN41
	{ 64	,8	,1	, &fEM_R7UY11RSS},	//(R7UY11RSS) Y-координата камеры R7IN42
	{ 65	,8	,1	, &fEM_R7UY12RSS},	//(R7UY12RSS) Y-координата камеры R7IN43
	{ 66	,8	,1	, &fEM_A0UX00RSS},	//(A0UX00RSS) Эффективный радиус АЗ
	{ 67	,8	,1	, &fEM_A0UX10RSS},	//(A0UX10RSS) Первый коэффициент калибровки камеры 10
	{ 68	,8	,1	, &fEM_A0UX11RSS},	//(A0UX11RSS) Первый коэффициент калибровки камеры 11
	{ 69	,8	,1	, &fEM_A0UX12RSS},	//(A0UX12RSS) Первый коэффициент калибровки камеры 12
	{ 70	,8	,1	, &fEM_B0UX10RSS},	//(B0UX10RSS) Второй коэффициент калибровки камеры 10
	{ 71	,8	,1	, &fEM_B0UX11RSS},	//(B0UX11RSS) Второй коэффициент калибровки камеры 11
	{ 72	,8	,1	, &fEM_B0UX12RSS},	//(B0UX12RSS) Второй коэффициент калибровки камеры 12
...
static ModbusRegister di_DiagnAKNP4[]={  // 
	{&R0DE3DLS4,1,0},	//(R0DE3DLS4) диагностика шкафа АКНП4 БП5/24Д место 8
	{&R0DE3CLS4,1,1},	//(R0DE3CLS4) диагностика шкафа АКНП4 БП5/24Д место 7
	{&R0DE3BLS4,1,2},	//(R0DE3BLS4) диагностика шкафа АКНП4 БП5/24Д место 6
	{&R0DE3ALS4,1,3},	//(R0DE3ALS4) диагностика шкафа АКНП4 БП5/24Д место 5
	{&R0DE39LS4,1,4},	//(R0DE39LS4) диагностика шкафа АКНП4 МП24-2 место 4
	{&R0DE38LS4,1,5},	//(R0DE38LS4) диагностика шкафа АКНП4 МП15-3 место 3
