...
#define var17	BUFFER[409]	// Внутренняя переменная var17
#define idvar17	109	// Внутренняя переменная var17
...
#define var33	BUFFER[421]	// Внутренняя переменная var33
#define idvar33	112	// Внутренняя переменная var33
#define var11	BUFFER[423]	// Внутренняя переменная var11
#define idvar11	113	// Внутренняя переменная var11
#define var16	BUFFER[425]	// Внутренняя переменная var16
#define idvar16	114	// Внутренняя переменная var16
#define var30	BUFFER[430]	// Внутренняя переменная var30
...
#define idvar1	118	// Внутренняя переменная var1
#define var22	BUFFER[444]	// Внутренняя переменная var22
#define idvar22	119	// Внутренняя переменная var22
#define var24	BUFFER[446]	// Внутренняя переменная var24
#define idvar24	120	// Внутренняя переменная var24
#define var26	BUFFER[448]	// Внутренняя переменная var26
#define idvar26	121	// Внутренняя переменная var26
#define vainSFloat	BUFFER[450]	// Внутренняя переменная vainSFloat
#define idvainSFloat	122	// Внутренняя переменная vainSFloat
#define var7	BUFFER[455]	// Внутренняя переменная var7
...
#define var21	BUFFER[465]	// Внутренняя переменная var21
#define idvar21	125	// Внутренняя переменная var21
#define var27	BUFFER[470]	// Внутренняя переменная var27
#define idvar27	126	// Внутренняя переменная var27
#define var28	BUFFER[472]	// Внутренняя переменная var28
#define idvar28	127	// Внутренняя переменная var28
#define vainSLong	BUFFER[474]	// Внутренняя переменная vainSLong
#define idvainSLong	128	// Внутренняя переменная vainSLong
#define var9	BUFFER[483]	// Внутренняя переменная var9
#define idvar9	129	// Внутренняя переменная var9
#define var20	BUFFER[485]	// Внутренняя переменная var20
#define idvar20	130	// Внутренняя переменная var20
#define var18	BUFFER[490]	// Внутренняя переменная var18
#define idvar18	131	// Внутренняя переменная var18
#define vainSBool	BUFFER[495]	// Внутренняя переменная vainSBool
...
#define var8	BUFFER[502]	// Внутренняя переменная var8
#define idvar8	134	// Внутренняя переменная var8
#define var4	BUFFER[504]	// Внутренняя переменная var4
#define idvar4	135	// Внутренняя переменная var4
#define var5	BUFFER[509]	// Внутренняя переменная var5
...
#define var29	BUFFER[524]	// Внутренняя переменная var29
#define idvar29	139	// Внутренняя переменная var29
#define var12	BUFFER[526]	// Внутренняя переменная var12
#define idvar12	140	// Внутренняя переменная var12
#define var13	BUFFER[528]	// Внутренняя переменная var13
#define idvar13	141	// Внутренняя переменная var13
#define var14	BUFFER[530]	// Внутренняя переменная var14
#define idvar14	142	// Внутренняя переменная var14
...
#define idvar2	144	// Внутренняя переменная var2
#define var10	BUFFER[542]	// Внутренняя переменная var10
#define idvar10	145	// Внутренняя переменная var10
#pragma pack(push,1)
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{109	,1	,1	,&var17},	//Внутренняя переменная var17
	{110	,8	,1	,&var19},	//Внутренняя переменная var19
	{111	,8	,1	,&var23},	//Внутренняя переменная var23
	{112	,1	,1	,&var33},	//Внутренняя переменная var33
	{113	,1	,1	,&var11},	//Внутренняя переменная var11
	{114	,8	,1	,&var16},	//Внутренняя переменная var16
	...
	{118	,8	,1	,&var1},	//Внутренняя переменная var1
	...
	{125	,5	,1	,&var21},	//Внутренняя переменная var21
	{126	,1	,1	,&var27},	//Внутренняя переменная var27
	{127	,1	,1	,&var28},	//Внутренняя переменная var28
	{128	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	{129	,1	,1	,&var9},	//Внутренняя переменная var9
	{130	,8	,1	,&var20},	//Внутренняя переменная var20
	{131	,8	,1	,&var18},	//Внутренняя переменная var18
	{132	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	{133	,8	,1	,&var6},	//Внутренняя переменная var6
	{134	,1	,1	,&var8},	//Внутренняя переменная var8
	{135	,8	,1	,&var4},	//Внутренняя переменная var4
	...
	{140	,1	,1	,&var12},	//Внутренняя переменная var12
	{141	,1	,1	,&var13},	//Внутренняя переменная var13
	{142	,5	,1	,&var14},	//Внутренняя переменная var14
	{143	,1	,1	,&var25},	//Внутренняя переменная var25
	{144	,8	,1	,&var2},	//Внутренняя переменная var2
	{145	,1	,1	,&var10},	//Внутренняя переменная var10
	{-1,0,NULL},
};
