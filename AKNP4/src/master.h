...
#define vainSBool	BUFFER[468]	// Внутренняя переменная vainSBool
...
#define vainSInt	BUFFER[514]	// Внутренняя переменная vainSInt
#define idvainSInt	137	// Внутренняя переменная vainSInt
#define vainSLong	BUFFER[459]	// Внутренняя переменная vainSLong
#define idvainSLong	122	// Внутренняя переменная vainSLong
#define var1	BUFFER[519]	// Внутренняя переменная var1
#define idvar1	138	// Внутренняя переменная var1
#define var10	BUFFER[499]	// Внутренняя переменная var10
#define idvar10	131	// Внутренняя переменная var10
#define var11	BUFFER[437]	// Внутренняя переменная var11
#define idvar11	117	// Внутренняя переменная var11
#define var12	BUFFER[490]	// Внутренняя переменная var12
#define idvar12	128	// Внутренняя переменная var12
#define var13	BUFFER[421]	// Внутренняя переменная var13
#define idvar13	112	// Внутренняя переменная var13
#define var14	BUFFER[439]	// Внутренняя переменная var14
#define idvar14	118	// Внутренняя переменная var14
#define var15	BUFFER[454]	// Внутренняя переменная var15
#define idvar15	121	// Внутренняя переменная var15
#define var16	BUFFER[423]	// Внутренняя переменная var16
#define idvar16	113	// Внутренняя переменная var16
#define var17	BUFFER[501]	// Внутренняя переменная var17
#define idvar17	132	// Внутренняя переменная var17
#define var18	BUFFER[428]	// Внутренняя переменная var18
#define idvar18	114	// Внутренняя переменная var18
#define var19	BUFFER[444]	// Внутренняя переменная var19
#define idvar19	119	// Внутренняя переменная var19
#define var2	BUFFER[485]	// Внутренняя переменная var2
#define idvar2	127	// Внутренняя переменная var2
#define var20	BUFFER[503]	// Внутренняя переменная var20
#define idvar20	133	// Внутренняя переменная var20
#define var21	BUFFER[524]	// Внутренняя переменная var21
#define idvar21	139	// Внутренняя переменная var21
#define var22	BUFFER[433]	// Внутренняя переменная var22
#define idvar22	115	// Внутренняя переменная var22
#define var23	BUFFER[492]	// Внутренняя переменная var23
#define idvar23	129	// Внутренняя переменная var23
#define var24	BUFFER[529]	// Внутренняя переменная var24
#define idvar24	140	// Внутренняя переменная var24
#define var25	BUFFER[497]	// Внутренняя переменная var25
#define idvar25	130	// Внутренняя переменная var25
#define var26	BUFFER[531]	// Внутренняя переменная var26
#define idvar26	141	// Внутренняя переменная var26
#define var27	BUFFER[510]	// Внутренняя переменная var27
#define idvar27	135	// Внутренняя переменная var27
#define var28	BUFFER[538]	// Внутренняя переменная var28
#define idvar28	143	// Внутренняя переменная var28
#define var29	BUFFER[508]	// Внутренняя переменная var29
#define idvar29	134	// Внутренняя переменная var29
#define var3	BUFFER[533]	// Внутренняя переменная var3
...
#define var32	BUFFER[409]	// Внутренняя переменная var32
#define idvar32	109	// Внутренняя переменная var32
#define var33	BUFFER[542]	// Внутренняя переменная var33
#define idvar33	145	// Внутренняя переменная var33
#define var4	BUFFER[470]	// Внутренняя переменная var4
#define idvar4	124	// Внутренняя переменная var4
#define var5	BUFFER[475]	// Внутренняя переменная var5
...
#define var7	BUFFER[480]	// Внутренняя переменная var7
#define idvar7	126	// Внутренняя переменная var7
#define var8	BUFFER[435]	// Внутренняя переменная var8
#define idvar8	116	// Внутренняя переменная var8
#define var9	BUFFER[419]	// Внутренняя переменная var9
#define idvar9	111	// Внутренняя переменная var9
#pragma pack(push,1)
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{137	,5	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	{122	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	{138	,8	,1	,&var1},	//Внутренняя переменная var1
	{131	,1	,1	,&var10},	//Внутренняя переменная var10
	{117	,1	,1	,&var11},	//Внутренняя переменная var11
	{128	,1	,1	,&var12},	//Внутренняя переменная var12
	{112	,1	,1	,&var13},	//Внутренняя переменная var13
	{118	,5	,1	,&var14},	//Внутренняя переменная var14
	{121	,8	,1	,&var15},	//Внутренняя переменная var15
	{113	,8	,1	,&var16},	//Внутренняя переменная var16
	{132	,1	,1	,&var17},	//Внутренняя переменная var17
	{114	,8	,1	,&var18},	//Внутренняя переменная var18
	{119	,8	,1	,&var19},	//Внутренняя переменная var19
	{127	,8	,1	,&var2},	//Внутренняя переменная var2
	{133	,8	,1	,&var20},	//Внутренняя переменная var20
	{139	,5	,1	,&var21},	//Внутренняя переменная var21
	{115	,1	,1	,&var22},	//Внутренняя переменная var22
	{129	,8	,1	,&var23},	//Внутренняя переменная var23
	{140	,1	,1	,&var24},	//Внутренняя переменная var24
	{130	,1	,1	,&var25},	//Внутренняя переменная var25
	{141	,1	,1	,&var26},	//Внутренняя переменная var26
	{135	,1	,1	,&var27},	//Внутренняя переменная var27
	{143	,1	,1	,&var28},	//Внутренняя переменная var28
	...
	{109	,8	,1	,&var32},	//Внутренняя переменная var32
	{145	,1	,1	,&var33},	//Внутренняя переменная var33
	{124	,8	,1	,&var4},	//Внутренняя переменная var4
	{125	,8	,1	,&var5},	//Внутренняя переменная var5
	{120	,8	,1	,&var6},	//Внутренняя переменная var6
	{126	,8	,1	,&var7},	//Внутренняя переменная var7
	{116	,1	,1	,&var8},	//Внутренняя переменная var8
	{111	,1	,1	,&var9},	//Внутренняя переменная var9
	{-1,0,NULL},
};
