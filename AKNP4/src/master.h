...
#define var13	BUFFER[409]	// Внутренняя переменная var13
#define idvar13	109	// Внутренняя переменная var13
#define vainSBool	BUFFER[411]	// Внутренняя переменная vainSBool
#define idvainSBool	110	// Внутренняя переменная vainSBool
#define var8	BUFFER[413]	// Внутренняя переменная var8
...
#define var27	BUFFER[417]	// Внутренняя переменная var27
#define idvar27	113	// Внутренняя переменная var27
#define var3	BUFFER[419]	// Внутренняя переменная var3
#define idvar3	114	// Внутренняя переменная var3
#define var18	BUFFER[424]	// Внутренняя переменная var18
#define idvar18	115	// Внутренняя переменная var18
#define var20	BUFFER[429]	// Внутренняя переменная var20
#define idvar20	116	// Внутренняя переменная var20
#define var21	BUFFER[434]	// Внутренняя переменная var21
#define idvar21	117	// Внутренняя переменная var21
#define var26	BUFFER[439]	// Внутренняя переменная var26
#define idvar26	118	// Внутренняя переменная var26
#define var29	BUFFER[441]	// Внутренняя переменная var29
#define idvar29	119	// Внутренняя переменная var29
#define var31	BUFFER[443]	// Внутренняя переменная var31
#define idvar31	120	// Внутренняя переменная var31
#define var32	BUFFER[445]	// Внутренняя переменная var32
#define idvar32	121	// Внутренняя переменная var32
#define var7	BUFFER[450]	// Внутренняя переменная var7
#define idvar7	122	// Внутренняя переменная var7
#define var12	BUFFER[455]	// Внутренняя переменная var12
#define idvar12	123	// Внутренняя переменная var12
#define var33	BUFFER[457]	// Внутренняя переменная var33
#define idvar33	124	// Внутренняя переменная var33
#define var5	BUFFER[459]	// Внутренняя переменная var5
#define idvar5	125	// Внутренняя переменная var5
#define var15	BUFFER[464]	// Внутренняя переменная var15
#define idvar15	126	// Внутренняя переменная var15
#define var16	BUFFER[469]	// Внутренняя переменная var16
...
#define var25	BUFFER[479]	// Внутренняя переменная var25
#define idvar25	129	// Внутренняя переменная var25
#define vainSFloat	BUFFER[481]	// Внутренняя переменная vainSFloat
#define idvainSFloat	130	// Внутренняя переменная vainSFloat
#define var6	BUFFER[486]	// Внутренняя переменная var6
#define idvar6	131	// Внутренняя переменная var6
#define var14	BUFFER[491]	// Внутренняя переменная var14
#define idvar14	132	// Внутренняя переменная var14
#define var24	BUFFER[496]	// Внутренняя переменная var24
#define idvar24	133	// Внутренняя переменная var24
#define var28	BUFFER[498]	// Внутренняя переменная var28
#define idvar28	134	// Внутренняя переменная var28
#define vainSInt	BUFFER[500]	// Внутренняя переменная vainSInt
#define idvainSInt	135	// Внутренняя переменная vainSInt
#define var17	BUFFER[505]	// Внутренняя переменная var17
#define idvar17	136	// Внутренняя переменная var17
#define var22	BUFFER[507]	// Внутренняя переменная var22
#define idvar22	137	// Внутренняя переменная var22
#define var4	BUFFER[509]	// Внутренняя переменная var4
#define idvar4	138	// Внутренняя переменная var4
#define var9	BUFFER[514]	// Внутренняя переменная var9
#define idvar9	139	// Внутренняя переменная var9
#define var10	BUFFER[516]	// Внутренняя переменная var10
#define idvar10	140	// Внутренняя переменная var10
#define var19	BUFFER[518]	// Внутренняя переменная var19
#define idvar19	141	// Внутренняя переменная var19
#define var30	BUFFER[523]	// Внутренняя переменная var30
#define idvar30	142	// Внутренняя переменная var30
#define vainSLong	BUFFER[525]	// Внутренняя переменная vainSLong
#define idvainSLong	143	// Внутренняя переменная vainSLong
#define var1	BUFFER[534]	// Внутренняя переменная var1
#define idvar1	144	// Внутренняя переменная var1
#define var2	BUFFER[539]	// Внутренняя переменная var2
#define idvar2	145	// Внутренняя переменная var2
#pragma pack(push,1)
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{110	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	...
	{116	,8	,1	,&var20},	//Внутренняя переменная var20
	{117	,5	,1	,&var21},	//Внутренняя переменная var21
	{118	,1	,1	,&var26},	//Внутренняя переменная var26
	{119	,1	,1	,&var29},	//Внутренняя переменная var29
	{120	,1	,1	,&var31},	//Внутренняя переменная var31
	...
	{124	,1	,1	,&var33},	//Внутренняя переменная var33
	{125	,8	,1	,&var5},	//Внутренняя переменная var5
	...
	{130	,8	,1	,&vainSFloat},	//Внутренняя переменная vainSFloat
	{131	,8	,1	,&var6},	//Внутренняя переменная var6
	{132	,5	,1	,&var14},	//Внутренняя переменная var14
	{133	,1	,1	,&var24},	//Внутренняя переменная var24
	{134	,1	,1	,&var28},	//Внутренняя переменная var28
	{135	,5	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	{136	,1	,1	,&var17},	//Внутренняя переменная var17
	{137	,1	,1	,&var22},	//Внутренняя переменная var22
	{138	,8	,1	,&var4},	//Внутренняя переменная var4
	{139	,1	,1	,&var9},	//Внутренняя переменная var9
	{140	,1	,1	,&var10},	//Внутренняя переменная var10
	{141	,8	,1	,&var19},	//Внутренняя переменная var19
	{142	,1	,1	,&var30},	//Внутренняя переменная var30
	{143	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	{144	,8	,1	,&var1},	//Внутренняя переменная var1
	{145	,8	,1	,&var2},	//Внутренняя переменная var2
	{-1,0,NULL},
};
