...
#define idvainSBool	192	// Внутренняя переменная vainSBool
#define vainSFloat	BUFFER[641]	// Внутренняя переменная vainSFloat
#define idvainSFloat	191	// Внутренняя переменная vainSFloat
#define vainSInt	BUFFER[662]	// Внутренняя переменная vainSInt
#define idvainSInt	197	// Внутренняя переменная vainSInt
#define vainSLong	BUFFER[632]	// Внутренняя переменная vainSLong
#define idvainSLong	190	// Внутренняя переменная vainSLong
#define var1	BUFFER[648]	// Внутренняя переменная var1
#define idvar1	193	// Внутренняя переменная var1
#define var10	BUFFER[683]	// Внутренняя переменная var10
#define idvar10	203	// Внутренняя переменная var10
#define var11	BUFFER[526]	// Внутренняя переменная var11
#define idvar11	155	// Внутренняя переменная var11
#define var12	BUFFER[513]	// Внутренняя переменная var12
#define idvar12	150	// Внутренняя переменная var12
#define var13	BUFFER[653]	// Внутренняя переменная var13
#define idvar13	194	// Внутренняя переменная var13
#define var14	BUFFER[672]	// Внутренняя переменная var14
#define idvar14	199	// Внутренняя переменная var14
#define var15	BUFFER[607]	// Внутренняя переменная var15
#define idvar15	182	// Внутренняя переменная var15
#define var16	BUFFER[515]	// Внутренняя переменная var16
#define idvar16	151	// Внутренняя переменная var16
#define var17	BUFFER[655]	// Внутренняя переменная var17
#define idvar17	195	// Внутренняя переменная var17
#define var18	BUFFER[496]	// Внутренняя переменная var18
#define idvar18	143	// Внутренняя переменная var18
#define var19	BUFFER[572]	// Внутренняя переменная var19
#define idvar19	169	// Внутренняя переменная var19
#define var2	BUFFER[583]	// Внутренняя переменная var2
#define idvar2	173	// Внутренняя переменная var2
#define var20	BUFFER[674]	// Внутренняя переменная var20
#define idvar20	200	// Внутренняя переменная var20
#define var21	BUFFER[528]	// Внутренняя переменная var21
#define idvar21	156	// Внутренняя переменная var21
#define var22	BUFFER[498]	// Внутренняя переменная var22
#define idvar22	144	// Внутренняя переменная var22
#define var23	BUFFER[625]	// Внутренняя переменная var23
#define idvar23	188	// Внутренняя переменная var23
#define var24	BUFFER[592]	// Внутренняя переменная var24
#define idvar24	176	// Внутренняя переменная var24
#define var25	BUFFER[565]	// Внутренняя переменная var25
#define idvar25	167	// Внутренняя переменная var25
#define var26	BUFFER[574]	// Внутренняя переменная var26
#define idvar26	170	// Внутренняя переменная var26
#define var27	BUFFER[657]	// Внутренняя переменная var27
#define idvar27	196	// Внутренняя переменная var27
#define var28	BUFFER[517]	// Внутренняя переменная var28
#define idvar28	152	// Внутренняя переменная var28
#define var29	BUFFER[542]	// Внутренняя переменная var29
#define idvar29	160	// Внутренняя переменная var29
#define var3	BUFFER[537]	// Внутренняя переменная var3
#define idvar3	159	// Внутренняя переменная var3
#define var30	BUFFER[511]	// Внутренняя переменная var30
#define idvar30	149	// Внутренняя переменная var30
#define var31	BUFFER[503]	// Внутренняя переменная var31
#define idvar31	145	// Внутренняя переменная var31
#define var32	BUFFER[505]	// Внутренняя переменная var32
#define idvar32	146	// Внутренняя переменная var32
#define var33	BUFFER[679]	// Внутренняя переменная var33
#define idvar33	201	// Внутренняя переменная var33
#define var34	BUFFER[570]	// Внутренняя переменная var34
#define idvar34	168	// Внутренняя переменная var34
#define var35	BUFFER[579]	// Внутренняя переменная var35
#define idvar35	171	// Внутренняя переменная var35
#define var36	BUFFER[507]	// Внутренняя переменная var36
#define idvar36	147	// Внутренняя переменная var36
#define var37	BUFFER[603]	// Внутренняя переменная var37
#define idvar37	180	// Внутренняя переменная var37
#define var39	BUFFER[597]	// Внутренняя переменная var39
#define idvar39	177	// Внутренняя переменная var39
#define var4	BUFFER[620]	// Внутренняя переменная var4
#define idvar4	187	// Внутренняя переменная var4
#define var41	BUFFER[544]	// Внутренняя переменная var41
#define idvar41	161	// Внутренняя переменная var41
#define var42	BUFFER[681]	// Внутренняя переменная var42
#define idvar42	202	// Внутренняя переменная var42
#define var43	BUFFER[609]	// Внутренняя переменная var43
#define idvar43	183	// Внутренняя переменная var43
#define var44	BUFFER[546]	// Внутренняя переменная var44
#define idvar44	162	// Внутренняя переменная var44
#define var45	BUFFER[519]	// Внутренняя переменная var45
#define idvar45	153	// Внутренняя переменная var45
#define var46	BUFFER[611]	// Внутренняя переменная var46
#define idvar46	184	// Внутренняя переменная var46
#define var47	BUFFER[627]	// Внутренняя переменная var47
#define idvar47	189	// Внутренняя переменная var47
#define var49	BUFFER[581]	// Внутренняя переменная var49
#define idvar49	172	// Внутренняя переменная var49
#define var5	BUFFER[550]	// Внутренняя переменная var5
#define idvar5	164	// Внутренняя переменная var5
#define var50	BUFFER[599]	// Внутренняя переменная var50
#define idvar50	178	// Внутренняя переменная var50
#define var52	BUFFER[548]	// Внутренняя переменная var52
#define idvar52	163	// Внутренняя переменная var52
#define var53	BUFFER[605]	// Внутренняя переменная var53
#define idvar53	181	// Внутренняя переменная var53
#define var54	BUFFER[616]	// Внутренняя переменная var54
#define idvar54	185	// Внутренняя переменная var54
#define var55	BUFFER[533]	// Внутренняя переменная var55
#define idvar55	157	// Внутренняя переменная var55
#define var56	BUFFER[509]	// Внутренняя переменная var56
#define idvar56	148	// Внутренняя переменная var56
#define var57	BUFFER[688]	// Внутренняя переменная var57
#define idvar57	204	// Внутренняя переменная var57
#define var58	BUFFER[535]	// Внутренняя переменная var58
#define idvar58	158	// Внутренняя переменная var58
#define var59	BUFFER[618]	// Внутренняя переменная var59
#define idvar59	186	// Внутренняя переменная var59
#define var6	BUFFER[521]	// Внутренняя переменная var6
#define idvar6	154	// Внутренняя переменная var6
#define var60	BUFFER[588]	// Внутренняя переменная var60
#define idvar60	174	// Внутренняя переменная var60
#define var61	BUFFER[590]	// Внутренняя переменная var61
#define idvar61	175	// Внутренняя переменная var61
#define var62	BUFFER[601]	// Внутренняя переменная var62
#define idvar62	179	// Внутренняя переменная var62
#define var7	BUFFER[555]	// Внутренняя переменная var7
#define idvar7	165	// Внутренняя переменная var7
#define var8	BUFFER[560]	// Внутренняя переменная var8
#define idvar8	166	// Внутренняя переменная var8
#define var9	BUFFER[667]	// Внутренняя переменная var9
#define idvar9	198	// Внутренняя переменная var9
#pragma pack(push,1)
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	...
	{192	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	{191	,8	,1	,&vainSFloat},	//Внутренняя переменная vainSFloat
	{197	,5	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	{190	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	{193	,8	,1	,&var1},	//Внутренняя переменная var1
	{203	,8	,1	,&var10},	//Внутренняя переменная var10
	{155	,1	,1	,&var11},	//Внутренняя переменная var11
	{150	,1	,1	,&var12},	//Внутренняя переменная var12
	{194	,1	,1	,&var13},	//Внутренняя переменная var13
	{199	,1	,1	,&var14},	//Внутренняя переменная var14
	{182	,1	,1	,&var15},	//Внутренняя переменная var15
	{151	,1	,1	,&var16},	//Внутренняя переменная var16
	{195	,1	,1	,&var17},	//Внутренняя переменная var17
	{143	,1	,1	,&var18},	//Внутренняя переменная var18
	{169	,1	,1	,&var19},	//Внутренняя переменная var19
	{173	,8	,1	,&var2},	//Внутренняя переменная var2
	{200	,5	,1	,&var20},	//Внутренняя переменная var20
	{156	,8	,1	,&var21},	//Внутренняя переменная var21
	{144	,8	,1	,&var22},	//Внутренняя переменная var22
	{188	,1	,1	,&var23},	//Внутренняя переменная var23
	{176	,8	,1	,&var24},	//Внутренняя переменная var24
	{167	,8	,1	,&var25},	//Внутренняя переменная var25
	{170	,8	,1	,&var26},	//Внутренняя переменная var26
	{196	,5	,1	,&var27},	//Внутренняя переменная var27
	{152	,1	,1	,&var28},	//Внутренняя переменная var28
	{160	,1	,1	,&var29},	//Внутренняя переменная var29
	{159	,8	,1	,&var3},	//Внутренняя переменная var3
	{149	,1	,1	,&var30},	//Внутренняя переменная var30
	{145	,1	,1	,&var31},	//Внутренняя переменная var31
	{146	,1	,1	,&var32},	//Внутренняя переменная var32
	{201	,1	,1	,&var33},	//Внутренняя переменная var33
	{168	,1	,1	,&var34},	//Внутренняя переменная var34
	{171	,1	,1	,&var35},	//Внутренняя переменная var35
	{147	,1	,1	,&var36},	//Внутренняя переменная var36
	{180	,1	,1	,&var37},	//Внутренняя переменная var37
	{177	,1	,1	,&var39},	//Внутренняя переменная var39
	{187	,8	,1	,&var4},	//Внутренняя переменная var4
	{161	,1	,1	,&var41},	//Внутренняя переменная var41
	{202	,1	,1	,&var42},	//Внутренняя переменная var42
	{183	,1	,1	,&var43},	//Внутренняя переменная var43
	{162	,1	,1	,&var44},	//Внутренняя переменная var44
	{153	,1	,1	,&var45},	//Внутренняя переменная var45
	{184	,8	,1	,&var46},	//Внутренняя переменная var46
	{189	,8	,1	,&var47},	//Внутренняя переменная var47
	{172	,1	,1	,&var49},	//Внутренняя переменная var49
	{164	,8	,1	,&var5},	//Внутренняя переменная var5
	{178	,1	,1	,&var50},	//Внутренняя переменная var50
	{163	,1	,1	,&var52},	//Внутренняя переменная var52
	{181	,1	,1	,&var53},	//Внутренняя переменная var53
	{185	,1	,1	,&var54},	//Внутренняя переменная var54
	{157	,1	,1	,&var55},	//Внутренняя переменная var55
	{148	,1	,1	,&var56},	//Внутренняя переменная var56
	{204	,1	,1	,&var57},	//Внутренняя переменная var57
	{158	,1	,1	,&var58},	//Внутренняя переменная var58
	{186	,1	,1	,&var59},	//Внутренняя переменная var59
	{154	,8	,1	,&var6},	//Внутренняя переменная var6
	{174	,1	,1	,&var60},	//Внутренняя переменная var60
	{175	,1	,1	,&var61},	//Внутренняя переменная var61
	{179	,1	,1	,&var62},	//Внутренняя переменная var62
	{165	,8	,1	,&var7},	//Внутренняя переменная var7
	{166	,8	,1	,&var8},	//Внутренняя переменная var8
	{198	,8	,1	,&var9},	//Внутренняя переменная var9
	{-1,0,NULL},
};
