...
#define A0IT03IRP	BUFFER[9]	// (vas84:06 - K01VASR, - ) Температура АЗ1-3
#define idA0IT03IRP	4	// (vas84:06 - K01VASR, - ) Температура АЗ1-3
...
#define B0IT03IRP	BUFFER[39]	// (vas84:06 - K02VASR, - ) Температура АЗ2-3
#define idB0IT03IRP	17	// (vas84:06 - K02VASR, - ) Температура АЗ2-3
...
#define var38	BUFFER[496]	// Внутренняя переменная var38
#define idvar38	30000	// Внутренняя переменная var38
#define var50	BUFFER[499]	// Внутренняя переменная var50
#define idvar50	30001	// Внутренняя переменная var50
#define vainSBool	BUFFER[501]	// Внутренняя переменная vainSBool
#define idvainSBool	30002	// Внутренняя переменная vainSBool
#define var1	BUFFER[503]	// Внутренняя переменная var1
#define idvar1	30003	// Внутренняя переменная var1
#define var4	BUFFER[508]	// Внутренняя переменная var4
#define idvar4	30004	// Внутренняя переменная var4
#define var19	BUFFER[513]	// Внутренняя переменная var19
#define idvar19	30005	// Внутренняя переменная var19
#define var14	BUFFER[515]	// Внутренняя переменная var14
#define idvar14	30006	// Внутренняя переменная var14
#define var21	BUFFER[517]	// Внутренняя переменная var21
#define idvar21	30007	// Внутренняя переменная var21
#define var36	BUFFER[522]	// Внутренняя переменная var36
#define idvar36	30008	// Внутренняя переменная var36
#define var41	BUFFER[524]	// Внутренняя переменная var41
#define idvar41	30009	// Внутренняя переменная var41
#define var47	BUFFER[526]	// Внутренняя переменная var47
#define idvar47	30010	// Внутренняя переменная var47
#define var2	BUFFER[531]	// Внутренняя переменная var2
#define idvar2	30011	// Внутренняя переменная var2
#define var3	BUFFER[536]	// Внутренняя переменная var3
#define idvar3	30012	// Внутренняя переменная var3
#define var10	BUFFER[541]	// Внутренняя переменная var10
#define idvar10	30013	// Внутренняя переменная var10
#define vainSFloat	BUFFER[546]	// Внутренняя переменная vainSFloat
#define idvainSFloat	30014	// Внутренняя переменная vainSFloat
#define var12	BUFFER[551]	// Внутренняя переменная var12
#define idvar12	30015	// Внутренняя переменная var12
#define var25	BUFFER[553]	// Внутренняя переменная var25
#define idvar25	30016	// Внутренняя переменная var25
#define var62	BUFFER[558]	// Внутренняя переменная var62
#define idvar62	30017	// Внутренняя переменная var62
#define var43	BUFFER[560]	// Внутренняя переменная var43
#define idvar43	30018	// Внутренняя переменная var43
#define var44	BUFFER[562]	// Внутренняя переменная var44
#define idvar44	30019	// Внутренняя переменная var44
#define var61	BUFFER[564]	// Внутренняя переменная var61
#define idvar61	30020	// Внутренняя переменная var61
#define var8	BUFFER[566]	// Внутренняя переменная var8
#define idvar8	30021	// Внутренняя переменная var8
#define var11	BUFFER[571]	// Внутренняя переменная var11
#define idvar11	30022	// Внутренняя переменная var11
#define var55	BUFFER[573]	// Внутренняя переменная var55
#define idvar55	30023	// Внутренняя переменная var55
#define var37	BUFFER[575]	// Внутренняя переменная var37
#define idvar37	30024	// Внутренняя переменная var37
#define vainSLong	BUFFER[577]	// Внутренняя переменная vainSLong
#define idvainSLong	30025	// Внутренняя переменная vainSLong
#define var46	BUFFER[586]	// Внутренняя переменная var46
#define idvar46	30026	// Внутренняя переменная var46
#define var26	BUFFER[591]	// Внутренняя переменная var26
#define idvar26	30027	// Внутренняя переменная var26
#define var29	BUFFER[596]	// Внутренняя переменная var29
#define idvar29	30028	// Внутренняя переменная var29
#define var32	BUFFER[598]	// Внутренняя переменная var32
#define idvar32	30029	// Внутренняя переменная var32
#define var58	BUFFER[600]	// Внутренняя переменная var58
#define idvar58	30030	// Внутренняя переменная var58
#define var59	BUFFER[602]	// Внутренняя переменная var59
#define idvar59	30031	// Внутренняя переменная var59
#define var23	BUFFER[604]	// Внутренняя переменная var23
#define idvar23	30032	// Внутренняя переменная var23
#define var39	BUFFER[606]	// Внутренняя переменная var39
#define idvar39	30033	// Внутренняя переменная var39
#define var56	BUFFER[608]	// Внутренняя переменная var56
#define idvar56	30034	// Внутренняя переменная var56
#define var9	BUFFER[610]	// Внутренняя переменная var9
#define idvar9	30035	// Внутренняя переменная var9
#define var40	BUFFER[615]	// Внутренняя переменная var40
#define idvar40	30036	// Внутренняя переменная var40
#define var45	BUFFER[618]	// Внутренняя переменная var45
#define idvar45	30037	// Внутренняя переменная var45
#define var28	BUFFER[620]	// Внутренняя переменная var28
#define idvar28	30038	// Внутренняя переменная var28
#define var31	BUFFER[622]	// Внутренняя переменная var31
#define idvar31	30039	// Внутренняя переменная var31
#define vainSInt	BUFFER[624]	// Внутренняя переменная vainSInt
#define idvainSInt	30040	// Внутренняя переменная vainSInt
#define var6	BUFFER[627]	// Внутренняя переменная var6
#define idvar6	30041	// Внутренняя переменная var6
#define var13	BUFFER[632]	// Внутренняя переменная var13
#define idvar13	30042	// Внутренняя переменная var13
#define var18	BUFFER[634]	// Внутренняя переменная var18
#define idvar18	30043	// Внутренняя переменная var18
#define var52	BUFFER[636]	// Внутренняя переменная var52
#define idvar52	30044	// Внутренняя переменная var52
#define var53	BUFFER[638]	// Внутренняя переменная var53
#define idvar53	30045	// Внутренняя переменная var53
#define var20	BUFFER[640]	// Внутренняя переменная var20
#define idvar20	30046	// Внутренняя переменная var20
#define var49	BUFFER[643]	// Внутренняя переменная var49
#define idvar49	30047	// Внутренняя переменная var49
#define var51	BUFFER[645]	// Внутренняя переменная var51
#define idvar51	30048	// Внутренняя переменная var51
#define var54	BUFFER[648]	// Внутренняя переменная var54
#define idvar54	30049	// Внутренняя переменная var54
#define var57	BUFFER[650]	// Внутренняя переменная var57
#define idvar57	30050	// Внутренняя переменная var57
#define var60	BUFFER[652]	// Внутренняя переменная var60
#define idvar60	30051	// Внутренняя переменная var60
#define vainSChar	BUFFER[654]	// Внутренняя переменная vainSChar
#define idvainSChar	30052	// Внутренняя переменная vainSChar
#define var7	BUFFER[657]	// Внутренняя переменная var7
#define idvar7	30053	// Внутренняя переменная var7
#define var15	BUFFER[662]	// Внутренняя переменная var15
#define idvar15	30054	// Внутренняя переменная var15
#define var33	BUFFER[664]	// Внутренняя переменная var33
#define idvar33	30055	// Внутренняя переменная var33
#define var30	BUFFER[666]	// Внутренняя переменная var30
#define idvar30	30056	// Внутренняя переменная var30
#define var5	BUFFER[668]	// Внутренняя переменная var5
#define idvar5	30057	// Внутренняя переменная var5
#define var22	BUFFER[673]	// Внутренняя переменная var22
#define idvar22	30058	// Внутренняя переменная var22
#define var24	BUFFER[678]	// Внутренняя переменная var24
#define idvar24	30059	// Внутренняя переменная var24
#define var42	BUFFER[683]	// Внутренняя переменная var42
#define idvar42	30060	// Внутренняя переменная var42
#define var48	BUFFER[685]	// Внутренняя переменная var48
#define idvar48	30061	// Внутренняя переменная var48
#define var17	BUFFER[688]	// Внутренняя переменная var17
#define idvar17	30062	// Внутренняя переменная var17
#define var27	BUFFER[690]	// Внутренняя переменная var27
#define idvar27	30063	// Внутренняя переменная var27
#define var34	BUFFER[693]	// Внутренняя переменная var34
#define idvar34	30064	// Внутренняя переменная var34
#define var16	BUFFER[695]	// Внутренняя переменная var16
#define idvar16	30065	// Внутренняя переменная var16
#define var35	BUFFER[697]	// Внутренняя переменная var35
#define idvar35	30066	// Внутренняя переменная var35
#pragma pack(push,1)
static VarCtrl allVariables[]={ 			 //Описание всех переменных
	 ...
	 4	,3	,1	,&A0IT03IRP},	//(vas84:06 - K01VASR, - ) Температура АЗ1-3
	 ...
	 17	,3	,1	,&B0IT03IRP},	//(vas84:06 - K02VASR, - ) Температура АЗ2-3
	 ...
	 30000	,	,1	,&var38},	//Внутренняя переменная var38
	 30001	,1	,1	,&var50},	//Внутренняя переменная var50
	 30002	,1	,1	,&vainSBool},	//Внутренняя переменная vainSBool
	 30003	,8	,1	,&var1},	//Внутренняя переменная var1
	 30004	,8	,1	,&var4},	//Внутренняя переменная var4
	 30005	,1	,1	,&var19},	//Внутренняя переменная var19
	 30006	,1	,1	,&var14},	//Внутренняя переменная var14
	 30007	,8	,1	,&var21},	//Внутренняя переменная var21
	 30008	,1	,1	,&var36},	//Внутренняя переменная var36
	 30009	,1	,1	,&var41},	//Внутренняя переменная var41
	 30010	,8	,1	,&var47},	//Внутренняя переменная var47
	 30011	,8	,1	,&var2},	//Внутренняя переменная var2
	 30012	,8	,1	,&var3},	//Внутренняя переменная var3
	 30013	,8	,1	,&var10},	//Внутренняя переменная var10
	 30014	,8	,1	,&vainSFloat},	//Внутренняя переменная vainSFloat
	 30015	,1	,1	,&var12},	//Внутренняя переменная var12
	 30016	,8	,1	,&var25},	//Внутренняя переменная var25
	 30017	,1	,1	,&var62},	//Внутренняя переменная var62
	 30018	,1	,1	,&var43},	//Внутренняя переменная var43
	 30019	,1	,1	,&var44},	//Внутренняя переменная var44
	 30020	,1	,1	,&var61},	//Внутренняя переменная var61
	 30021	,8	,1	,&var8},	//Внутренняя переменная var8
	 30022	,1	,1	,&var11},	//Внутренняя переменная var11
	 30023	,1	,1	,&var55},	//Внутренняя переменная var55
	 30024	,1	,1	,&var37},	//Внутренняя переменная var37
	 30025	,11	,1	,&vainSLong},	//Внутренняя переменная vainSLong
	 30026	,8	,1	,&var46},	//Внутренняя переменная var46
	 30027	,8	,1	,&var26},	//Внутренняя переменная var26
	 30028	,1	,1	,&var29},	//Внутренняя переменная var29
	 30029	,1	,1	,&var32},	//Внутренняя переменная var32
	 30030	,1	,1	,&var58},	//Внутренняя переменная var58
	 30031	,1	,1	,&var59},	//Внутренняя переменная var59
	 30032	,1	,1	,&var23},	//Внутренняя переменная var23
	 30033	,1	,1	,&var39},	//Внутренняя переменная var39
	 30034	,1	,1	,&var56},	//Внутренняя переменная var56
	 30035	,8	,1	,&var9},	//Внутренняя переменная var9
	 30036	,	,1	,&var40},	//Внутренняя переменная var40
	 30037	,1	,1	,&var45},	//Внутренняя переменная var45
	 30038	,1	,1	,&var28},	//Внутренняя переменная var28
	 30039	,1	,1	,&var31},	//Внутренняя переменная var31
	 30040	,3	,1	,&vainSInt},	//Внутренняя переменная vainSInt
	 30041	,8	,1	,&var6},	//Внутренняя переменная var6
	 30042	,1	,1	,&var13},	//Внутренняя переменная var13
	 30043	,1	,1	,&var18},	//Внутренняя переменная var18
	 30044	,1	,1	,&var52},	//Внутренняя переменная var52
	 30045	,1	,1	,&var53},	//Внутренняя переменная var53
	 30046	,3	,1	,&var20},	//Внутренняя переменная var20
	 30047	,1	,1	,&var49},	//Внутренняя переменная var49
	 30048	,	,1	,&var51},	//Внутренняя переменная var51
	 30049	,1	,1	,&var54},	//Внутренняя переменная var54
	 30050	,1	,1	,&var57},	//Внутренняя переменная var57
	 30051	,1	,1	,&var60},	//Внутренняя переменная var60
	 30052	,	,1	,&vainSChar},	//Внутренняя переменная vainSChar
	 30053	,8	,1	,&var7},	//Внутренняя переменная var7
	 30054	,1	,1	,&var15},	//Внутренняя переменная var15
	 30055	,1	,1	,&var33},	//Внутренняя переменная var33
	 30056	,1	,1	,&var30},	//Внутренняя переменная var30
	 30057	,8	,1	,&var5},	//Внутренняя переменная var5
	 30058	,8	,1	,&var22},	//Внутренняя переменная var22
	 30059	,8	,1	,&var24},	//Внутренняя переменная var24
	 30060	,1	,1	,&var42},	//Внутренняя переменная var42
	 30061	,	,1	,&var48},	//Внутренняя переменная var48
	 30062	,1	,1	,&var17},	//Внутренняя переменная var17
	 30063	,3	,1	,&var27},	//Внутренняя переменная var27
	 30064	,1	,1	,&var34},	//Внутренняя переменная var34
	 30065	,1	,1	,&var16},	//Внутренняя переменная var16
	 30066	,1	,1	,&var35},	//Внутренняя переменная var35
	{-1,0,NULL},
}
...
static ModbusRegister coil_RPU[]={
	{&R0EE02LDU,2,0},	//( - , RPU) Питание  АКНП  отключить
	{NULL,0,0},
}
#pragma pop
#pragma pack(push,1)
static ModbusRegister di_RPU[]={
	{&B0VT71LRP,2,5},	//( - , RPU) АС по температуре в АЗ2-3
	{&R0ET02LRP,2,7},	//( - , RPU) Признак наличия неисправности по температуре АЗ2-3
	{&A7MZ31LRP,2,2},	//( - , RPU) Клапан ОБДУВ АЗ1 открыть(обесточить)
	{&B0VT61LRP,2,6},	//( - , RPU) ПС по температуре в АЗ2-3
	{&A0VT61LRP,2,10},	//( - , RPU) ПС по температуре в АЗ1
	{&R7VE70LRP,2,3},	//( - , RPU) Сигнал тревоги по неисправности РПУ на диспетчера
	{&A0VT71LRP,2,9},	//( - , RPU) АС по температуре в АЗ1
	{&R0ET01LRP,2,8},	//( - , RPU) Признак наличия неисправности по температуре  АЗ1-3
	{&A0EE01LRP,2,4},	//( - , RPU) Исправность АКНП канал 5
	{&B7MZ31LRP,2,1},	//( - , RPU) Клапан ОБДУВ АЗ2 открыть(обесточить)
	{&A0EE02LRP,2,12},	//( - , RPU) Исправность АКНП5 (от сшивки каналов) канал 5
	{&TestDiagnRPU,2,0},	//( - , RPU) Неисправность от диагностики
	{&R7VN71LRP,2,11},	//( - , RPU) Сигнал тревоги по уровню нейтронного потока на диспетчера
	{NULL,0,0},
}
#pragma pop
#pragma pack(push,1)
...
static ModbusRegister di_DiagnRPU[]={
	{&R0DE34LRP,2,11},	//( - S04SBK, DiagnRPU) диагностика шкафа РПУ температура меньше 43
	{&R0DE31LRP,2,14},	//( - S01SBK, DiagnRPU) диагностика шкафа РПУ сеть 1
	{&R0DEB2LRP,2,2},	//( - S11SBK, DiagnRPU) диагностика шкафа РПУ БП24Д место 7
	{&R0DEB1LRP,2,3},	//( - S10SBK, DiagnRPU) диагностика шкафа РПУ БП5 место 7
	{&R0DE38LRP,2,7},	//( - S08SBK, DiagnRPU) диагностика шкафа РПУ МП15-3 место 3
	{&R0DE3CLRP,2,5},	//( - , DiagnRPU) диагностика шкафа РПУ БП5/24Д место 7
	{&R0DE39LRP,2,6},	//( - S09SBK, DiagnRPU) диагностика шкафа РПУ МП24-2 место 4
	{&R0DE33LRP,2,12},	//( - S03SBK, DiagnRPU) диагностика шкафа РПУ двери
	{&R0DEB3LRP,2,0},	//( - S12SBK, DiagnRPU) диагностика шкафа РПУ БП5 место 8
	{&R0DEB4LRP,2,1},	//( - S13SBK, DiagnRPU) диагностика шкафа РПУ БП24Д место 8
	{&R0DE36LRP,2,9},	//( - S06SBK, DiagnRPU) диагностика шкафа РПУ МП15-3.1 место 1
	{&R0DE35LRP,2,10},	//( - S05SBK, DiagnRPU) диагностика шкафа РПУ температура больше 53
	{&R0DE32LRP,2,13},	//( - S02SBK, DiagnRPU) диагностика шкафа РПУ сеть 2
	{&R0DE3DLRP,2,4},	//( - , DiagnRPU) диагностика шкафа РПУ БП5/24Д место 8
	{&R0DE37LRP,2,8},	//( - S07SBK, DiagnRPU) диагностика шкафа РПУ МП15-3.1 место 2
	{NULL,0,0},
}
#pragma pop
#pragma pack(push,1)
...
static ModbusDevice modbuses[]={
	{0,5002,&coil_RPU[0],&di_RPU[0],&di_RPU[0],&hr_RPU[0],NULL,NULL,NULL,0},	//общий slave RPU
	{0,5003,&coil_DiagnRPU[0],&di_DiagnRPU[0],&di_DiagnRPU[0],&hr_DiagnRPU[0],NULL,NULL,NULL,0},	//Диагностика РПУ
	{1,5010,&coil_MRPS[0],&di_MRPS[0],&di_MRPS[0],&hr_MRPS[0],NULL,MRPS_ip1,MRPS_ip2,100},	//Мастер RPU в SCM
...
#pragma pop
#include <fp8/drivers/vchs2.h>/nstatic char buf_VCHS03[58];	//VCHS03
...
static Drive drivers[]={
	{0xc4,0x03,58,def_buf_VCHS03,&table_VCHS03},	//VCHS03
	{0xc6,0x06,30,def_buf_VAS84,&table_VAS84},	//VAS84
	{0xc2,0x07,132,def_buf_VDS32,&table_VDS32},	//VDS32
	{0x96,0x08,40,def_buf_FDS16,&table_FDS16},	//FDS16
